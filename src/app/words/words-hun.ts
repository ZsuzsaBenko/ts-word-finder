...
export const wordsHun: Words = {
    ...
    'R': {
        '3': [
            'RAB', 'RAG', 'RAJ', 'RAK', 'RÁC', 'RÁG', 'RÁK', 'RÁZ', 'REÁ', 'RÉG', 'RÉM', 'RÉS', 'RÉT', 'RÉV', 'RÉZ', 'RÍM', 'ROM', 'RÖG',
            'RŐF', 'RŐT', 'RUM', 'RÚG', 'RÚT', 'RÜH'
        ],
        '4': [
            'RAJZ', 'RAJT', 'RANG', 'RÁAD', 'RÁCS', 'RÁÉG', 'RÁÉR', 'RÁGÓ', 'RÁÍR', 'RÁNC', 'RÁNG', 'RÁNT', 'RÁRÓ', 'RÁÜL', 'RÁÜT', 'REÁL',
            'REDŐ', 'REGE', 'RELÉ', 'REND', 'RENG', 'REST', 'RÉCE', 'RÉGI', 'RÉPA', 'RÉSZ', 'RÉTI', 'RIAD', 'RIGÓ', 'RING', 'RIZS', 'ROGY',
            'ROMA', 'RONT', 'ROST', 'RÓKA', 'RÖNK', 'RUCA', 'RUGÓ', 'RUHA', 'RÚNA', 'RÚZS'
        ],
        '5': [
        ...
        '6': [
            ...
            'RÁÉPÍT', 'RÁÉPÜL', 'RÁHAGY', 'RÁHAJT', 'RÁHULL', 'RÁKÖLT', 'RÁNCOL', 'RÁNCOS', 'RÁNDUL', 'RÁNGAT', 'RÁNTÁS', 'RÁRÁNT',
            'RÁROGY', 'RÁRONT', 'RÁSZED', 'RÁSZEL', 'RÁSZÓL', 'RÁSZÚR', 'RÁTESZ', 'RÁVARR', 'RÁVESZ', 'RÁVISZ', 'REÁLIS', 'REDŐNY',
            'REDVES', 'REGÉNY', 'REGGEL', 'RELUXA', 'RENDEL', 'RENDES', 'RENDEZ', 'RENDŐR', 'RENGET', 'RESZEL', 'RÉGIES', 'RÉSZES',
            'RÉVÉSZ', 'RINGAT', 'RIPORT', 'ROGYÁS', 'ROKKAN', 'ROMBOL', 'ROMLIK', 'RONTÁS', 'ROZSDA', 'RÓZSÁS', 'RUGDAL', 'RÚZSOS',
            'RÚZSOZ'
        ],
        '7': [
            'RABOSÍT', 'RAGOZÁS', 'RÁGCSÁL', 'RÁGÓZÁS', 'RÁGÓZIK', 'RÁKERES', 'RÁLÁTÁS', 'RÁSPOLY', 'REGGELI', 'RESZELŐ', 'RESZKET',
            'RÉGISÉG', 'RÉSZLET', 'ROBOTOL', 'ROHADÁS', 'ROHANÁS', 'ROKKANT', 'ROMLOTT', 'ROZSDÁS', 'RÖFÖGÉS', 'RÖHÖGÉS', 'RONGYOS',
            'RUGÓZÁS', 'RUGÓZIK'
        ]
    },
    'S': {
