...
export const wordsHun: Words = {
    ...
    'B': {
        ...
        '7': [
            ...
            'BÖKKENŐ', 'BŐGŐZIK', 'BŐREGÉR', 'BŐRFEJŰ', 'BŐRIPAR', 'BŐRSZÍN', 'BŐSÉGES', 'BŐVÍTÉS', 'BŐVÜLÉS', 'BRÁCSÁS', 'BRICSKA',
            'BRIKETT', 'BRINGÁS', 'BROSÚRA', 'BRUMMOG', 'BUBORÉK', 'BUGGYAN', 'BUGGYOS', 'BUGYOGÓ', 'BUGYUTA', 'BUHERÁL', 'BUJASÁG',
            'BUJDOSÓ', 'BUKFENC', 'BUKKANÓ', 'BUKSZUS', 'BUKTATÓ', 'BULIMIA', 'BULIZIK', 'BULIZÓS', 'BULLDOG', 'BUNGALÓ', 'BURKOLT',
            'BURZSOÁ', 'BUSZSÁV', 'BUTASÁG', 'BUTÍTÁS', 'BUTULÁS', 'BUTUSKA', 'BUTYKOS', 'BUZERÁL', 'BÚBÁNAT', 'BÚSULÁS', 'BÚZAMAG',
            'BÚZASÖR', 'BÜDÖSÍT', 'BÜDÖSKE', 'BÜFIZIK', 'BÜKKÖNY', 'BÜNTETŐ', 'BÜTYKÖL', 'BÜTYKÖS', 'BŰBÁJOS', 'BŰNBÁNÓ', 'BŰNESET',
            'BŰNÖZÉS', 'BŰNÖZIK', 'BŰNTÁRS', 'BŰNTETT', 'BŰNTÉNY', 'BŰNÜGYI', 'BŰVÖLET'
        ]
    },
    'C': {
        '3': [
    ...
    'K': {
        ...
        '4': [
            ...
            'KENU', 'KEPE', 'KERT', 'KESE', 'KEZD', 'KÉNE', 'KÉNY', 'KÉPI', 'KÉRD', 'KÉRÓ', 'KÉRŐ', 'KÉSŐ', 'KÉSZ', 'KÉVE', 'KÉZI', 'KIAD',
            'KIÁS', 'KIES', 'KIÉG', 'KIÉL', 'KIÉR', 'KIFŐ', 'KIÍR', 'KILÓ', 'KILŐ', 'KINN', 'KINŐ', 'KINT', 'KIÖL', 'KIRÍ', 'KIRÓ', 'KIÚT',
            'KIÜL', 'KIÜT', 'KIŰZ', 'KIWI', 'KLÁN', 'KLIP', 'KLÓN', 'KLÓR', 'KLUB', 'KOCA', 'KOFA', 'KOHÓ', 'KOMA', 'KOMP', 'KONC', 'KONG',
            'KOPT', 'KOPÓ', 'KORA', 'KORD', 'KOSZ', 'KOVA', 'KÓDA', 'KÓLA', 'KÓLÓ', 'KÓMA', 'KÓPÉ', 'KÓRÓ', 'KÖLT', 'KÖPŰ', 'KÖRÉ', 'KÖSZ',
            'KÖTŐ', 'KÖZÉ', 'KÖZT', 'KŐSÓ', 'KRÉM', 'KRÓM', 'KUKA', 'KUKI', 'KUKK', 'KULI', 'KUPA', 'KUPÉ', 'KÚRA', 'KÜLD', 'KÜRT', 'KÜZD',
            'KVÍZ'
        ],
        '5': [
        ...
        '6': [
            ...
            'KAPTÁR', 'KAPUFA', 'KAPZSI', 'KARATE', 'KARCOL', 'KARCSÚ', 'KARDÉL', 'KARDOS', 'KARIKA', 'KARIMA', 'KARMOL', 'KARNIS',
            'KARÓRA', 'KARSZT', 'KARTON', 'KARZAT', 'KASMÍR', 'KASZÁL', 'KASZÁS', 'KASSZA', 'KATICA', 'KATLAN', 'KATONA', 'KATTAN',
            'KATTOG', 'KAUCIÓ', 'KAVIÁR', 'KAVICS', 'KAZUÁR', 'KÁBÍTÓ', 'KÁBULT', 'KÁLIUM', 'KÁLYHA', 'KÁMFOR', 'KÁMZSA', 'KÁNKÁN',
            'KÁNTOR', 'KÁPLÁN', 'KÁPLÁR', 'KÁRPIT', 'KÁRTOL', 'KÁRTYA', 'KÁVÉZÓ', 'KECMEC', 'KECSES', 'KECSKE', 'KEDÉLY', 'KEDVEL',
            'KEDVES', 'KEDVEZ', 'KEGYES', 'KEHELY', 'KELETI', 'KELETŰ', 'KELLEM', 'KELLÉK', 'KELTET', 'KELTEZ', 'KEMÉNY', 'KENDER',
            'KENDŐZ', 'KENYÉR', 'KENŐCS', 'KENYÉR', 'KERENG', 'KERESŐ', 'KERGET', 'KERING', 'KERÍTŐ', 'KERTES', 'KERTEL', 'KERTES',
            'KERÜLŐ', 'KESERŰ', 'KESZEG', 'KESZON', 'KETREC', 'KETTED', 'KETTEN', 'KETTES', 'KETTŐS', 'KETTŐZ', 'KETYEG', 'KEVÉLY',
            'KEVERŐ', 'KEVERT', 'KEZDET', 'KEZDÉS', 'KEZDVE', 'KEZELŐ', 'KÉJENC', 'KÉMCSŐ', 'KÉMÉNY', 'KÉMIAI', 'KÉMLEL', 'KÉNSAV',
            'KÉNYES', 'KÉNYÚR', 'KÉPCSŐ', 'KÉPEST', 'KÉPLET', 'KÉPMÁS', 'KÉPTÁR', 'KÉPZEL', 'KÉPZÉS', 'KÉPZET', 'KÉRDEZ', 'KÉRDÉS',
            'KÉRDŐN', 'KÉRÉSZ', 'KÉRGES', 'KÉRLEL', 'KÉSŐBB', 'KÉSZEN', 'KÉSZÍT', 'KÉSZÜL', 'KÉTÁGÚ', 'KÉTELL', 'KÉTELY', 'KÉTÉLŰ',
            'KÉTÉVI', 'KÉTFŐS', 'KÉTRÉT', 'KÉTSÉG', 'KÉZELŐ', 'KÉZFEJ', 'KIABÁL', 'KIADÁS', 'KIADÓS', 'KIAPAD', 'KIÁLLÓ', 'KIÁLTÓ',
            'KIÁRAD', 'KIÁSÁS', 'KIÁZIK', 'KIBBUC', 'KIBONT', 'KIBÚVÓ', 'KICSAL', 'KICSAP', 'KICSÍP', 'KICSUK', 'KIDÖNT', 'KIEMEL',
            'KIESÉS', 'KIESIK', 'KIEVEZ', 'KIÉGET', 'KIÉGÉS', 'KIÉKEL', 'KIÉLEZ', 'KIÉPÍT', 'KIÉPÜL', 'KIÉREZ', 'KIFEJT', 'KIFELÉ',
            'KIFEST', 'KIFOGY', 'KIFORR', 'KIFŐTT', 'KIFUTÓ', 'KIHAGY', 'KIHAJT', 'KIHALL', 'KIHALÓ', 'KIHALT', 'KIHÁNY', 'KIHÍVÓ',
            'KIHORD', 'KIÍRAT', 'KIÍRÁS', 'KIJÁRÓ', 'KIKEZD', 'KIKELT', 'KIKÖLT', 'KIKÖTŐ', 'KIKÜLD', 'KILÁTÓ', 'KILENC', 'KILENG',
            'KIMÉRA', 'KIMÉRT', 'KIMOND', 'KIMONÓ', 'KINŐTT', 'KINYAL', 'KINYIT', 'KINYÍR', 'KINYOM', 'KINYÖG', 'KINYÚL', 'KIOKÁD',
            'KIOLDÓ', 'KIOSON', 'KIOSZK', 'KIOSZT', 'KIÖTÖL', 'KIRAKÓ', 'KIRÁLY', 'KIRÁNT', 'KIRGIZ', 'KIRÍVÓ', 'KIRONT', 'KISAGY',
            'KISÁGY', 'KISDED', 'KISDOB', 'KISEBB', 'KISFIÚ', 'KISHAL', 'KISIET', 'KISÍRT', 'KISPAD', 'KISPAP', 'KISUJJ', 'KISVAD',
            'KISZAB', 'KISZED', 'KISZEL', 'KISZÍV', 'KISZÓL', 'KISZÓR', 'KISZÚR', 'KISZŰR', 'KITART', 'KITESZ', 'KITEVŐ', 'KITÉRŐ',
            'KITILT', 'KITÖLT', 'KITÖRŐ', 'KITŰNŐ', 'KITŰZŐ', 'KIUGRÓ', 'KIUTAL', 'KIUTÁL', 'KIÚJUL', 'KIÜLÉS', 'KIÜRÍT', 'KIÜRÜL',
            'KIÜTÉS', 'KIŰZÉS', 'KIVARR', 'KIVÁJT', 'KIVÁLÓ', 'KIVÁLT', 'KIVERT', 'KIVESZ', 'KIVÉSZ', 'KIVÉVE', 'KIVISZ', 'KIVONT',
            'KIZÁRT', 'KÍNPAD', 'KÍNRÍM', 'KÍNZÁS', 'KÍSÉRŐ', 'KÍSÉRT', 'KÍVÜLI', 'KLASSZ', 'KLÉRUS', 'KLIENS', 'KLIMAX', 'KLIPSZ',
            'KLOÁKA', 'KLOTYÓ', 'KLOZET', 'KLÓNOZ', 'KLÓROS', 'KLÓROZ', 'KLUMPA', 'KNÉDLI', 'KOBALT', 'KOBOLD', 'KOCCAN', 'KOCKÁS',
            'KOCOGÓ', 'KOCSIS', 'KOCSMA', 'KOFFER', 'KOHÁSZ', 'KOHOLT', 'KOHÓMŰ', 'KOKAIN', 'KOKETT', 'KOKOTT', 'KOKTÉL', 'KOLDUL',
            'KOLDUS', 'KOLERA', 'KOLESZ', 'KOLHOZ', 'KOLOMP', 'KOLONC', 'KOMIKA', 'KOMISZ', 'KOMOLY', 'KOMPÓT', 'KONCOL', 'KONDÁS',
            'KONDÉR', 'KONDOM', 'KONGAT', 'KONKÁV', 'KONTÁR', 'KONTRA', 'KONTÚR', 'KONVEX', 'KONVOJ', 'KONZOL', 'KONZUL', 'KONYAK',
            'KONYHA', 'KONYÍT', 'KONYUL', 'KOPASZ', 'KOPLAL', 'KOPOTT', 'KOPPAN', 'KOPTAT', 'KORALL', 'KORÁBB', 'KORÁNT', 'KORDON',
            'KORHAD', 'KORHOL', 'KORKÉP', 'KORLÁT', 'KORMOS', 'KORMOZ', 'KORONA', 'KORONG', 'KORPÁS', 'KOSBOR', 'KOSZOS', 'KOTLIK',
            'KOTRÁS', 'KOTTÁZ', 'KOTYOG', 'KOVAKŐ', 'KOVÁCS', 'KOVÁSZ', 'KOZMÁL', 'KOZMÁS', 'KÓCSAG', 'KÓDOLT', 'KÓKLER', 'KÓLIKA',
            'KÓRHÁZ', 'KÓRLAP', 'KÓRTAN', 'KÓSTOL', 'KÓSZÁL', 'KÖCSÖG', 'KÖDLIK', 'KÖDMÖN', 'KÖHINT', 'KÖKÉNY', 'KÖLDÖK', 'KÖLTÉS',
            'KÖLTŐI', 'KÖLYÖK', 'KÖMÉNY', 'KÖNNYŰ', 'KÖNTÖS', 'KÖNYÖK', 'KÖPCÖS', 'KÖPDÖS', 'KÖPENY', 'KÖPKÖD', 'KÖRBEN', 'KÖRGÁT',
            'KÖRKÉP', 'KÖRMÖL', 'KÖRMÖS', 'KÖRÖND', 'KÖRTÉR', 'KÖRÜLE', 'KÖRÜLI', 'KÖRZET', 'KÖSZÖN', 'KÖTBÉR', 'KÖTÉNY', 'KÖTÖDE',
            'KÖTÖTT', 'KÖTŐTŰ', 'KÖTTET', 'KÖVETŐ', 'KÖZADÓ', 'KÖZBEN', 'KÖZCÉL', 'KÖZELI', 'KÖZÉRT', 'KÖZFAL', 'KÖZHÍR', 'KÖZÍRÓ',
            'KÖZJOG', 'KÖZLÉS', 'KÖZNAP', 'KÖZNÉP', 'KÖZÖNY', 'KÖZÖTT', 'KÖZSÉG', 'KÖZTES', 'KÖZTÉR', 'KÖZÚTI', 'KÖZÜGY', 'KŐKORI',
            'KŐOLAJ', 'KŐSZÉN', 'KŐTÖMB', 'KRAPEK', 'KRÁKOG', 'KRÁTER', 'KREDIT', 'KRETÉN', 'KRÉKER', 'KRÉMES', 'KRÉMEZ', 'KRÉTÁS',
            'KRIGLI', 'KRIPTA', 'KRÍZIS', 'KRÓMOS', 'KRÓMOZ', 'KRŐZUS', 'KRUPIÉ', 'KUCSMA', 'KUDARC', 'KUGLER', 'KUGLÓF', 'KUKKOL',
            'KUKSOL', 'KUKUCS', 'KULACS', 'KULLOG', 'KUNCOG', 'KUNSZT', 'KUNYHÓ', 'KUPICA', 'KUPOLA', 'KURBLI', 'KURTÁN', 'KURTÍT',
            'KURZÍV', 'KURZOR', 'KURZUS', 'KUSHAD', 'KUSSOL', 'KUTACS', 'KUTATÓ', 'KUTYÁS', 'KUTYUS', 'KUVASZ', 'KÚSZIK', 'KÚTÁSÓ',
            'KÚTGÉM', 'KÚTVÍZ', 'KÜLDÉS', 'KÜLLEM', 'KÜLÖNB', 'KÜLÖNC', 'KÜLSŐS', 'KÜLTAG', 'KÜLÜGY', 'KÜRTÖL', 'KÜRTÖS', 'KÜSZÖB',
            'KÜZDÉS', 'KVAZÁR'
        ],
        '7': [
    ...
    'S': {
        ...
        '4': [
            ...
            'SÚLY', 'SÜLT', 'SÜNI', 'SÜTŐ', 'SŰRŰ', 'SVÁB', 'SVÉD', 'SZAB', 'SZAG', 'SZAK', 'SZAR', 'SZÁJ', 'SZÁK', 'SZÁL', 'SZÁM', 'SZÁN',
            'SZÁR', 'SZÁZ', 'SZED', 'SZEG', 'SZEL', 'SZEM', 'SZER', 'SZEX', 'SZÉF', 'SZÉK', 'SZÉL', 'SZÉN', 'SZÉP', 'SZÉT', 'SZIA', 'SZID',
            'SZIK', 'SZIL', 'SZÍJ', 'SZÍN', 'SZÍR', 'SZÍT', 'SZÍV', 'SZOP', 'SZÓL', 'SZÓR', 'SZÖG', 'SZŐR', 'SZÚR', 'SZÜL', 'SZŰK', 'SZŰR',
            'SZŰZ'
        ],
        '5': [
