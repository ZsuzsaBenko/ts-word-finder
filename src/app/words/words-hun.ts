...
export const wordsHun: Words = {
    ...
    'F': {
        ...
        '4': [
            ...
            'FEDD', 'FEDŐ', 'FEJT', 'FELE', 'FELÉ', 'FENE', 'FENN', 'FENT', 'FESS', 'FEST', 'FÉLŐ', 'FÉLT', 'FÉNY', 'FÉRC', 'FÉRJ', 'FÉSŰ',
            'FIAL', 'FIKA', 'FILC', 'FILE', 'FILÉ', 'FILM', 'FING', 'FINN', 'FIÓK', 'FITT', 'FIÚI', 'FIÚS', 'FLÖS', 'FOCI', 'FOGÓ', 'FOGY',
            'FOJT', 'FOLT', 'FONÓ', 'FONT', 'FORR', 'FOTÓ', 'FOXI', 'FÓKA', 'FÖLD', 'FÖLÉ', 'FÖNN', 'FÖNT', 'FŐÁG', 'FŐMŰ', 'FŐTT', 'FŐÚR',
            'FŐÚT', 'FŐZŐ', 'FRÍZ', 'FUGA', 'FURA', 'FUTÓ', 'FÚGA', 'FÚJÓ', 'FÚRÓ', 'FÜGE', 'FÜGG', 'FÜRJ', 'FÜRT', 'FÜST', 'FŰTŐ', 'FŰZŐ'
        ],
        '5': [
    ...
    'K': {
        ...
        '6': [
            ...
            'KAPTÁR', 'KAPUFA', 'KAPZSI', 'KARATE', 'KARCOL', 'KARCOS', 'KARCSÚ', 'KARDÉL', 'KARDOS', 'KARIKA', 'KARIMA', 'KARMOL',
            'KARNIS', 'KARÓRA', 'KARSZT', 'KARTON', 'KARZAT', 'KASMÍR', 'KASZÁL', 'KASZÁS', 'KASSZA', 'KATICA', 'KATLAN', 'KATONA',
            'KATTAN', 'KATTOG', 'KAUCIÓ', 'KAVIÁR', 'KAVICS', 'KAZUÁR', 'KÁBÍTÓ', 'KÁBULT', 'KÁLIUM', 'KÁLYHA', 'KÁMFOR', 'KÁMZSA',
            'KÁNKÁN', 'KÁNTOR', 'KÁPLÁN', 'KÁPLÁR', 'KÁRPIT', 'KÁRTOL', 'KÁRTYA', 'KÁVÉZÓ', 'KECMEC', 'KECSES', 'KECSKE', 'KEDÉLY',
            'KEDVEL', 'KEDVES', 'KEDVEZ', 'KEGYES', 'KEHELY', 'KELETI', 'KELETŰ', 'KELLEM', 'KELLÉK', 'KELTET', 'KELTEZ', 'KEMÉNY',
            'KENDER', 'KENDŐZ', 'KENYÉR', 'KENŐCS', 'KENYÉR', 'KERENG', 'KERESŐ', 'KERGET', 'KERING', 'KERÍTŐ', 'KERTES', 'KERTEL',
            'KERTES', 'KERÜLŐ', 'KESERŰ', 'KESZEG', 'KESZON', 'KETREC', 'KETTED', 'KETTEN', 'KETTES', 'KETTŐS', 'KETTŐZ', 'KETYEG',
            'KEVÉLY', 'KEVERŐ', 'KEVERT', 'KEZDET', 'KEZDÉS', 'KEZDVE', 'KEZELŐ', 'KÉJENC', 'KÉMCSŐ', 'KÉMÉNY', 'KÉMIAI', 'KÉMLEL',
            'KÉNSAV', 'KÉNYES', 'KÉNYÚR', 'KÉPCSŐ', 'KÉPEST', 'KÉPLET', 'KÉPMÁS', 'KÉPTÁR', 'KÉPZEL', 'KÉPZÉS', 'KÉPZET', 'KÉRDEZ',
            'KÉRDÉS', 'KÉRDŐN', 'KÉRÉSZ', 'KÉRGES', 'KÉRLEL', 'KÉSŐBB', 'KÉSZEN', 'KÉSZÍT', 'KÉSZÜL', 'KÉTÁGÚ', 'KÉTELL', 'KÉTELY',
            'KÉTÉLŰ', 'KÉTÉVI', 'KÉTFŐS', 'KÉTRÉT', 'KÉTSÉG', 'KÉZELŐ', 'KÉZFEJ', 'KIABÁL', 'KIADÁS', 'KIADÓS', 'KIAPAD', 'KIÁLLÓ',
            'KIÁLTÓ', 'KIÁRAD', 'KIÁSÁS', 'KIÁZIK', 'KIBBUC', 'KIBONT', 'KIBÚVÓ', 'KICSAL', 'KICSAP', 'KICSÍP', 'KICSUK', 'KIDÖNT',
            'KIEMEL', 'KIESÉS', 'KIESIK', 'KIEVEZ', 'KIÉGET', 'KIÉGÉS', 'KIÉKEL', 'KIÉLEZ', 'KIÉPÍT', 'KIÉPÜL', 'KIÉREZ', 'KIFEJT',
            'KIFELÉ', 'KIFEST', 'KIFOGY', 'KIFORR', 'KIFŐTT', 'KIFUTÓ', 'KIHAGY', 'KIHAJT', 'KIHALL', 'KIHALÓ', 'KIHALT', 'KIHÁNY',
            'KIHÍVÓ', 'KIHORD', 'KIÍRAT', 'KIÍRÁS', 'KIJÁRÓ', 'KIKEZD', 'KIKELT', 'KIKÖLT', 'KIKÖTŐ', 'KIKÜLD', 'KILÁTÓ', 'KILENC',
            'KILENG', 'KIMÉRA', 'KIMÉRT', 'KIMOND', 'KIMONÓ', 'KINŐTT', 'KINYAL', 'KINYIT', 'KINYÍR', 'KINYOM', 'KINYÖG', 'KINYÚL',
            'KIOKÁD', 'KIOLDÓ', 'KIOSON', 'KIOSZK', 'KIOSZT', 'KIÖTÖL', 'KIRAKÓ', 'KIRÁLY', 'KIRÁNT', 'KIRGIZ', 'KIRÍVÓ', 'KIRONT',
            'KISAGY', 'KISÁGY', 'KISDED', 'KISDOB', 'KISEBB', 'KISFIÚ', 'KISHAL', 'KISIET', 'KISÍRT', 'KISPAD', 'KISPAP', 'KISUJJ',
            'KISVAD', 'KISZAB', 'KISZED', 'KISZEL', 'KISZÍV', 'KISZÓL', 'KISZÓR', 'KISZÚR', 'KISZŰR', 'KITART', 'KITESZ', 'KITEVŐ',
            'KITÉRŐ', 'KITILT', 'KITÖLT', 'KITÖRŐ', 'KITŰNŐ', 'KITŰZŐ', 'KIUGRÓ', 'KIUTAL', 'KIUTÁL', 'KIÚJUL', 'KIÜLÉS', 'KIÜRÍT',
            'KIÜRÜL', 'KIÜTÉS', 'KIŰZÉS', 'KIVARR', 'KIVÁJT', 'KIVÁLÓ', 'KIVÁLT', 'KIVERT', 'KIVESZ', 'KIVÉSZ', 'KIVÉVE', 'KIVISZ',
            'KIVONT', 'KIZÁRT', 'KÍNPAD', 'KÍNRÍM', 'KÍNZÁS', 'KÍSÉRŐ', 'KÍSÉRT', 'KÍVÜLI', 'KLASSZ', 'KLÉRUS', 'KLIENS', 'KLIMAX',
            'KLIPSZ', 'KLOÁKA', 'KLOTYÓ', 'KLOZET', 'KLÓNOZ', 'KLÓROS', 'KLÓROZ', 'KLUMPA', 'KNÉDLI', 'KOBALT', 'KOBOLD', 'KOCCAN',
            'KOCKÁS', 'KOCOGÓ', 'KOCSIS', 'KOCSMA', 'KOFFER', 'KOHÁSZ', 'KOHOLT', 'KOHÓMŰ', 'KOKAIN', 'KOKETT', 'KOKOTT', 'KOKTÉL',
            'KOLDUL', 'KOLDUS', 'KOLERA', 'KOLESZ', 'KOLHOZ', 'KOLOMP', 'KOLONC', 'KOMIKA', 'KOMISZ', 'KOMOLY', 'KOMPÓT', 'KONCOL',
            'KONDÁS', 'KONDÉR', 'KONDOM', 'KONGAT', 'KONKÁV', 'KONTÁR', 'KONTRA', 'KONTÚR', 'KONVEX', 'KONVOJ', 'KONZOL', 'KONZUL',
            'KONYAK', 'KONYHA', 'KONYÍT', 'KONYUL', 'KOPASZ', 'KOPLAL', 'KOPOTT', 'KOPPAN', 'KOPTAT', 'KORALL', 'KORÁBB', 'KORÁNT',
            'KORDON', 'KORHAD', 'KORHOL', 'KORKÉP', 'KORLÁT', 'KORMOS', 'KORMOZ', 'KORONA', 'KORONG', 'KORPÁS', 'KOSBOR', 'KOSZOS',
            'KOTLIK', 'KOTRÁS', 'KOTTÁZ', 'KOTYOG', 'KOVAKŐ', 'KOVÁCS', 'KOVÁSZ', 'KOZMÁL', 'KOZMÁS', 'KÓCSAG', 'KÓDOLT', 'KÓKLER',
            'KÓLIKA', 'KÓRHÁZ', 'KÓRLAP', 'KÓRTAN', 'KÓSTOL', 'KÓSZÁL', 'KÖCSÖG', 'KÖDLIK', 'KÖDMÖN', 'KÖHINT', 'KÖKÉNY', 'KÖLDÖK',
            'KÖLTÉS', 'KÖLTŐI', 'KÖLYÖK', 'KÖMÉNY', 'KÖNNYŰ', 'KÖNTÖS', 'KÖNYÖK', 'KÖPCÖS', 'KÖPDÖS', 'KÖPENY', 'KÖPKÖD', 'KÖRBEN',
            'KÖRGÁT', 'KÖRKÉP', 'KÖRMÖL', 'KÖRMÖS', 'KÖRÖND', 'KÖRTÉR', 'KÖRÜLE', 'KÖRÜLI', 'KÖRZET', 'KÖSZÖN', 'KÖTBÉR', 'KÖTÉNY',
            'KÖTÖDE', 'KÖTÖTT', 'KÖTŐTŰ', 'KÖTTET', 'KÖVETŐ', 'KÖZADÓ', 'KÖZBEN', 'KÖZCÉL', 'KÖZELI', 'KÖZÉRT', 'KÖZFAL', 'KÖZHÍR',
            'KÖZÍRÓ', 'KÖZJOG', 'KÖZLÉS', 'KÖZNAP', 'KÖZNÉP', 'KÖZÖNY', 'KÖZÖTT', 'KÖZSÉG', 'KÖZTES', 'KÖZTÉR', 'KÖZÚTI', 'KÖZÜGY',
            'KŐKORI', 'KŐOLAJ', 'KŐSZÉN', 'KŐTÖMB', 'KRAPEK', 'KRÁKOG', 'KRÁTER', 'KREDIT', 'KRETÉN', 'KRÉKER', 'KRÉMES', 'KRÉMEZ',
            'KRÉTÁS', 'KRIGLI', 'KRIPTA', 'KRÍZIS', 'KRÓMOS', 'KRÓMOZ', 'KRŐZUS', 'KRUPIÉ', 'KUCSMA', 'KUDARC', 'KUGLER', 'KUGLÓF',
            'KUKKOL', 'KUKSOL', 'KUKUCS', 'KULACS', 'KULLOG', 'KUNCOG', 'KUNSZT', 'KUNYHÓ', 'KUPICA', 'KUPOLA', 'KURBLI', 'KURTÁN',
            'KURTÍT', 'KURZÍV', 'KURZOR', 'KURZUS', 'KUSHAD', 'KUSSOL', 'KUTACS', 'KUTATÓ', 'KUTYÁS', 'KUTYUS', 'KUVASZ', 'KÚSZIK',
            'KÚTÁSÓ', 'KÚTGÉM', 'KÚTVÍZ', 'KÜLDÉS', 'KÜLLEM', 'KÜLÖNB', 'KÜLÖNC', 'KÜLSŐS', 'KÜLTAG', 'KÜLÜGY', 'KÜRTÖL', 'KÜRTÖS',
            'KÜSZÖB', 'KÜZDÉS', 'KVAZÁR'
        ],
        '7': [
    ...
    'L': {
        ...
        '6': [
            ...
            'LEEVÉS', 'LEÉGET', 'LEÉGÉS', 'LEÉLÉS', 'LEÉPÍT', 'LEÉPÜL', 'LEÉRÉS', 'LEFAGY', 'LEFEJT', 'LEFELÉ', 'LEFEST', 'LEFOGY',
            'LEGELŐ', 'LEGÉNY', 'LEGOTT', 'LEGUÁN', 'LEGYEN', 'LEGYEZ', 'LEGYŐZ', 'LEGYŰR', 'LEHAGY', 'LEHAJT', 'LEHÁNT', 'LEHÁNY',
            'LEHETŐ', 'LEHORD', 'LEHULL', 'LEHUNY', 'LEIGÁZ', 'LEIRAT', 'LEITAT', 'LEÍRAT', 'LEÍRÁS', 'LEJÁRÓ', 'LEJÁRT', 'LEJMOL',
            'LEJTŐS', 'LEKTOR', 'LEKTŰR', 'LEKÜLD', 'LEKÜZD', 'LEKVÁR', 'LELÁTÓ', 'LELENC', 'LELKES', 'LELTÁR', 'LEMEGY', 'LEMENŐ',
            'LEMOND', 'LENCSE', 'LENDÍT', 'LENDÜL', 'LENÉZŐ', 'LENGET', 'LENGÉS', 'LENMAG', 'LENYEL', 'LENYES', 'LENYÍR', 'LENYOM',
            'LENYÚL', 'LENYÚZ', 'LEOKÁD', 'LEOSON', 'LEÖLÉS', 'LEPEDŐ', 'LEPÉNY', 'LEPLEZ', 'LEPRÁS', 'LÉPTEK', 'LÉPTÉK', 'LERÁNT',
            'LEROGY', 'LERONT', 'LESGÓL', 'LESÚJT', 'LESZED', 'LESZEL', 'LESZID', 'LESZÍV', 'LESZÓL', 'LESZÓR', 'LESZÚR', 'LESZŰR',
            'LETESZ', 'LETILT', 'LETÖLT', 'LETÖRT', 'LEÜLÉS', 'LEÜTÉS', 'LEVÁLT', 'LEVARR', 'LEVEGŐ', 'LEVERT', 'LEVESZ', 'LEVISZ',
            'LEVLAP', 'LEZSER', 'LÉGCSŐ', 'LÉGFÉK', 'LÉGIES', 'LÉGKÖR', 'LÉGTÉR', 'LÉGÚTI', 'LÉGZÉS', 'LÉHŰTŐ', 'LÉNYEG', 'LÉPCSŐ',
            'LÉPKED', 'LÉPTET', 'LÉTÉRE', 'LÉTEZŐ', 'LÉTIGE', 'LÉZENG', 'LIBEGŐ', 'LIBIDÓ', 'LICENC', 'LIDÉRC', 'LIFTES', 'LIGNIT',
            'LIKVID', 'LILIOM', 'LIMLOM', 'LINKEL', 'LINZER', 'LISTÁS', 'LISTÁZ', 'LITVÁN', 'LÍCEUM', 'LÍTIUM', 'LÍZING', 'LOBBAN',
            'LOBOGÓ', 'LOCSOG', 'LOCSOL', 'LOGGIA', 'LOGIKA', 'LOMBIK', 'LOMBOS', 'LOMPOS', 'LOMTÁR', 'LOPKOD', 'LOPOTT', 'LOVAGI',
            'LOVÁSZ', 'LÓFOGÚ', 'LÓHERE', 'LÓKÖTŐ', 'LÓSZŐR', 'LÓTETŰ', 'LÓZUNG', 'LÖKDÖS', 'LÖTYÖG', 'LÖVELL', 'LÖVÉSZ', 'LŐSZER',
            'LUCSOK', 'LUMPEN', 'LUMPOL', 'LUGGAT', 'LÚDBŐR', 'LÜKTET', 'LYUKAS'
        ],
        '7': [
    ...
    'S': {
        ...
        '6': [
            ...
            'SÜTTET', 'SÜVÍTŐ', 'SÜVÖLT', 'SVIHÁK', 'SZABAD', 'SZABÁS', 'SZABIN', 'SZAGOL', 'SZAGOS', 'SZAJHA', 'SZAJKÓ', 'SZAJRÉ',
            'SZAKAD', 'SZAKÁG', 'SZAKOS', 'SZAKÍT', 'SZAKMA', 'SZALAD', 'SZALAG', 'SZALDÓ', 'SZALMA', 'SZALON', 'SZALTÓ', 'SZAMÁR',
            'SZAMBA', 'SZANÁL', 'SZAPUL', 'SZARÁS', 'SZAROS', 'SZARIK', 'SZARKA', 'SZATÉN', 'SZATÍR', 'SZAUNA', 'SZAVAL', 'SZAVAZ',
            'SZÁJAL', 'SZÁJAS', 'SZÁJÍZ', 'SZÁLAS', 'SZÁLAZ', 'SZÁLFA', 'SZÁLKA', 'SZÁLLÓ', 'SZÁMÍT', 'SZÁMLA', 'SZÁMOL', 'SZÁMOS',
            'SZÁMOZ', 'SZÁMŰZ', 'SZÁNKÓ', 'SZÁNÁS', 'SZÁNTÓ', 'SZÁRAD', 'SZÁRAS', 'SZÁRAZ', 'SZÁRÍT', 'SZÁRNY', 'SZÁZAD', 'SZÁZAN',
            'SZÁZAS', 'SZCÉNA', 'SZEDÁL', 'SZEDÁN', 'SZEDER', 'SZEDÉS', 'SZEGEL', 'SZEGES', 'SZEGEZ', 'SZEGFŰ', 'SZEKÁL', 'SZEKÉR',
            'SZEKTA', 'SZELEL', 'SZELEP', 'SZELES', 'SZELET', 'SZELÉN', 'SZELÉS', 'SZELÍD', 'SZELLŐ', 'SZEMBE', 'SZEMEL', 'SZEMES',
            'SZEMEZ', 'SZEMÉT', 'SZEMLE', 'SZENDE', 'SZENES', 'SZENNY', 'SZEPEG', 'SZEPLŐ', 'SZERÁF', 'SZERÁJ', 'SZERDA', 'SZEREL',
            'SZEREP', 'SZERET', 'SZEREZ', 'SZERKÓ', 'SZERTE', 'SZERVA', 'SZERVI', 'SZERZŐ', 'SZEXEL', 'SZEXIS', 'SZEZÁM', 'SZEZON',
            'SZÉDÍT', 'SZÉDÜL', 'SZÉKEL', 'SZÉKES', 'SZÉLED', 'SZÉLES', 'SZÉLEZ', 'SZÉLSŐ', 'SZÉNÁS', 'SZÉPEN', 'SZÉPIA', 'SZÉPÍT',
            'SZÉPÜL', 'SZÉRIA', 'SZÉRUM', 'SZÉTLŐ', 'SZÉTFŐ', 'SZÉTÜT', 'SZFÉRA', 'SZFINX', 'SZIÁMI', 'SZIDÁS', 'SZIFON', 'SZIGET',
            'SZIGNÓ', 'SZIGOR', 'SZIKÁR', 'SZIKES', 'SZIKLA', 'SZIKRA', 'SZIKSÓ', 'SZILAJ', 'SZILFA', 'SZILKE', 'SZILVA', 'SZIMAT',
            'SZINTE', 'SZINTŰ', 'SZIPKA', 'SZIPOG', 'SZIPÓS', 'SZIPUS', 'SZIRÉN', 'SZIROM', 'SZIRTI', 'SZIRUP', 'SZITÁL', 'SZITÁR',
            'SZITOK', 'SZIVAR', 'SZÍJAS', 'SZÍJAZ', 'SZÍNES', 'SZÍNEZ', 'SZÍTÁS', 'SZÍVAT', 'SZÍVÁS', 'SZÍVEL', 'SZÍVES', 'SZÍVÓS',
            'SZKÍTA', 'SZLENG', 'SZOBOR', 'SZOKÁS', 'SZOKIK', 'SZOLGA', 'SZOLID', 'SZONDA', 'SZOPÁS', 'SZOPIK', 'SZOPÓS', 'SZORÍT',
            'SZOROS', 'SZOROZ', 'SZORUL', 'SZORZÓ', 'SZÓBAN', 'SZÓCSŐ', 'SZÓDÁS', 'SZÓFAJ', 'SZÓKÉP', 'SZÓKÖZ', 'SZÓLAM', 'SZÓLÁS',
            'SZÓLÍT', 'SZÓNOK', 'SZÓRÁS', 'SZÓSOR', 'SZÓTAG', 'SZÓTAN', 'SZÓTÁR', 'SZÓVAL', 'SZÓVÉG', 'SZÓZAT', 'SZÖGEL', 'SZÖGES',
            'SZÖGEZ', 'SZÖKÉS', 'SZÖKIK', 'SZÖRNY', 'SZÖSZI', 'SZÖVEG', 'SZÖVET', 'SZÖVÉS', 'SZŐKÉS', 'SZŐKÍT', 'SZŐKÜL', 'SZŐLŐS',
            'SZŐRME', 'SZŐRÖS', 'SZŐRÖZ', 'SZPÁHI', 'SZTEPP', 'SZTORI', 'SZUFLA', 'SZUFLÉ', 'SZUMMA', 'SZUNDI', 'SZUNYA', 'SZUPER',
            'SZUROK', 'SZUVAS', 'SZÚRÁS', 'SZÚRÓS', 'SZÜLÉS', 'SZÜLŐI', 'SZÜNET', 'SZÜRET', 'SZÜRKE', 'SZŰKEN', 'SZŰKÍT', 'SZŰKÖL',
            'SZŰKÖS', 'SZŰKÜL', 'SZŰNÉS', 'SZŰNIK', 'SZŰRÉS'
        ],
        '7': [
