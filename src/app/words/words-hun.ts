...
export const wordsHun: Words = {
    ...
    'B': {
        '3': [
            'BAB', 'BAJ', 'BAK', 'BAL', 'BÁB', 'BÁJ', 'BÁL', 'BÁN', 'BÁR', 'BEJ', 'BÉG', 'BÉL', 'BÉR', 'BIO', 'BIT', 'BÍR', 'BÍZ', 'BOA',
            'BOB', 'BOG', 'BOR', 'BOT', 'BOX', 'BÓK', 'BÓN', 'BÓR', 'BÖK', 'BŐG', 'BŐR', 'BÚB', 'BÚG', 'BÚR', 'BÚS', 'BŰN', 'BŰZ'
        ],
        '4': [
            ...
            'BÍRÓ', 'BLOG', 'BLŐD', 'BLÚZ', 'BOCI', 'BOCS', 'BOHÓ', 'BOKA', 'BOLT', 'BOLY', 'BONT', 'BORS', 'BORZ', 'BORÚ', 'BÓDÉ', 'BÓJA',
            'BÓLÉ', 'BÓRA', 'BÖJT', 'BÖKŐ', 'BŐGŐ', 'BŐSZ', 'BRIT', 'BRÓM', 'BUBI', 'BUCI', 'BUDI', 'BUGA', 'BUJA', 'BUKÉ', 'BULI', 'BURA',
            'BUSA', 'BUSÓ', 'BUSZ', 'BUTA', 'BUZI', 'BÚGÓ', 'BÚZA', 'BÜFÉ', 'BÜFI', 'BÜKK', 'BYTE'
        ],
        '5': [
            ...
            'BÚSUL', 'BÚTOR', 'BÚVÁR', 'BÜDÖS', 'BÜRÖK', 'BŰBÁJ', 'BŰNÖS', 'BŰVÖS', 'BŰZÖS'
        ],
        '6': [
        ...
        '7': [
            ...
            'BIZALOM', 'BIZNISZ', 'BIZTATÓ', 'BÍBOROS', 'BÍRÁLAT', 'BÍRÓSÁG', 'BLAMÁZS', 'BLATTOL', 'BLAZÍRT', 'BLICCEL', 'BLOGGER',
            'BLOKKOL', 'BLÖFFÖL', 'BOGARAS', 'BOGÁNCS', 'BOGLYAS', 'BOGRÁCS', 'BOGOZÁS', 'BOHÓKÁS', 'BOHÓZAT', 'BOJKOTT', 'BOKÁZIK',
            'BOKRÉTA', 'BOKSZER', 'BOKSZOL', 'BOKSZOS', 'BOLYGAT', 'BOLYHOS', 'BOLYONG', 'BOMBÁZÓ', 'BOMLOTT', 'BONSZÁJ', 'BORBÉLY',
            'BORDÉLY', 'BORECET', 'BORÍTÁS', 'BORÍTÉK', 'BOROGAT', 'BORONÁL', 'BOROSTA', 'BOROTVA', 'BORPRÉS', 'BORZONG', 'BOSNYÁK',
            'BOSSZÚS', 'BOTFÜLŰ', 'BOTOZÁS', 'BOTRÁNY', 'BOZÓTOS', 'BÓDÍTÁS', 'BÓDULAT', 'BÓKOLÁS', 'BÓLOGAT', 'BÖFFENT', 'BÖFÖGÉS',
            'BÖKKENŐ', 'BÖKÖDÉS', 'BŐGŐZIK', 'BŐREGÉR', 'BŐRFEJŰ', 'BŐRIPAR', 'BŐRSZÍN', 'BŐSÉGES', 'BŐVÍTÉS', 'BŐVÜLÉS', 'BRÁCSÁS',
            'BRICSKA', 'BRIKETT', 'BRINGÁS', 'BROSÚRA', 'BRUMMOG', 'BUBORÉK', 'BUGGYAN', 'BUGGYOS', 'BUGYOGÓ', 'BUGYUTA', 'BUHERÁL',
            'BUJASÁG', 'BUJDOSÓ', 'BUKFENC', 'BUKKANÓ', 'BUKSZUS', 'BUKTATÓ', 'BULIMIA', 'BULIZIK', 'BULIZÓS', 'BULLDOG', 'BUNGALÓ',
            'BURKOLT', 'BURZSOÁ', 'BUSZSÁV', 'BUTASÁG', 'BUTÍTÁS', 'BUTULÁS', 'BUTUSKA', 'BUTYKOS', 'BUZERÁL', 'BÚBÁNAT', 'BÚSULÁS',
            'BÚZAMAG', 'BÚZASÖR', 'BÜDÖSÍT', 'BÜDÖSKE', 'BÜFIZIK', 'BÜKKÖNY', 'BÜNTETŐ', 'BÜTYKÖL', 'BÜTYKÖS', 'BŰBÁJOS', 'BŰNBÁNÓ',
            'BŰNESET', 'BŰNÖZÉS', 'BŰNÖZIK', 'BŰNTÁRS', 'BŰNTETT', 'BŰNTÉNY', 'BŰNÜGYI', 'BŰVÖLET'
        ]
    },
    'C': {
        '3': [
    ...
    'E': {
        '3': [
            'EDZ', 'EGO', 'EGY', 'EJT', 'EKE', 'ELÉ', 'EME', 'EMU', 'EPE', 'ELŐ', 'ELV', 'EOL', 'EPE', 'ERŐ', 'ESD', 'ESŐ', 'EST', 'EVŐ',
            'EZT'
        ],
        '4': [
            'EBBE', 'EBÉD', 'ECET', 'EDZŐ', 'EGÁL', 'EGÉR', 'EJHA', 'EKÉZ', 'ELAD', 'ELÁN', 'ELÁS', 'ELÉG', 'ELLŐ', 'ELEM', 'ELÁS', 'ELÉG',
            'ELÉL', 'ELÉR', 'ELFŐ', 'ELIT', 'ELÍR', 'ELLŐ', 'ELME', 'ELÖL', 'ELŐD', 'ELŐL', 'ELŐZ', 'ELSŐ', 'ELUN', 'ELÜL', 'ELÜT', 'ELŰZ',
            'ELVI', 'EMEL', 'EMEZ', 'EMÍR', 'EMLŐ', 'EMSE', 'ENYH', 'ENYV', 'EPED', 'EPER', 'EPÉS', 'ERDŐ', 'ERED', 'ERES', 'EREZ', 'ERGO',
            'ERŐD', 'ERŐS', 'ERRE', 'ESET', 'ESÉS', 'ESIK', 'ESKÜ', 'ESŐS', 'ESTE', 'ESTI', 'ETAP', 'ETET', 'ETŰD', 'EURO', 'EVET', 'EVEZ',
            'EVÉS', 'EZEN', 'EZER'
        ],
        '5': [
        ...
        '6': [
            'EBADTA', 'EBBELI', 'EBBÉLI', 'EBÉDEL', 'EBÉDLŐ', 'EBIHAL', 'EBONIT', 'ECETES', 'ECETFA', 'EDDIGI', 'EDITÁL', 'EDZETT',
            'EFELŐL', 'EFFEKT', 'EFFÉLE', 'EGEREZ', 'EGÉRÚT', 'EGZAKT', 'EGYÁGÚ', 'EGYBEN', 'EGYBŐL', 'EGYEDI', 'EGYEZŐ', 'EGYÉNI',
            'EGYÉVI', 'EGYFŐS', 'EGYHÁZ', 'EGYKOR', 'EGYLET', 'EGYMÁS', 'EGYSÉG', 'EGYÜTT', 'EGYÜVÉ', 'EKCÉMA', 'EKEVAS', 'EKKÉNT',
            'EKKORA', 'EKLOGA', 'ELADÁS', 'ELAKAD', 'ELALÉL', 'ELAPAD', 'ELAVUL', 'ELÁJUL', 'ELÁLLÓ', 'ELÁMÍT', 'ELÁMUL', 'ELÁRUL',
            'ELÁSÁS', 'ELÁZIK', 'ELBONT', 'ELCSAL', 'ELCSAP', 'ELCSEN', 'ELCSÍP', 'ELCSÓR', 'ELCSUK', 'ELDÖNT', 'ELEDEL', 'ELEGEN',
            'ELEINK', 'ELEMEL', 'ELEMES', 'ELEMEZ', 'ELEMZŐ', 'ELEPED', 'ELERED', 'ELESÉG', 'ELESÉS', 'ELESIK', 'ELEVEN', 'ELÉGET',
            'ELÉGÉS', 'ELÉGGÉ', 'ELÉGIA', 'ELÉRÉS', 'ELÉVÜL', 'ELFAGY', 'ELFOGY', 'ELFOJT', 'ELFORR', 'ELFÚLÓ', 'ELHAGY', 'ELHAJT',
            'ELHALÓ', 'ELHÁNY', 'ELHINT', 'ELHISZ', 'ELHORD', 'ELHULL', 'ELHUNY', 'ELIJED', 'ELINAL', 'ELIXÍR', 'ELÍGÉR', 'ELÍRÁS',
            'ELÍTÉL', 'ELKEZD', 'ELKÖLT', 'ELKÜLD', 'ELLÁTÓ', 'ELLENE', 'ELLENI', 'ELMEGY', 'ELMENT', 'ELMOND', 'ELMÚLT', 'ELNÉZŐ',
            'ELNÖKI', 'ELNYEL', 'ELNYER', 'ELNYOM', 'ELODÁZ', 'ELOROZ', 'ELOSON', 'ELOSZT', 'ELŐADÓ', 'ELŐÁLL', 'ELŐBBI', 'ELŐHAD',
            'ELŐHÍV', 'ELŐHOZ', 'ELŐHÚZ', 'ELŐÍRT', 'ELŐJEL', 'ELŐJOG', 'ELŐJÖN', 'ELŐKAP', 'ELŐLAP', 'ELŐLEG', 'ELŐLÉP', 'ELŐNÉV',
            'ELŐŐRS', 'ELŐRAG', 'ELŐSZÓ', 'ELŐTAG', 'ELŐTÉR', 'ELŐTÖR', 'ELŐTTE', 'ELŐTTI', 'ELŐVÉD', 'ELŐZÉS', 'ELRÁNT', 'ELREJT',
            'ELRIAD', 'ELRONT', 'ELSEJE', 'ELSIET', 'ELSŐRE', 'ELSZAB', 'ELSZÁN', 'ELSZED', 'ELSZÍV', 'ELSZÓL', 'ELSZÓR', 'ELSZÚR',
            'ELTART', 'ELTESZ', 'ELTÉRŐ', 'ELTILT', 'ELTÖLT', 'ELTŰNT', 'ELUNÁS', 'ELURAL', 'ELÜLÉS', 'ELÜTÉS', 'ELVARR', 'ELVÁLT',
            'ELVESZ', 'ELVÉSZ', 'ELVISZ', 'ELVONT', 'ELZÁRT', 'EMBERI', 'EMBRIÓ', 'EMELET', 'EMELÉS', 'EMERRE', 'EMÉSZT', 'EMIATT',
            'EMÓCIÓ', 'EMULÁL', 'ENCIÁN', 'ENIGMA', 'ENYÉIM', 'ENYHÉN', 'ENYHÍT', 'ENYHÜL', 'ENYVES', 'ENYVEZ', 'EPEBAJ', 'EPERFA',
            'EPESZT', 'EPIGON', 'EPIKAI', 'EPIKUS', 'EPILÁL', 'EPIZÓD', 'EPOSZI', 'ERDÉSZ', 'ERDŐŐR', 'EREDET', 'EREGET', 'ERESZT',
            'EREZET', 'EREZÉS', 'ERJEDT', 'ERKÉLY', 'ERNYED', 'ERNYŐS', 'ERODÁL', 'EROGÉN', 'ERÓZIÓ', 'ERŐDÍT', 'ERŐGÉP', 'ERŐKAR',
            'ERŐSEN', 'ERŐSÍT', 'ERŐTAN', 'ERŐTÉR', 'ERRÉBB', 'ESENDŐ', 'ESKÜDT', 'ESKÜVŐ', 'ESŐNAP', 'ESŐVÍZ', 'ESŐZÉS', 'ESPERS',
            'ESTÉLY', 'ESTÉRE', 'ESTIKE', 'ESZKÖZ', 'ESZMEI', 'ESZMÉL', 'ETALON', 'ETANOL', 'ETETÉS', 'ETIKAI', 'ETIKUS', 'ETILÉN',
            'EUNUCH', 'EVETKE', 'EVEZÉS', 'EVEZŐS', 'EXTRÉM', 'EXPORT', 'EZUTÁN', 'EZÚTON'
        ],
        '7': [
            'EBCSONT', 'EBÉDIDŐ', 'EBTARTÓ', 'ECETSAV', 'ECSETEL', 'EDÉNYES', 'EDIKTUM', 'EDZŐDIK', 'EGERÉSZ', 'EGÉSZEN', 'EGOSITA',
            'EGYAZON', 'EGYBEÍR', 'EGYEDÜL', 'EGYENES', 'EGYENLŐ', 'EGYESÍT', 'EGYESÜL', 'EGYETEM', 'EGYEZÉS', 'EGYEZIK', 'EGYÉNÍT',
            'EGYÉVES', 'EGYFELÉ', 'EGYFÉLE', 'EGYHAVI', 'EGYHÁZI', 'EGYHETI', 'EGYIDŐS', 'EGYKARÚ', 'EGYKÉNT', 'EGYKORI', 'EGYKORÚ',
            'EGYLÁBÚ', 'EGYLAKI', 'EGYMAGA', 'EGYNAPI', 'EGYNEJŰ', 'EGYNEMŰ', 'EGYÓRAI', 'EGYÓRÁS', 'EGYPÚPÚ', 'EGYSÍKÚ', 'EGYSZER',
            'EGYTAGÚ', 'EGYTERŰ', 'EGYÜGYŰ', 'EJTŐZIK', 'EKCÉMÁS', 'ELADÁSI', 'ELALTAT', 'ELALVÁS', 'ELAPRÓZ', 'ELASZIK', 'ELAVULT',
            'ELÁLLÁS', 'ELÁLLÍT', 'ELÁRVUL', 'ELÁTKOZ', 'ELÁZOTT', 'ELÁZTAT', 'ELBÁJOL', 'ELBÁNÁS', 'ELBÁNIK', 'ELBÍRÁL', 'ELBORÍT',
            'ELBORUL', 'ELBÓDÍT', 'ELBŐDÜL', 'ELBUKÁS', 'ELBUKIK', 'ELBUTÍT', 'ELBUTUL', 'ELBÚJÁS', 'ELBÚJIK', 'ELBŰVÖL', 'ELCIPEL',
            'ELDALOL', 'ELDOBÁL', 'ELDOBÁS', 'ELDÖCÖG', 'ELDŐLÉS', 'ELDUGÁS', 'ELDUGUL', 'ELEFÁNT', 'ELEGÁNS', 'ELEGYES', 'ELEGYÍT',
            'ELEINTE', 'ELEJTÉS', 'ELEKTÍV', 'ELEKTOR', 'ELEMZÉS', 'ELENGED', 'ELESETT', 'ELESZIK', 'ELÉLVEZ', 'ELÉMEGY', 'ELÉVÜLT',
            'ELFAJUL', 'ELFALAZ', 'ELFÁRAD', 'ELFÁSUL', 'ELFAXOL', 'ELFEJEL', 'ELFEKVŐ', 'ELFOGAD', 'ELFOGÁS', 'ELGÁZOL', 'ELGÉPEL',
            'ELGURÍT', 'ELGURUL', 'ELHADAR', 'ELHAJÍT', 'ELHAJLÓ', 'ELHAJOL', 'ELHALAD', 'ELHALÁS', 'ELHARAP', 'ELHASAD', 'ELHASAL',
            'ELHÁRÍT', 'ELHÁRUL', 'ELHIBÁZ', 'ELHITET', 'ELHIVAT', 'ELHÍVÁS', 'ELHÍZÁS', 'ELHÍZIK', 'ELHOZAT', 'ELHÓDÍT', 'ELHUNYT',
            'ELHÚZÁS', 'ELHŰLÉS', 'ELILLAN', 'ELINDÍT', 'ELINDUL', 'ELINTÉZ', 'ELISMER', 'ELISZIK', 'ELÍTÉLŐ', 'ELÍTÉLT', 'ELJÁRÁS',
            'ELJÖVÉS', 'ELJUTÁS', 'ELKAPAR', 'ELKAPAT', 'ELKAPÁS', 'ELKAVAR', 'ELKÁBÍT', 'ELKÁBUL', 'ELKELÉS', 'ELKENÉS', 'ELKÉKÜL',
            'ELKÉPED', 'ELKERÍT', 'ELKERÜL', 'ELKEVER', 'ELKEZEL', 'ELKÉRÉS', 'ELKÉSÉS', 'ELKÉSIK', 'ELKIÁLT', 'ELKÍSÉR', 'ELKOBOZ',
            'ELKOPIK', 'ELKÖTÉS', 'ELKÖVET', 'ELLÁTÁS', 'ELNÉZÉS', 'ELLAPÍT', 'ELLAZUL', 'ELLÁTÁS', 'ELLENEZ', 'ELLENŐR', 'ELLENZŐ',
            'ELLEPÉS', 'ELLESÉS', 'ELLÉPÉS', 'ELLOPÁS', 'ELLÓGÁS', 'ELLÖKÉS', 'ELLÖVÉS', 'ELMARAD', 'ELMARÁS', 'ELMENET', 'ELMENÉS',
            'ELMERÜL', 'ELMESÉL', 'ELMETSZ', 'ELMÉLET', 'ELMÉRÉS', 'ELMOSÁS', 'ELMULAT', 'ELMÚLÁS', 'ELMÚLIK', 'ELNAPOL', 'ELNEVET',
            'ELNEVEZ', 'ELNÉMÍT', 'ELNÉMUL', 'ELNÉZÉS', 'ELNÖKÖL', 'ELNYERŐ', 'ELNYOMÓ', 'ELNYÚJT', 'ELNYÚLÓ', 'ELNYŰTT', 'ELOLDÁS',
            'ELOLTÁS', 'ELOLVAD', 'ELOLVAS', 'ELORDÍT', 'ELOSZTÓ', 'ELÖLRŐL', 'ELÖMLIK', 'ELÖNTÉS', 'ELŐADÁS', 'ELŐÁSÁS', 'ELŐBBRE',
            'ELŐÉLET', 'ELŐESTE', 'ELŐÉTEL', 'ELŐHANG', 'ELŐHÍVÓ', 'ELŐIDÉZ', 'ELŐÍRÁS', 'ELŐJELŰ', 'ELŐKELŐ', 'ELŐKERT', 'ELŐNYÖS',
            'ELŐRAJZ', 'ELŐRÁNT', 'ELŐRÉSZ', 'ELŐRONT', 'ELŐSZED', 'ELŐSZÉL', 'ELŐSZÖR', 'ELŐTETŐ', 'ELŐTÖLT', 'ELŐVESZ', 'ELPÁHOL',
            'ELPEREL', 'ELPIHEN', 'ELPIRUL', 'ELPUCOL', 'ELPUHÍT', 'ELPUHUL', 'ELRABOL', 'ELRAGAD', 'ELRAGOZ', 'ELRAKÁS', 'ELRÁGÁS',
            'ELREBEG', 'ELREPED', 'ELREPÍT', 'ELREPÜL', 'ELRÉMÍT', 'ELRÉMÜL', 'ELROBOG', 'ELROHAN', 'ELRÚGÁS', 'ELRÚTÍT', 'ELSÁPAD',
            'ELSÉTÁL', 'ELSIMÍT', 'ELSIMUL', 'ELSIRAT', 'ELSODOR', 'ELSODRÓ', 'ELSOROL', 'ELSÖPÖR', 'ELSÖPRŐ', 'ELSUHAN', 'ELSÜLÉS',
            'ELSÜTÉS', 'ELSZÁLL', 'ELSZÁNT', 'ELSZÍVÓ', 'ELSZÓRT', 'ELTAGAD', 'ELTAKAR', 'ELTALÁL', 'ELTANUL', 'ELTAPOS', 'ELTARTÓ',
            'ELTÁTÁS', 'ELTELIK', 'ELTELTE', 'ELTEMET', 'ELTEREL', 'ELTERÍT', 'ELTERÜL', 'ELTEVÉS', 'ELTÉPÉS', 'ELTÉRÉS', 'ELTÉRÍT',
            'ELTÉRÜL', 'ELTÉVED', 'ELTIPOR', 'ELTOLÁS', 'ELTÖKÉL', 'ELTÖMÉS', 'ELTÖRÉS', 'ELTÖRIK', 'ELTÖRÖL', 'ELTÚLOZ', 'ELTÜZEL',
            'ELTŰNÉS', 'ELTŰNIK', 'ELTŰRÉS', 'ELUGRÁS', 'ELUGRIK', 'ELVADÍT', 'ELVADUL', 'ELVAKÍT', 'ELVAKUL', 'ELVÁGÁS', 'ELVÁLÁS',
            'ELVÁLIK', 'ELVÁMOL', 'ELVÁRÁS', 'ELVÁSIK', 'ELVERÉS', 'ELVESZT', 'ELVETET', 'ELVETÉL', 'ELVETÉS', 'ELVEZET', 'ELVÉGEZ',
            'ELVÉGRE', 'ELVÉTEL', 'ELVÉTÉS', 'ELVÉTVE', 'ELVILEG', 'ELVISEL', 'ELVITAT', 'ELVITEL', 'ELVONÁS', 'ELVONUL', 'ELVTÁRS',
            'ELZAVAR', 'ELZÁRÁS', 'ELZOKOG', 'ELZÚGÁS', 'EMBERES', 'EMBERKE', 'EMBLÉMA', 'EMBÓLIA', 'EMELETI', 'EMÉSZTŐ', 'EMINENS',
            'EMÍRSÉG', 'EMLEGET', 'EMLÉKMŰ', 'EMLÍTÉS', 'EMLŐRÁK', 'EMÖGÖTT', 'EMPÁTIA', 'ENDOGÉN', 'ENERGIA', 'ENGEDÉS', 'ENKÓDER',
            'ENTITÁS', 'ENYHÍTŐ', 'ENNYIEN', 'EPÉSSÉG', 'ERDŐSÁV', 'ERDŐSÉG', 'ERDŐSÍT', 'ERDŐTŰZ', 'ERECSKE', 'EREDETI', 'EREDETŰ',
            'EREKCIÓ', 'EREKLYE', 'ERETNEK', 'EREZETT', 'ERÉLYES', 'ERÉNYES', 'ERJEDÉS', 'ERJESZT', 'ERKÖLCS', 'ERNYEDT', 'EROTIKA',
            'ERŐLTET', 'ERŐNLÉT', 'ERŐSÍTŐ', 'ERŐSSÉG', 'ERŐSZAK', 'ERŐTLEN', 'ERSZÉNY', 'ERUPCIÓ', 'ERUPTÍV', 'ESDEKEL', 'ESDEKLŐ',
            'ESEMÉNY', 'ESERNYŐ', 'ESETLEG', 'ESETLEN', 'ESETRAG', 'ESÉLYES', 'ESKÜVŐI', 'ESŐÁLLÓ', 'ESŐTLEN', 'ESTEBÉD', 'ESTÉLYI',
            'ESZCÁJG', 'ESZEGET', 'ESZELŐS', 'ESZKIMÓ', 'ESZMÉNY', 'ESZTÉTA', 'ETERNIT', 'ETIKETT', 'ETNIKAI', 'ETNIKUM', 'ETRUSZK',
            'EUFÓRIA', 'EVAKUÁL', 'EVÉGBŐL', 'EVÉSZET', 'EVICKÉL', 'EVIDENS', 'EVILÁGI', 'EXHUMÁL', 'EXPONÁL', 'EXTÁZIS', 'EZALATT',
            'EZÁLTAL', 'EZELŐTT', 'EZENNEL', 'EZENTÚL', 'EZERÉVI', 'EZERNYI', 'EZREDES', 'EZREDÉV', 'EZREDIK', 'EZRELÉK', 'EZRÉVEL',
            'EZÚTTAL', 'EZÜSTÖS', 'EZÜSTÖZ'
        ]
    },
    'É': {
        '3': [
            'ÉGI', 'ÉGŐ', 'ÉJI', 'ÉLC', 'ÉLŐ', 'ÉPP', 'ÉRA', 'ÉLC', 'ÉLŐ', 'ÉLV', 'ÉPP', 'ÉRA', 'ÉRC', 'ÉRŐ', 'ÉRT', 'ÉRV', 'ÉSZ', 'ÉTI',
            'ÉVI'
        ],
        '4': [
            'ÉBEN', 'ÉBER', 'ÉDEN', 'ÉDES', 'ÉGER', 'ÉGET', 'ÉGÉS', 'ÉGÖV', 'ÉHEN', 'ÉHES', 'ÉKEL', 'ÉKES', 'ÉKKŐ', 'ÉLED', 'ÉLES', 'ÉLET',
            'ÉLEZ', 'ÉLÉS', 'ÉLVE', 'ÉNEK', 'ÉPEN', 'ÉPÍT', 'ÉPÜL', 'ÉREM', 'ÉREZ', 'ÉRÉS', 'ÉRIK', 'ÉRME', 'ÉRTE', 'ÉRTŐ', 'ÉRZŐ', 'ÉSZT',
            'ÉTEK', 'ÉTEL', 'ÉTER', 'ÉTET', 'ÉVAD', 'ÉVES', 'ÉVÜL'
        ],
        '5': [
        ...
        '6': [
            'ÉBENFA', 'ÉBEREN', 'ÉDELEG', 'ÉDESÍT', 'ÉGBOLT', 'ÉGERFA', 'ÉGETÉS', 'ÉGGÖMB', 'ÉGHETŐ', 'ÉGŐFEJ', 'ÉHEZÉS', 'ÉHEZIK',
            'ÉJFÉLI', 'ÉJJELI', 'ÉKESÍT', 'ÉKEZET', 'ÉKÍRÁS', 'ÉKSZER', 'ÉKSZÍJ', 'ÉLBOLY', 'ÉLEDÉS', 'ÉLELEM', 'ÉLESEN', 'ÉLESÍT',
            'ÉLESZT', 'ÉLETÉV', 'ÉLETFA', 'ÉLETHŰ', 'ÉLETMŰ', 'ÉLETÚT', 'ÉLEZÉS', 'ÉLMÉNY', 'ÉLŐFEJ', 'ÉLŐHAL', 'ÉLŐKÉP', 'ÉLŐLÁB',
            'ÉLŐSDI', 'ÉLŐSZÓ', 'ÉLŐVÍZ', 'ÉLTETŐ', 'ÉLVEZŐ', 'ÉLVÉDŐ', 'ÉNEKEL', 'ÉNEKES', 'ÉNEKLŐ', 'ÉPESZŰ', 'ÉPÍTÉS', 'ÉPÜLET',
            'ÉPÜLÉS', 'ÉPPÍGY', 'ÉPPÚGY', 'ÉRCDÚS', 'ÉRDEMI', 'ÉRFOGÓ', 'ÉRINTŐ', 'ÉRKEZŐ', 'ÉRSEKI', 'ÉRTÉKŰ', 'ÉRVÉNY', 'ÉRZÉKI',
            'ÉSZAKI', 'ÉSZLEL', 'ÉSZTER', 'ÉTKEZŐ', 'ÉTOLAJ', 'ÉTREND', 'ÉTVÁGY', 'ÉVENTE', 'ÉVKÖZI', 'ÉVŐDÉS', 'ÉVŐDIK', 'ÉVSZAK',
            'ÉVSZÁM', 'ÉVVÉGI', 'ÉVZÁRÓ'
        ],
        '7': [
            'ÉBERSÉG', 'ÉBREDÉS', 'ÉBRESZT', 'ÉDESAPA', 'ÉDESBÚS', 'ÉDESDED', 'ÉDESGET', 'ÉDESÍTŐ', 'ÉDESKÉS', 'ÉDESSÉG', 'ÉDESVÍZ',
            'ÉGETETT', 'ÉGITEST', 'ÉHEZTET', 'ÉHHALÁL', 'ÉHÍNSÉG', 'ÉJSÖTÉT', 'ÉJSZAKA', 'ÉKESSÉG', 'ÉKTELEN', 'ÉLDEGÉL', 'ÉLELMES',
            'ÉLELMEZ', 'ÉLÉNKÍT', 'ÉLÉNKÜL', 'ÉLESBEN', 'ÉLESSÉG', 'ÉLÉSTÁR', 'ÉLESZTŐ', 'ÉLETADÓ', 'ÉLETCÉL', 'ÉLETELV', 'ÉLETERŐ',
            'ÉLETJEL', 'ÉLETKÉP', 'ÉLETKOR', 'ÉLETLEN', 'ÉLETMÓD', 'ÉLETTAN', 'ÉLETTÉR', 'ÉLETUNT', 'ÉLGÁRDA', 'ÉLJENEZ', 'ÉLLOVAS',
            'ÉLŐLÉNY', 'ÉLŐSÚLY', 'ÉLŐVÍZI', 'ÉLSPORT', 'ÉLVETEG', 'ÉLVEZET', 'ÉLVEZÉS', 'ÉLVONAL', 'ÉMELYEG', 'ÉMELYÍT', 'ÉNEKKAR',
            'ÉNEKLÉS', 'ÉNEKÓRA', 'ÉNEKSZÓ', 'ÉNTŐLEM', 'ÉNTUDAT', 'ÉPÍTÉSI', 'ÉPÍTÉSZ', 'ÉPÍTGET', 'ÉPÍTTET', 'ÉPPHOGY', 'ÉRCKOHÓ',
            'ÉRCMOSÓ', 'ÉRCPÉNZ', 'ÉRCSOMÓ', 'ÉRDEKEL', 'ÉRDEKES', 'ÉRDEMEL', 'ÉRDEMES', 'ÉRDEMLŐ', 'ÉRDESÍT', 'ÉREMTAN', 'ÉRETLEN',
            'ÉREZTET', 'ÉRGÖRCS', 'ÉRINTÉS', 'ÉRKEZÉS', 'ÉRKEZIK', 'ÉRLELÉS', 'ÉRTELEM', 'ÉRTELMI', 'ÉRTELMŰ', 'ÉRTESÍT', 'ÉRTESÜL',
            'ÉRTÉKEL', 'ÉRTÉKES', 'ÉRTHETŐ', 'ÉRVÁGÁS', 'ÉRVELÉS', 'ÉRVERÉS', 'ÉRVÉNYŰ', 'ÉRZELEG', 'ÉRZELEM', 'ÉRZELMI', 'ÉRZELMŰ',
            'ÉRZÉKEL', 'ÉRZŐDIK', 'ÉRZÜLET', 'ÉSPEDIG', 'ÉSZLELŐ', 'ÉSZLÉNY', 'ÉTCSOKI', 'ÉTELBÁR', 'ÉTKEZDE', 'ÉTKEZÉS', 'ÉTKEZIK',
            'ÉTRENDI', 'ÉTTEREM', 'ÉTTERMI', 'ÉVEZRED', 'ÉVGYŰRŰ', 'ÉVJÁRAT', 'ÉVKÖNYV', 'ÉVNYITÓ', 'ÉVTIZED', 'ÉVZÁRÁS'
        ]
    },
    'F': {
        '3': [
            'FAJ', 'FAL', 'FAR', 'FAX', 'FÁJ', 'FÁS', 'FED', 'FEJ', 'FEL', 'FEN', 'FEZ', 'FÉK', 'FÉL', 'FÉM', 'FÉR', 'FIÚ', 'FIX', 'FOG',
            'FOK', 'FON', 'FOS', 'FÓR', 'FÖL', 'FŐN', 'FŐZ', 'FUJ', 'FUT', 'FÚJ', 'FÚR', 'FÜL', 'FŰT', 'FŰZ'
        ],
        '4': [
            'FAÁG', 'FACH', 'FAGY', 'FAJD', 'FAJI', 'FALI', 'FAKÓ', 'FALC', 'FALÓ', 'FALU', 'FARM', 'FAUN', 'FÁJL', 'FÁJÓ', 'FÁMA', 'FÁNK',
            'FEDD', 'FEDŐ', 'FEJT', 'FELE', 'FELÉ', 'FENE', 'FENN', 'FENT', 'FESS', 'FEST', 'FÉLE', 'FÉLŐ', 'FÉLT', 'FÉNY', 'FÉRC', 'FÉRJ',
            'FÉSŰ', 'FIAL', 'FIKA', 'FILC', 'FILE', 'FILÉ', 'FILM', 'FING', 'FINN', 'FIÓK', 'FITT', 'FIÚI', 'FIÚS', 'FLÖS', 'FOCI', 'FOGÓ',
            'FOGY', 'FOJT', 'FOLT', 'FONÓ', 'FONT', 'FORR', 'FOTÓ', 'FOXI', 'FÓKA', 'FÖLD', 'FÖLÉ', 'FÖNN', 'FÖNT', 'FŐÁG', 'FŐMŰ', 'FŐTT',
            'FŐÚR', 'FŐÚT', 'FŐZŐ', 'FRÍZ', 'FUGA', 'FURA', 'FUTÓ', 'FÚGA', 'FÚJÓ', 'FÚRÓ', 'FÜGE', 'FÜGG', 'FÜRJ', 'FÜRT', 'FÜST', 'FŰTŐ',
            'FŰZŐ'
        ],
        '5': [
            'FACÉR', 'FAEKE', 'FAFAJ', 'FAGYI', 'FAHÁZ', 'FAHÉJ', 'FAJHŐ', 'FAJTA', 'FAJUL', 'FAKAD', 'FAKÉP', 'FAKÍR', 'FAKÍT', 'FAKUL',
            'FALAS', 'FALAT', 'FALAZ', 'FALÁB', 'FALÁS', 'FALÉC', 'FALKA', 'FARAG', 'FAROK', 'FAROL', 'FARTŐ', 'FASOR', 'FATER', 'FAUNA',
            'FAVÁZ', 'FAXOL', 'FAZÉK', 'FAZON', 'FÁCÁN', 'FÁJÁS', 'FÁJÓS', 'FÁRAÓ', 'FÁRAD', 'FÁSÍT', 'FÁSLI', 'FÁSUL', 'FÁTUM', 'FÁZÁS',
            'FÁZIK', 'FÁZIS', 'FÁZÓS', 'FEDDŐ', 'FEDEZ', 'FEDÉL', 'FEDÉS', 'FEHÉR', 'FEJEL', 'FEJES', 'FEJÉK', 'FEJÉS', 'FEJFA', 'FEKVŐ',
            'FELAD', 'FELÁR', 'FELÁS', 'FELED', 'FELEL', 'FELES', 'FELEZ', 'FELÉG', 'FELÉL', 'FELÉR', 'FELHŐ', 'FELÍR', 'FELLŐ', 'FELNŐ',
            'FELŐL', 'FELRÓ', 'FELSŐ', 'FELÜL', 'FELÜT', 'FENÉK', 'FENÉS', 'FENOL', 'FENTI', 'FENYŐ', 'FERDE', 'FERTŐ', 'FESTŐ', 'FÉKEZ',
            'FÉKÚT', 'FÉLBE', 'FÉLÉV', 'FÉLIG', 'FÉLŐS', 'FÉLRE', 'FÉLSZ', 'FÉLTŐ', 'FÉMES', 'FÉREG', 'FÉRFI', 'FÉSÜL', 'FÉTIS', 'FICAM',
            'FICKÓ', 'FIKÁS', 'FIKÁZ', 'FILÉZ', 'FINIS', 'FINOM', 'FIOLA', 'FIÓKA', 'FIRKA', 'FIRMA', 'FITOS', 'FITTY', 'FIVÉR', 'FIXÁL',
            'FIZET', 'FLANC', 'FLEKK', 'FLÓRA', 'FLOTT', 'FLÖRT', 'FLUOR', 'FODOR', 'FOGAD', 'FOGAN', 'FOGAS', 'FOGAT', 'FOGÁS', 'FOGDA',
            'FOGKŐ', 'FOGÓS', 'FOGVA', 'FOGYÓ', 'FOJTÓ', 'FOKOS', 'FOKOZ', 'FOLYÓ', 'FONAL', 'FONAT', 'FONÁK', 'FONÁL', 'FONÁS', 'FONDÜ',
            'FORGÓ', 'FORMA', 'FOROG', 'FORRÓ', 'FOSÁS', 'FOSIK', 'FOTEL', 'FOTON', 'FOTÓS', 'FOTÓZ', 'FÓBIA', 'FÓLIA', 'FÓRUM', 'FÖDÉM',
            'FÖLDI', 'FÖLÖS', 'FÖLÖZ', 'FÖLSŐ', 'FÖLÜL', 'FÖNTI', 'FŐCÍM', 'FŐDÍJ', 'FŐFAL', 'FŐHŐS', 'FŐIGE', 'FŐLEG', 'FŐNÉV', 'FŐNIX',
            'FŐNÖK', 'FŐNÖZ', 'FŐPAP', 'FŐTÉR', 'FŐÚRI', 'FŐZET', 'FŐZÉS', 'FRAKK', 'FRANC', 'FRANK', 'FRÁSZ', 'FREON', 'FRIGY', 'FRISS',
            'FRONT', 'FUCCS', 'FUKAR', 'FÜGÉS', 'FÜGGŐ', 'FUGÁZ', 'FUNKY', 'FURAT', 'FUTAM', 'FUTÁR', 'FUTÁS', 'FUVAR', 'FÚJÁS', 'FÚRÁS',
            'FÚRIA', 'FÚVÓS', 'FÚZIÓ', 'FÜGGŐ', 'FÜLEL', 'FÜLES', 'FÜLKE', 'FÜLTŐ', 'FÜRDŐ', 'FÜRGE', 'FÜRDŐ', 'FÜRGE', 'FÜTYI', 'FÜTTY',
            'FÜVES', 'FÜZET', 'FÜZÉR', 'FŰEVŐ', 'FŰLIK', 'FŰMAG', 'FŰTÉS', 'FŰZÁG', 'FŰZÉS', 'FŰZFA', 'FŰZŐS'
        ],
        '6': [
            'FABABA', 'FABULA', 'FACIPŐ', 'FADUGÓ', 'FAECET', 'FACSAR', 'FAFEJŰ', 'FAFÚRÓ', 'FAGGAT', 'FAGOTT', 'FAGGYÚ', 'FAGYAL',
            'FAGYÁS', 'FAGYOS', 'FAHAMU', 'FAIPAR', 'FAKTOR', 'FAKULÓ', 'FAKÚSZ', 'FALAZÓ', 'FALÁNK', 'FALCOL', 'FALUSI', 'FANFÁR',
            'FANTOM', 'FANYAR', 'FANYÉL', 'FAPOFA', 'FARKAS', 'FARMER', 'FARÖNK', 'FASZÉN', 'FATETŰ', 'FATÖNK', 'FATTYÚ', 'FAVÁGÓ',
            'FAVICC', 'FAXGÉP', 'FÁJDÍT', 'FÁJDUL', 'FÁJLAL', 'FÁKLYA', 'FÁNDLI', 'FÁRADT', 'FÁSLIZ', 'FÁSULT', 'FÁTLAN', 'FÁTYOL',
            'FECSEG', 'FECSKE', 'FEDDÉS', 'FEDETT', 'FEDLAP', 'FEDŐKŐ', 'FEGYŐR', 'FEJADÓ', 'FEJBŐR', 'FEJLÉC', 'FEJŐNŐ', 'FEJSZE',
            'FEJTÉS', 'FEKETE', 'FEKÉLY', 'FEKTET', 'FEKVÉS', 'FELADÓ', 'FELAJZ', 'FELÁLL', 'FELBŐG', 'FELDOB', 'FELDŐL', 'FELDÚL',
            'FELEJT', 'FELETT', 'FELEZŐ', 'FELFAL', 'FELFED', 'FELFÉR', 'FELFOG', 'FELFON', 'FELFŐZ', 'FELFUT', 'FELFÚJ', 'FELFÚR',
            'FELFŰT', 'FELFŰZ', 'FELHÁG', 'FELHÁM', 'FELHÍV', 'FELHOZ', 'FELHŐS', 'FELHÚZ', 'FELJÁR', 'FELJÖN', 'FELJUT', 'FELKAP',
            'FELKAR', 'FELKEL', 'FELKEN', 'FELKÉR', 'FELKÖT', 'FELLÁT', 'FELLEG', 'FELLEL', 'FELLÉP', 'FELLÉP', 'FELLÖK', 'FELMAR',
            'FELMÉR', 'FELMOS', 'FELNÉZ', 'FELOLD', 'FELÖLT', 'FELÖNT', 'FELŐLE', 'FELRAK', 'FELRÁZ', 'FELRÚG', 'FELSÁL', 'FELSÉG',
            'FELSÍR', 'FELSŐS', 'FELSÜL', 'FELTÁR', 'FELTÉP', 'FELTOL', 'FELTÖR', 'FELTÚR', 'FELTŰR', 'FELTŰZ', 'FELÜLI', 'FELVÁG',
            'FELVER', 'FELVET', 'FELVÉS', 'FELVON', 'FELZÚG', 'FENNEN', 'FENŐKŐ', 'FENYÉR', 'FENYÍT', 'FESTÉK', 'FERDÉN', 'FERDÍT',
            'FERDÜL', 'FERTŐZ', 'FESLÉS', 'FESLIK', 'FESTET', 'FESTÉK', 'FESTÉS', 'FESTŐI', 'FESZES', 'FESZÍT', 'FESZÜL', 'FÉKDOB',
            'FÉKEZŐ', 'FÉLÁRÚ', 'FÉLÉNK', 'FÉLÉVI', 'FÉLIDŐ', 'FÉLKÖR', 'FÉLÓRA', 'FÉLTÁV', 'FÉLTÉS', 'FÉLVAD', 'FÉLVÉR', 'FÉMÁRU',
            'FÉMJEL', 'FÉMVÁZ', 'FÉMZÁR', 'FÉNYÁR', 'FÉNYES', 'FÉNYEZ', 'FÉNYÉV', 'FÉRCEL', 'FÉRGES', 'FÉRJES', 'FÉSZEK', 'FÉSZER',
            'FIASKÓ', 'FIATAL', 'FIÁKER', 'FICKÓS', 'FICSÚR', 'FIFIKA', 'FIGURA', 'FIGYEL', 'FIKCIÓ', 'FIKTÍV', 'FILLÉR', 'FILMES',
            'FILMEZ', 'FILTER', 'FINÁLÉ', 'FINÁNC', 'FINGIK', 'FINTOR', 'FIÓKOS', 'FIRKÁL', 'FIRTAT', 'FITYEG', 'FITYMA', 'FIÚNÉV',
            'FIZETŐ', 'FIZIKA', 'FLAKON', 'FLANEL', 'FLASKA', 'FLEGMA', 'FLEPNI', 'FLOPPY', 'FLOTTA', 'FLÓTÁS', 'FLUXUS', 'FLÚGOS',
            'FODROS', 'FODROZ', 'FOGADÓ', 'FOGÁGY', 'FOGÁSZ', 'FOGBÉL', 'FOGDOS', 'FOGHÁZ', 'FOGHÍJ', 'FOGHÚS', 'FOGÍNY', 'FOGLAL',
            'FOGOLY', 'FOGSÁG', 'FOGSOR', 'FOGZÁS', 'FOGZIK', 'FOGYÁS', 'FOHÁSZ', 'FOJTÁS', 'FOLDOZ', 'FOLSAV', 'FOLTOS', 'FOLTOZ',
            'FOLYAM', 'FOLYAT', 'FOLYÁS', 'FOLYIK', 'FOLYÓS', 'FONÉMA', 'FONODA', 'FONOTT', 'FONTOS', 'FORDÍT', 'FORDUL', 'FORGAT',
            'FORGÁS', 'FORINT', 'FORMAI', 'FORMÁL', 'FORMÁS', 'FORMÁZ', 'FORRAD', 'FORRAL', 'FORRÁS', 'FORRÁZ', 'FÓKUSZ', 'FÓBIÁS',
            'FÓLIÁS', 'FÓLIÁZ', 'FÖLDEL', 'FÖLDES', 'FÖLDÚT', 'FÖLÉNY', 'FÖLÖTT', 'FÖLSŐS', 'FÖLÜLI', 'FÖVENY', 'FŐALAK', 'FŐAPÁT',
            'FŐBÍRÓ', 'FŐÉTEL', 'FŐHAJÓ', 'FŐHELY', 'FŐKAPU', 'FŐKÉNT', 'FŐKÖTŐ', 'FŐNÉVI', 'FŐNÖZŐ', 'FŐREND', 'FŐSZAK', 'FŐUTCA',
            'FŐZÉSI', 'FŐZTJE', 'FRANKÓ', 'FRÁNYA', 'FRÁTER', 'FRÁZIS', 'FRESKÓ', 'FRIGID', 'FRITŐZ', 'FRIVOL', 'FRIZBI', 'FRÖCCS',
            'FRUFRU', 'FRUSKA', 'FULLAD', 'FURCSA', 'FURDAL', 'FURGON', 'FUTÓMŰ', 'FUTTAT', 'FUVOLA', 'FÚJTAT', 'FÚVÓKA', 'FÚZIÓS',
            'FÜGEFA', 'FÜGGÉS', 'FÜLÉSZ', 'FÜLLED', 'FÜRDET', 'FÜRDÉS', 'FÜRDIK', 'FÜRGÉN', 'FÜRTÖS', 'FÜSTÖL', 'FÜSTÖS', 'FÜTYÜL',
            'FŰRÉSZ', 'FŰSZÁL', 'FŰSZER', 'FŰTÖTT', 'FŰZÖLD', 'FŰZÖTT'
        ],
        '7': [
            'FAANYAG', 'FABATKA', 'FADARAB', 'FAFAJTA', 'FAFŰTÉS', 'FAGGYÚS', 'FAGGYÚZ', 'FAGYKÁR', 'FAGYOTT', 'FAHÁNCS', 'FAHASÁB',
            'FAHÉJAS', 'FAHORDÓ', 'FAJANKÓ', 'FAJANSZ', 'FAJSÚLY', 'FAKADÁS', 'FAKANÁL', 'FAKASZT', 'FAKERET', 'FAKÉREG', 'FAKÍTÁS',
            'FAKSZNI', 'FAKULÁS', 'FAKUTYA', 'FALAFEL', 'FALAZAT', 'FALAZÁS', 'FALEMEZ', 'FALEVÉL', 'FALIKAR', 'FALIKÚT', 'FALIÓRA',
            'FALLOSZ', 'FALUHÁZ', 'FALVÉDŐ', 'FAMÍLIA', 'FAMUNKA', 'FAPADOS', 'FARAGÁS', 'FARAKÁS', 'FAROLÁS', 'FARSANG', 'FARZSEB',
            'FASZESZ', 'FATÁLIS', 'FATELEP', 'FATÖRZS', 'FATUSKÓ', 'FAVÁZAS', 'FAVÁGÁS', 'FAVORIT', 'FAZEKAS', 'FÁCÁNOS', 'FÁKLYÁS',
            'FÁRASZT', 'FÁSÍTÁS', 'FEBRUÁR', 'FECSEGŐ', 'FEDELES', 'FEDEZET', 'FEDEZÉK', 'FEDEZÉS', 'FEDŐLAP', 'FEDŐNÉV', 'FEGYHÁZ',
            'FEGYVER', 'FEHÉRES', 'FEHÉRÍT', 'FEHÉRJE', 'FEJADAG', 'FEJDÍSZ', 'FEJELÉS', 'FEJEZET', 'FEJFEDŐ', 'FEJHANG', 'FEJLETT',
            'FEJLŐDŐ', 'FEJŐGÉP', 'FEJPÉNZ', 'FEJRÉSZ', 'FEJTETŐ', 'FEJTÖRŐ', 'FEJVÉDŐ', 'FEKÁLIA', 'FEKETÉN', 'FEKETÉS', 'FEKHELY',
            'FEKSZIK', 'FEKVÉSŰ', 'FELADAT', 'FELADÁS', 'FELAVAT', 'FELÁZIK', 'FELBONT', 'FELBUJT', 'FELCSAL', 'FELCSAP', 'FELCSER',
            'FELCSÍP', 'FELDÖNT', 'FELEDÉS', 'FELELET', 'FELELÉS', 'FELELŐS', 'FELEMÁS', 'FELEMEL', 'FELESEL', 'FELESÉG', 'FELETTE',
            'FELETTI', 'FELEZÉS', 'FELÉGET', 'FELÉLED', 'FELÉPÍT', 'FELÉPÜL', 'FELFEJT', 'FELFELÉ', 'FELFORR', 'FELFÖLD', 'FELGYŰR',
            'FELHAGY', 'FELHAJT', 'FELHANG', 'FELHINT', 'FELHORD', 'FELHÚZÓ', 'FELIDÉZ', 'FELIJED', 'FELIRAT', 'FELITAT', 'FELÍRAT',
            'FELÍRÁS', 'FELÍVEL', 'FELJÁRÓ', 'FELJEBB', 'FELKELŐ', 'FELKELT', 'FELKENT', 'FELKÜLD', 'FELKÜZD', 'FELMEGY', 'FELMENŐ',
            'FELMENT', 'FELMÉRŐ', 'FELMOND', 'FELNŐTT', 'FELNYAL', 'FELNYIT', 'FELNYÍR', 'FELNYOM', 'FELNYÖG', 'FELNYÚL', 'FELOSZT',
            'FELÖLEL', 'FELÖLTŐ', 'FELŐRÖL', 'FELRÁNT', 'FELRIAD', 'FELSŐBB', 'FELSZED', 'FELSZEG', 'FELSZEL', 'FELSZÍN', 'FELSZÍT',
            'FELSZÍV', 'FELSZÚR', 'FELTART', 'FELTESZ', 'FELTÉVE', 'FELTÖLT', 'FELTÖRT', 'FELTŰNŐ', 'FELÚJÍT', 'FELÚJUL', 'FELÜDÍT',
            'FELÜDÜL', 'FELÜLET', 'FELÜLÍR', 'FELÜLSŐ', 'FELÜTÉS', 'FELÜZEN', 'FELVARR', 'FELVÁLT', 'FELVESZ', 'FELVETT', 'FELVEVŐ',
            'FELVISZ', 'FELVONÓ', 'FEMININ', 'FENEVAD', 'FENNÁLL', 'FENNLÉT', 'FENNSÍK', 'FENOMÉN', 'FENTEBB', 'FENYŐÁG', 'FENYŐFA',
            'FENYVES', 'FERTÁLY', 'FERTŐZŐ', 'FESLETT', 'FESTETT', 'FESZENG', 'FESZTÁV', 'FESZÜLT', 'FETRENG', 'FÉKEZÉS', 'FÉKNYOM',
            'FÉKPOFA', 'FÉKSARU', 'FÉLÁLOM', 'FÉLÁRVA', 'FÉLCIPŐ', 'FÉLELEM', 'FÉLESZŰ', 'FÉLÉDES', 'FÉLÉVES', 'FÉLGÖMB', 'FÉLHANG',
            'FÉLHAVI', 'FÉLHOLD', 'FÉLHOLT', 'FÉLKARÚ', 'FÉLKEZŰ', 'FÉLKÉSZ', 'FÉLLÁBÚ', 'FÉLNAPI', 'FÉLÓRÁS', 'FÉLSZÁZ', 'FÉLSZEG',
            'FÉLTEKE', 'FÉLTETT', 'FÉLÚTON', 'FÉMIPAR', 'FÉMKOHÓ', 'FÉMOXID', 'FÉMPÉNZ', 'FÉMSZÁL', 'FÉNYCSŐ', 'FÉNYERŐ', 'FÉNYJEL',
            'FÉNYKÉP', 'FÉNYKOR', 'FÉNYLIK', 'FÉNYMÁZ', 'FÉNYTAN', 'FÉNYŰZŐ', 'FÉRFIAS', 'FÉRFIÁG', 'FÉSŰFOG', 'FÉSZKEL', 'FÉSZKES',
            'FIFIKÁS', 'FIGURÁS', 'FIRURÁZ', 'FIGYELŐ', 'FILMHÉT', 'FILMTÁR', 'FINOMAN', 'FINOMÍT', 'FINOMUL', 'FINNYÁS', 'FIRKÁSZ',
            'FITTSÉG', 'FITYEGŐ', 'FITYING', 'FITYISZ', 'FITYMÁL', 'FITYULA', 'FIZETÉS', 'FIZIKAI', 'FIZIKUM', 'FIZIKUS', 'FLAMAND',
            'FLANCOL', 'FLANCOS', 'FLANGÁL', 'FLEKKEN', 'FLIPPER', 'FLOTTUL', 'FLÖRTÖL', 'FOCISTA', 'FOCIZIK', 'FODRÁSZ', 'FOGADÁS',
            'FOGALMI', 'FOGALOM', 'FOGANAT', 'FOGAZAT', 'FOGDAŐR', 'FOGDMEG', 'FOGFÚRÓ', 'FOGHANG', 'FOGHATÓ', 'FOGHEGY', 'FOGIDEG',
            'FOGKEFE', 'FOGKÖZI', 'FOGKRÉM', 'FOGLALÓ', 'FOGLALT', 'FOGÓDZÓ', 'FOGÓLAP', 'FOGVÁJÓ', 'FOGVÉDŐ', 'FOGYTÁN', 'FOJTOTT',
            'FOKMÉRŐ', 'FOKOZAT', 'FOKOZÁS', 'FOLKLÓR', 'FOLPACK', 'FOLYAMI', 'FOLYOSÓ', 'FOLYÓÁG', 'FOLYÓKA', 'FOLYTAT', 'FOLYTÁN',
            'FOLYTON', 'FONCSOR', 'FONÓDIK', 'FONÓGÉP', 'FONNYAD', 'FORDÍTÓ', 'FORDULÓ', 'FORGÁCS', 'FORMULA', 'FORRALT', 'FORRONG',
            'FORTÉLY', 'FORTYOG', 'FOSZFÁT', 'FOSZFOR', 'FOSZLIK', 'FOTOGÉN', 'FOTÓZÁS', 'FÖLDADÓ', 'FÖLDGÁZ', 'FÖLDPÁT', 'FÖLDSÁV',
            'FÖLDTAN', 'FÖLFELÉ', 'FÖLÖTTE', 'FÖLÖTTI', 'FÖLÖZÉS', 'FÖLSŐBB', 'FÖNTEBB', 'FÖSVÉNY', 'FŐÁLLÁS', 'FŐÁRBOC', 'FŐBÉRLŐ',
            'FŐBŰNÖS', 'FŐEMLŐS', 'FŐISPÁN', 'FŐKÖNYV', 'FŐMUFTI', 'FŐMŰSOR', 'FŐNEMES', 'FŐNŐVÉR', 'FŐOLTÁR', 'FŐORVOS', 'FŐPOSTA',
            'FŐPRÓBA', 'FŐRABBI', 'FŐSODOR', 'FŐTÉTEL', 'FŐTISZT', 'FŐVÁROS', 'FŐVEZÉR', 'FŐVONAL', 'FŐZELÉK', 'FŐZŐLAP', 'FŐZŐVAJ',
            'FRAKCIÓ', 'FRAKTÁL', 'FRANCIA', 'FRANCOS', 'FREGATT', 'FREGOLI', 'FRICSKA', 'FRISSEN', 'FRISSÍT', 'FRISSÜL', 'FRIZURA',
            'FROTTÍR', 'FUGÁZÁS', 'FUKSZIA', 'FULLÁNK', 'FUNKCIÓ', 'FURFANG', 'FURULYA', 'FUSERÁL', 'FUSIZIK', 'FUTBALL', 'FUTKOSÓ',
            'FUTÓBAB', 'FUTÓLAG', 'FUTÓTŰZ', 'FUVAROS', 'FUVAROZ', 'FÚRÓDIK', 'FÚRÓFEJ', 'FÚRÓGÉP', 'FÚVÓCSŐ', 'FÜGGÖNY', 'FÜGGŐÓN',
            'FÜLDUGÓ', 'FÜLELÉS', 'FÜLLEDT', 'FÜLLENT', 'FÜLTANÚ', 'FÜLVÉDŐ', 'FÜLZSÍR', 'FÜRDŐZŐ', 'FÜRKÉSZ', 'FÜRÖSZT', 'FÜSTCSŐ',
            'FÜSTGÁZ', 'FÜSTJEL', 'FÜSTKÖD', 'FÜSTÖLŐ', 'FÜSTÖLT', 'FÜTYKÖS', 'FÜVESÍT', 'FÜVEZÉS', 'FÜVEZIK', 'FŰCSOMÓ', 'FŰNYÍRÓ',
            'FŰTŐGÁZ', 'FŰTŐHÁZ', 'FŰZŐDIK', 'FŰZŐGÉP'
        ]
    },
    'G': {
        '3': [
    ...
    'H': {
        ...
        '4': [
            'HADI', 'HAGY', 'HAHÓ', 'HAJÓ', 'HAJT', 'HALK', 'HALL', 'HALÓ', 'HAMU', 'HAMV', 'HANG', 'HANT', 'HARC', 'HASÉ', 'HASI', 'HATÓ',
            'HAVI', 'HAZA', 'HÁGÓ', 'HÁLA', 'HÁLÓ', 'HÁNT', 'HÁNY', 'HÁRS', 'HÁTI', 'HÁZI', 'HECC', 'HEGY', 'HEKK', 'HELY', 'HERE', 'HESS',
            'HETI', 'HÉJA', 'HIBA', 'HIFI', 'HINT', 'HISZ', 'HIÚZ', 'HÍJA', 'HÍRŰ', 'HÍVE', 'HÍVÓ', 'HÍVŐ', 'HÍZÓ', 'HOGY', 'HOHÓ', 'HOKI',
            'HOLD', 'HOLT', 'HONI', 'HOPP', 'HORD', 'HOVA', 'HOVÁ', 'HÓKA', 'HŐSI', 'HULL', 'HUNY', 'HURI', 'HUSI', 'HÚGY', 'HÚSZ', 'HŰHA',
            'HŰHÓ', 'HŰLT', 'HŰTŐ'
        ],
        '5': [
        ...
        '6': [
            ...
            'HAJZAT', 'HALADÓ', 'HALÁLI', 'HALÁSZ', 'HALKAN', 'HALKÉS', 'HALKÍT', 'HALKUL', 'HALLAT', 'HALLÁS', 'HALLIK', 'HALMAZ',
            'HALMOZ', 'HALOTT', 'HALÓDÓ', 'HALTEJ', 'HAMVAD', 'HAMVAS', 'HANGÁR', 'HANGOL', 'HANGOS', 'HANGZÓ', 'HANGYA', 'HANUKA',
            'HANYAG', 'HANTÁS', 'HANTOL', 'HAPTÁK', 'HARANG', 'HARÁNT', 'HARCOL', 'HARCOS', 'HARCSA', 'HARMAD', 'HARMAT', 'HARSAN',
            'HARSOG', 'HASADT', 'HASPÓK', 'HASTÁJ', 'HASZON', 'HATÁLY', 'HATÉVI', 'HATFŐS', 'HATUNK', 'HATTYÚ', 'HATVAN', 'HAVASI',
            'HAZAAD', 'HAZAÉR', 'HAZAFI', 'HAZAÚT', 'HAZÁIG', 'HAZÁRD', 'HÁBORÚ', 'HÁJFEJ', 'HÁKLIS', 'HÁLYOG', 'HÁMLÁS', 'HÁMLIK',
            'HÁNTOL', 'HÁNYAD', 'HÁNYAN', 'HÁNYAS', 'HÁNYÁS', 'HÁRFÁS', 'HÁRMAN', 'HÁRMAS', 'HÁRPIA', 'HÁRSFA', 'HÁRTYA', 'HÁTAKT',
            'HÁTFAL', 'HÁTLAP', 'HÁTRÁL', 'HÁTTÉR', 'HÁTVÉD', 'HÁZADÓ', 'HÁZALÓ', 'HÁZIAS', 'HÁZBÉR', 'HÁZIKÓ', 'HÁZIÚR', 'HÁZSOR',
            'HEBEGŐ', 'HECCEL', 'HEGEDŰ', 'HEGYES', 'HEGYEZ', 'HEKTÁR', 'HELLÉN', 'HELYÁR', 'HELYES', 'HELYEZ', 'HENCEG', 'HENGER',
            'HENTES', 'HENYÉL', 'HERCEG', 'HERCIG', 'HERÉLT', 'HERGEL', 'HERING', 'HERNYÓ', 'HEROIN', 'HERVAD', 'HETERÓ', 'HETVEN',
            'HETYEG', 'HETYKE', 'HEVENY', 'HEVERŐ', 'HÉLIUM', 'HÉTÉVI', 'HÉTFŐI', 'HÉTFŐS', 'HÉTRÉT', 'HIÁTUS', 'HIBRID', 'HIDRÁL',
            'HIDRÁT', 'HIGANY', 'HIHETŐ', 'HIMBÁL', 'HINTÁS', 'HINTÉS', 'HIMLŐS', 'HIRDET', 'HISZEN', 'HISZTI', 'HITTAN', 'HITVES',
            'HIÚSÁG', 'HIZLAL', 'HÍDVÁM', 'HÍGÍTÓ', 'HÍMNEM', 'HÍMNŐS', 'HÍMPOR', 'HÍMZÉS', 'HÍRADÓ', 'HÍRLAP', 'HÍRLIK', 'HÍRNÉV',
            'HÍRNÖK', 'HOBBIT', 'HODÁLY', 'HOGYAN', 'HOGYHA', 'HOGYNE', 'HOLDAS', 'HOLDÉV', 'HOLLÉT', 'HOLNAP', 'HOLOTT', 'HOLTAN',
            'HOLTÁG', 'HOMÁLY', 'HOMBÁR', 'HOMLOK', 'HOMORÚ', 'HONLAP', 'HONNAN', 'HONVÉD', 'HORDÁR', 'HORDOZ', 'HORGAS', 'HORGOL',
            'HORGOS', 'HORKOL', 'HORMON', 'HORONY', 'HORPAD', 'HORROR', 'HORVÁT', 'HOSSZÚ', 'HOTDOG', 'HOZOTT', 'HÓÁGYÚ', 'HÓBORT',
            'HÓCIPŐ', 'HÓDÍTÓ', 'HÓDOLÓ', 'HÓESÉS', 'HÓKÁSA', 'HÓLÁNC', 'HÓLYAG', 'HÓMARÓ', 'HÓMEZŐ', 'HÓNALJ', 'HÓNAPI', 'HÓRUKK',
            'HÓTOLÓ', 'HÖRGÉS', 'HŐÁLLÓ', 'HŐGUTA', 'HŐMÉRŐ', 'HŐSIES', 'HŐSKOR', 'HUGYOS', 'HUGYOZ', 'HULLAT', 'HULLÁM', 'HUMBUG',
            'HUMUSZ', 'HUNCUT', 'HUPPAN', 'HURCOL', 'HURKOL', 'HUSÁNG', 'HUSZAD', 'HUSZÁR', 'HÚSEVŐ', 'HÚSVÉT', 'HÚSZAN', 'HÚSZAS',
            'HÜMMÖG', 'HÜVELY', 'HŰBÉRI', 'HŰSÍTŐ', 'HŰTLEN', 'HŰTÖTT'
        ],
        '7': [
            ...
            'HÓLAPÁT', 'HÓLEPEL', 'HÓMOBIL', 'HÓVIHAR', 'HÓVIRÁG', 'HÓZÁPOR', 'HÖRCSÖG', 'HÖRPINT', 'HŐERŐMŰ', 'HŐPAPÍR', 'HŐSTETT',
            'HŐTARTÓ', 'HUMÁNUS', 'HÓNAPOS', 'HUHOGÁS', 'HULIGÁN', 'HULLOTT', 'HUMÁNUM', 'HUMÁNUS', 'HUMOROS', 'HURUTOS', 'HUZAMOS',
            'HUZATOS', 'HÚGYCSŐ', 'HÚGYSAV', 'HÚSBOLT', 'HÚSÉTEL', 'HÚSIPAR', 'HÚSVÉTI', 'HÚSZÉVI', 'HÚSSZOR', 'HÚZÓDÁS', 'HÚZÓDIK',
            'HÚZÓZÁR', 'HÜVELYK', 'HŰBÉRES', 'HŰBÉRÚR', 'HŰDÉSES', 'HŰSÉGES', 'HŰSÖLÉS', 'HŰTŐGÉP', 'HŰTŐHÁZ', 'HŰTŐVÍZ', 'HŰVÖSEN'
        ]
    },
    'I': {
        '3': [
        ...
        '4': [
            ...
            'INTŐ', 'IPAR', 'IPSE', 'IRAM', 'IRAT', 'IRHA', 'IRKA', 'IRTÓ', 'ITAL', 'ITAT', 'IVÁS', 'IZÉL', 'IZGI', 'IZOM', 'IZZÓ'
        ],
        '5': [
        ...
        '7': [
            ...
            'ISZAPOS', 'ISZÁKOS', 'ISZOGAT', 'ISZONYÚ', 'ITTHONI', 'IVÁSZAT', 'IVÓKÚRA', 'IZGALMI', 'IZGALOM', 'IZGATÁS', 'IZOMERŐ',
            'IZOMLÁZ', 'IZOMZAT', 'IZZADÁS', 'IZZASZT'
        ]
    },
    'Í': {
        '3': [
    ...
    'K': {
        '3': [
            'KAN', 'KAP', 'KAR', 'KAS', 'KÁD', 'KÁN', 'KÁR', 'KEL', 'KEN', 'KÉJ', 'KÉK', 'KÉL', 'KÉM', 'KÉN', 'KÉP', 'KÉR', 'KÉS', 'KÉT',
            'KÉZ', 'KIÉ', 'KIK', 'KIN', 'KIS', 'KIT', 'KÍN', 'KOR', 'KOS', 'KÓC', 'KÓD', 'KÓR', 'KÖB', 'KÖD', 'KÖP', 'KÖR', 'KÖT', 'KÖZ',
            'KŐR', 'KUN', 'KÚP', 'KÚT', 'KŰR'
        ],
        '4': [
            'KACS', 'KAJA', 'KAKA', 'KAKI', 'KAMU', 'KAPA', 'KAPU', 'KARC', 'KARD', 'KARI', 'KARÓ', 'KÁBA', 'KÁDI', 'KÁKA', 'KÁLA', 'KÁNA',
            'KÁPA', 'KÁPÉ', 'KÁRÓ', 'KÁSA', 'KÁTÉ', 'KÁVA', 'KÁVÉ', 'KECS', 'KEDD', 'KEDV', 'KEFE', 'KEGY', 'KEKI', 'KELL', 'KELT', 'KEND',
            'KENÓ', 'KENU', 'KEPE', 'KERT', 'KESE', 'KEZD', 'KÉNE', 'KÉNY', 'KÉPI', 'KÉRD', 'KÉRÓ', 'KÉRŐ', 'KÉSŐ', 'KÉSZ', 'KÉVE', 'KÉZI',
            'KIAD', 'KIÁS', 'KIES', 'KIÉG', 'KIÉL', 'KIÉR', 'KIFŐ', 'KIÍR', 'KILÓ', 'KILŐ', 'KINN', 'KINŐ', 'KINT', 'KIÖL', 'KIRÍ', 'KIRÓ',
            'KIÚT', 'KIÜL', 'KIÜT', 'KIŰZ', 'KIWI', 'KLÁN', 'KLIP', 'KLÓN', 'KLÓR', 'KLUB', 'KOCA', 'KOFA', 'KOHÓ', 'KOMA', 'KOMP', 'KONC',
            'KONG', 'KOPT', 'KOPÓ', 'KORA', 'KORD', 'KOSZ', 'KOVA', 'KÓDA', 'KÓLA', 'KÓLÓ', 'KÓMA', 'KÓPÉ', 'KÓRÓ', 'KÖLT', 'KÖPŰ', 'KÖRÉ',
            'KÖSZ', 'KÖTŐ', 'KÖZÉ', 'KÖZT', 'KŐSÓ', 'KRÉM', 'KRÓM', 'KUKA', 'KUKI', 'KUKK', 'KULI', 'KUPA', 'KUPÉ', 'KÚRA', 'KÜLD', 'KÜRT',
            'KÜZD', 'KVÍZ'
        ],
        '5': [
            'KABÁT', 'KABIN', 'KACAG', 'KACAJ', 'KACAT', 'KACÉR', 'KACSA', 'KACSÓ', 'KADÉT', 'KAJAK', 'KAJÁL', 'KAJÁN', 'KAJLA', 'KAJÜT',
            'KAKAÓ', 'KAKAS', 'KAKÁL', 'KAKIL', 'KALAP', 'KALÓZ', 'KAMAT', 'KAMRA', 'KANÁL', 'KANCA', 'KANKÓ', 'KANNA', 'KANOS', 'KANÓC',
            'KANÜL', 'KAPAR', 'KAPÁL', 'KAPCA', 'KAPOR', 'KAPÓS', 'KAPUS', 'KARAJ', 'KARÁM', 'KARÁT', 'KARÉJ', 'KARFA', 'KARMA', 'KAROL',
            'KAROM', 'KARÓS', 'KARÓZ', 'KARTA', 'KASPÓ', 'KASZA', 'KASZT', 'KATÓD', 'KAVAR', 'KAZAH', 'KAZAL', 'KAZÁN', 'KÁBEL', 'KÁBÍT',
            'KÁBUL', 'KÁDAS', 'KÁDÁR', 'KÁDER', 'KÁNON', 'KÁNYA', 'KÁOSZ', 'KÁROG', 'KÁROS', 'KÁSÁS', 'KÁTYÚ', 'KÁVÉS', 'KEBEL', 'KEDDI',
            'KEFÉL', 'KEFÍR', 'KEKSZ', 'KELET', 'KELÉS', 'KELLŐ', 'KELME', 'KELTA', 'KELTŐ', 'KENCE', 'KENDŐ', 'KENET', 'KENÉS', 'KEREK',
            'KERES', 'KERET', 'KERÉK', 'KERGE', 'KERÍT', 'KERTI', 'KERUB', 'KERÜL', 'KETTÉ', 'KETTŐ', 'KEVER', 'KEVÉS', 'KEZDŐ', 'KEZEL',
            'KEZES', 'KEZEZ', 'KÉGLI', 'KÉJES', 'KÉJNŐ', 'KÉKES', 'KÉKÍT', 'KÉKÜL', 'KÉMIA', 'KÉMNŐ', 'KÉNES', 'KÉNEZ', 'KÉNKŐ', 'KÉPES',
            'KÉPEZ', 'KÉPZŐ', 'KÉRDŐ', 'KÉREG', 'KÉREM', 'KÉRET', 'KÉRÉS', 'KÉSEI', 'KÉSEL', 'KÉSES', 'KÉSÉS', 'KÉSIK', 'KÉSŐI', 'KÉSŐN',
            'KÉTES', 'KHAKI', 'KIADÓ', 'KIÁLL', 'KIÁLT', 'KIBIC', 'KIBÍR', 'KIBÖK', 'KIBUC', 'KICSI', 'KIDOB', 'KIDŐL', 'KIDUG', 'KIEJT',
            'KIÉLT', 'KIFED', 'KIFEJ', 'KIFEN', 'KIFÉR', 'KIFLI', 'KIFOG', 'KIFŐZ', 'KIFUT', 'KIFÚJ', 'KIFÚR', 'KIFŰT', 'KIFŰZ', 'KIHAL',
            'KIHAT', 'KIHÍV', 'KIHOZ', 'KIHÚZ', 'KIHŰL', 'KIHŰT', 'KIIRT', 'KIJÁR', 'KIJÖN', 'KIJUT', 'KIKAP', 'KIKEL', 'KIKEN', 'KIKÉR',
            'KIKÖP', 'KIKÖT', 'KILÁT', 'KILEL', 'KILES', 'KILÉP', 'KILÉT', 'KILOP', 'KILÓG', 'KILÖK', 'KIMAR', 'KIMER', 'KIMÉR', 'KIMOS',
            'KINCS', 'KINÉZ', 'KINCS', 'KININ', 'KINTI', 'KIOLD', 'KIOLT', 'KIONT', 'KIÖLT', 'KIÖNT', 'KISÍR', 'KIRAK', 'KIRÁG', 'KIRÁZ',
            'KIRÚG', 'KISÍR', 'KISSÉ', 'KISÜL', 'KISÜT', 'KITÁR', 'KITÁT', 'KITÉP', 'KITÉR', 'KITIN', 'KITOL', 'KITÖM', 'KITÖR', 'KITÚR',
            'KITŰZ', 'KIVAN', 'KIVÁG', 'KIVÁJ', 'KIVÁR', 'KIVER', 'KIVET', 'KIVÉD', 'KIVÉS', 'KIVÉT', 'KIVÍV', 'KIVON', 'KIZÁR', 'KÍGYÓ',
            'KÍNAI', 'KÍNÁL', 'KÍNOS', 'KÍNOZ', 'KÍNZÓ', 'KÍSÉR', 'KÍVÁN', 'KÍVÜL', 'KLIKK', 'KLISÉ', 'KLÍMA', 'KOALA', 'KOBAK', 'KOCKA',
            'KOCOG', 'KOCSI', 'KOMÁZ', 'KOMBI', 'KOMLÓ', 'KOMOR', 'KOMÓD', 'KONDA', 'KONDI', 'KONGA', 'KONOK', 'KONTY', 'KOPÁR', 'KOPÁS',
            'KOPIK', 'KOPOG', 'KORAI', 'KORÁL', 'KORÁN', 'KORCS', 'KORDÉ', 'KORHŰ', 'KOROG', 'KOROM', 'KOROS', 'KORPA', 'KORSÓ', 'KORTY',
            'KORZÓ', 'KOSÁR', 'KOSZT', 'KOTON', 'KOTOR', 'KOTTA', 'KOZÁK', 'KÓBOR', 'KÓCOL', 'KÓCOS', 'KÓDEX', 'KÓDOL', 'KÓKAD', 'KÓMÁS',
            'KÓPIA', 'KÓROS', 'KÓRUS', 'KÓSER', 'KÓSZA', 'KÖDÖL', 'KÖDÖS', 'KÖHÖG', 'KÖLES', 'KÖLNI', 'KÖLTŐ', 'KÖNNY', 'KÖNYV', 'KÖPET',
            'KÖPÉS', 'KÖPÜL', 'KÖRBE', 'KÖRET', 'KÖRÍT', 'KÖRÍV', 'KÖRÖM', 'KÖRÖZ', 'KÖRTE', 'KÖRÚT', 'KÖRÜL', 'KÖRZŐ', 'KÖSZI', 'KÖTEG',
            'KÖTET', 'KÖTÉL', 'KÖTÉS', 'KÖTÖZ', 'KÖTVE', 'KÖVES', 'KÖVET', 'KÖVEZ', 'KÖVÉR', 'KÖZBE', 'KÖZEG', 'KÖZEL', 'KÖZÉP', 'KÖZJÓ',
            'KÖZMŰ', 'KÖZÖL', 'KÖZÖS', 'KÖZTE', 'KÖZTI', 'KÖZÚT', 'KÖZÜL', 'KŐFAL', 'KŐKOR', 'KŐLAP', 'KŐPOR', 'KŐZET', 'KRACH', 'KREÁL',
            'KREOL', 'KREPP', 'KRESZ', 'KRÉTA', 'KRIMI', 'KROKI', 'KUCKÓ', 'KUFÁR', 'KUGLI', 'KUJON', 'KUKAC', 'KUKÁS', 'KUKÁZ', 'KUKTA',
            'KULÁK', 'KULCS', 'KUPAC', 'KUPAK', 'KUPEC', 'KUPLÉ', 'KUPON', 'KURTA', 'KURUC', 'KUSZA', 'KUTAS', 'KUTAT', 'KUTYA', 'KUVIK',
            'KÚPOS', 'KÚRÁL', 'KÚRIA', 'KÚTFŐ', 'KÜBLI', 'KÜLDŐ', 'KÜLLŐ', 'KÜLÖN', 'KÜLSŐ', 'KÜRTŐ', 'KÜTYÜ', 'KÜZDŐ', 'KVARC', 'KVARK',
            'KVINT', 'KVITT', 'KVÓTA'
        ],
        '6': [
            'KABALA', 'KABARÉ', 'KABÓCA', 'KAFTÁN', 'KAGYLÓ', 'KAJMÁN', 'KAJSZI', 'KAKADU', 'KAKUKK', 'KALAND', 'KALÁCS', 'KALÁSZ',
            'KALAUZ', 'KALIFA', 'KALMÁR', 'KALODA', 'KAMARA', 'KAMASZ', 'KAMERA', 'KAMION', 'KAMPEC', 'KAMPÓS', 'KANAPÉ', 'KANÁRI',
            'KANÁSZ', 'KANCSÓ', 'KANDÚR', 'KANNÁS', 'KANTÁR', 'KANTIN', 'KANTON', 'KANYAR', 'KAPKOD', 'KAPOCS', 'KAPPAN', 'KAPROS',
            'KAPTAT', 'KAPTÁR', 'KAPUFA', 'KAPZSI', 'KARATE', 'KARCOL', 'KARCOS', 'KARCSÚ', 'KARDÉL', 'KARDOS', 'KARIKA', 'KARIMA',
            'KARMOL', 'KARNIS', 'KARÓRA', 'KARSZT', 'KARTON', 'KARZAT', 'KASMÍR', 'KASZÁL', 'KASZÁS', 'KASSZA', 'KATICA', 'KATLAN',
            'KATONA', 'KATTAN', 'KATTOG', 'KAUCIÓ', 'KAVIÁR', 'KAVICS', 'KAZUÁR', 'KÁBÍTÓ', 'KÁBULT', 'KÁLIUM', 'KÁLYHA', 'KÁMFOR',
            'KÁMZSA', 'KÁNKÁN', 'KÁNTOR', 'KÁPLÁN', 'KÁPLÁR', 'KÁRPIT', 'KÁRTOL', 'KÁRTYA', 'KÁVÉZÓ', 'KECMEC', 'KECSES', 'KECSKE',
            'KEDÉLY', 'KEDVEL', 'KEDVES', 'KEDVEZ', 'KEGYES', 'KEHELY', 'KELETI', 'KELETŰ', 'KELLEM', 'KELLÉK', 'KELTET', 'KELTEZ',
            'KEMÉNY', 'KENDER', 'KENDŐZ', 'KENYÉR', 'KENŐCS', 'KENYÉR', 'KERENG', 'KERESŐ', 'KERGET', 'KERING', 'KERÍTŐ', 'KERTES',
            'KERTEL', 'KERTES', 'KERÜLŐ', 'KESERŰ', 'KESZEG', 'KESZON', 'KETREC', 'KETTED', 'KETTEN', 'KETTES', 'KETTŐS', 'KETTŐZ',
            'KETYEG', 'KEVÉLY', 'KEVERŐ', 'KEVERT', 'KEZDET', 'KEZDÉS', 'KEZDVE', 'KEZELŐ', 'KÉJENC', 'KÉMCSŐ', 'KÉMÉNY', 'KÉMIAI',
            'KÉMLEL', 'KÉNSAV', 'KÉNYES', 'KÉNYÚR', 'KÉPCSŐ', 'KÉPEST', 'KÉPLET', 'KÉPMÁS', 'KÉPTÁR', 'KÉPZEL', 'KÉPZÉS', 'KÉPZET',
            'KÉRDEZ', 'KÉRDÉS', 'KÉRDŐN', 'KÉRÉSZ', 'KÉRGES', 'KÉRLEL', 'KÉSŐBB', 'KÉSZEN', 'KÉSZÍT', 'KÉSZÜL', 'KÉTÁGÚ', 'KÉTELL',
            'KÉTELY', 'KÉTÉLŰ', 'KÉTÉVI', 'KÉTFŐS', 'KÉTRÉT', 'KÉTSÉG', 'KÉZELŐ', 'KÉZFEJ', 'KIABÁL', 'KIADÁS', 'KIADÓS', 'KIAPAD',
            'KIÁLLÓ', 'KIÁLTÓ', 'KIÁRAD', 'KIÁSÁS', 'KIÁZIK', 'KIBBUC', 'KIBONT', 'KIBÚVÓ', 'KICSAL', 'KICSAP', 'KICSÍP', 'KICSUK',
            'KIDÖNT', 'KIEMEL', 'KIESÉS', 'KIESIK', 'KIEVEZ', 'KIÉGET', 'KIÉGÉS', 'KIÉKEL', 'KIÉLEZ', 'KIÉPÍT', 'KIÉPÜL', 'KIÉREZ',
            'KIFEJT', 'KIFELÉ', 'KIFEST', 'KIFOGY', 'KIFORR', 'KIFŐTT', 'KIFUTÓ', 'KIHAGY', 'KIHAJT', 'KIHALL', 'KIHALÓ', 'KIHALT',
            'KIHÁNY', 'KIHÍVÓ', 'KIHORD', 'KIÍRAT', 'KIÍRÁS', 'KIJÁRÓ', 'KIKEZD', 'KIKELT', 'KIKÖLT', 'KIKÖTŐ', 'KIKÜLD', 'KILÁTÓ',
            'KILENC', 'KILENG', 'KIMÉRA', 'KIMÉRT', 'KIMOND', 'KIMONÓ', 'KINŐTT', 'KINYAL', 'KINYIT', 'KINYÍR', 'KINYOM', 'KINYÖG',
            'KINYÚL', 'KIOKÁD', 'KIOLDÓ', 'KIOSON', 'KIOSZK', 'KIOSZT', 'KIÖTÖL', 'KIRAKÓ', 'KIRÁLY', 'KIRÁNT', 'KIRGIZ', 'KIRÍVÓ',
            'KIRONT', 'KISAGY', 'KISÁGY', 'KISDED', 'KISDOB', 'KISEBB', 'KISFIÚ', 'KISHAL', 'KISIET', 'KISÍRT', 'KISPAD', 'KISPAP',
            'KISUJJ', 'KISVAD', 'KISZAB', 'KISZED', 'KISZEL', 'KISZÍV', 'KISZÓL', 'KISZÓR', 'KISZÚR', 'KISZŰR', 'KITART', 'KITESZ',
            'KITEVŐ', 'KITÉRŐ', 'KITILT', 'KITÖLT', 'KITÖRŐ', 'KITŰNŐ', 'KITŰZŐ', 'KIUGRÓ', 'KIUTAL', 'KIUTÁL', 'KIÚJUL', 'KIÜLÉS',
            'KIÜRÍT', 'KIÜRÜL', 'KIÜTÉS', 'KIŰZÉS', 'KIVARR', 'KIVÁJT', 'KIVÁLÓ', 'KIVÁLT', 'KIVERT', 'KIVESZ', 'KIVÉSZ', 'KIVÉVE',
            'KIVISZ', 'KIVONT', 'KIZÁRT', 'KÍNPAD', 'KÍNRÍM', 'KÍNZÁS', 'KÍSÉRŐ', 'KÍSÉRT', 'KÍVÜLI', 'KLASSZ', 'KLÉRUS', 'KLIENS',
            'KLIMAX', 'KLIPSZ', 'KLOÁKA', 'KLOTYÓ', 'KLOZET', 'KLÓNOZ', 'KLÓROS', 'KLÓROZ', 'KLUMPA', 'KNÉDLI', 'KOBALT', 'KOBOLD',
            'KOCCAN', 'KOCKÁS', 'KOCOGÓ', 'KOCSIS', 'KOCSMA', 'KOFFER', 'KOHÁSZ', 'KOHOLT', 'KOHÓMŰ', 'KOKAIN', 'KOKETT', 'KOKOTT',
            'KOKTÉL', 'KOLDUL', 'KOLDUS', 'KOLERA', 'KOLESZ', 'KOLHOZ', 'KOLOMP', 'KOLONC', 'KOMIKA', 'KOMISZ', 'KOMOLY', 'KOMPÓT',
            'KONCOL', 'KONDÁS', 'KONDÉR', 'KONDOM', 'KONGAT', 'KONKÁV', 'KONTÁR', 'KONTRA', 'KONTÚR', 'KONVEX', 'KONVOJ', 'KONZOL',
            'KONZUL', 'KONYAK', 'KONYHA', 'KONYÍT', 'KONYUL', 'KOPASZ', 'KOPLAL', 'KOPOTT', 'KOPPAN', 'KOPTAT', 'KORALL', 'KORÁBB',
            'KORÁNT', 'KORDON', 'KORHAD', 'KORHOL', 'KORKÉP', 'KORLÁT', 'KORMOS', 'KORMOZ', 'KORONA', 'KORONG', 'KORPÁS', 'KOSBOR',
            'KOSZOS', 'KOTLIK', 'KOTRÁS', 'KOTTÁZ', 'KOTYOG', 'KOVAKŐ', 'KOVÁCS', 'KOVÁSZ', 'KOZMÁL', 'KOZMÁS', 'KÓCSAG', 'KÓDOLT',
            'KÓKLER', 'KÓLIKA', 'KÓRHÁZ', 'KÓRLAP', 'KÓRTAN', 'KÓSTOL', 'KÓSZÁL', 'KÖCSÖG', 'KÖDLIK', 'KÖDMÖN', 'KÖHINT', 'KÖKÉNY',
            'KÖLDÖK', 'KÖLTÉS', 'KÖLTŐI', 'KÖLYÖK', 'KÖMÉNY', 'KÖNNYŰ', 'KÖNTÖS', 'KÖNYÖK', 'KÖPCÖS', 'KÖPDÖS', 'KÖPENY', 'KÖPKÖD',
            'KÖRBEN', 'KÖRGÁT', 'KÖRKÉP', 'KÖRMÖL', 'KÖRMÖS', 'KÖRÖND', 'KÖRTÉR', 'KÖRÜLE', 'KÖRÜLI', 'KÖRZET', 'KÖSZÖN', 'KÖTBÉR',
            'KÖTÉNY', 'KÖTÖDE', 'KÖTÖTT', 'KÖTŐTŰ', 'KÖTTET', 'KÖVETŐ', 'KÖZADÓ', 'KÖZBEN', 'KÖZCÉL', 'KÖZELI', 'KÖZÉRT', 'KÖZFAL',
            'KÖZHÍR', 'KÖZÍRÓ', 'KÖZJOG', 'KÖZLÉS', 'KÖZNAP', 'KÖZNÉP', 'KÖZÖNY', 'KÖZÖTT', 'KÖZSÉG', 'KÖZTES', 'KÖZTÉR', 'KÖZÚTI',
            'KÖZÜGY', 'KŐKORI', 'KŐOLAJ', 'KŐSZÉN', 'KŐTÖMB', 'KRAPEK', 'KRÁKOG', 'KRÁTER', 'KREDIT', 'KRETÉN', 'KRÉKER', 'KRÉMES',
            'KRÉMEZ', 'KRÉTÁS', 'KRIGLI', 'KRIPTA', 'KRÍZIS', 'KRÓMOS', 'KRÓMOZ', 'KRŐZUS', 'KRUPIÉ', 'KUCSMA', 'KUDARC', 'KUGLER',
            'KUGLÓF', 'KUKKOL', 'KUKSOL', 'KUKUCS', 'KULACS', 'KULLOG', 'KUNCOG', 'KUNSZT', 'KUNYHÓ', 'KUPICA', 'KUPOLA', 'KURBLI',
            'KURTÁN', 'KURTÍT', 'KURZÍV', 'KURZOR', 'KURZUS', 'KUSHAD', 'KUSSOL', 'KUTACS', 'KUTATÓ', 'KUTYÁS', 'KUTYUS', 'KUVASZ',
            'KÚSZIK', 'KÚTÁSÓ', 'KÚTGÉM', 'KÚTVÍZ', 'KÜLDÉS', 'KÜLLEM', 'KÜLÖNB', 'KÜLÖNC', 'KÜLSŐS', 'KÜLTAG', 'KÜLÜGY', 'KÜRTÖL',
            'KÜRTÖS', 'KÜSZÖB', 'KÜZDÉS', 'KVAZÁR'
        ],
        '7': [
            'KABINET', 'KABINOS', 'KACAGÁS', 'KACATOS', 'KACKIÁS', 'KACSINT', 'KADARKA', 'KADMIUM', 'KAGYLÓS', 'KAGYLÓZ', 'KAJAKOS',
            'KAKTUSZ', 'KALAPÁL', 'KALAPOS', 'KALYIBA', 'KALIBER', 'KALITKA', 'KALÓRIA', 'KAMÁSLI', 'KAMILLA', 'KAMPÁNY', 'KANALAS',
            'KANALAZ', 'KANÁLIS', 'KANBULI', 'KANCSAL', 'KANDZSI', 'KANMURI', 'KANONOK', 'KANTÁTA', 'KANYARÓ', 'KAPARÁS', 'KAPARÓS',
            'KAPCSÁN', 'KAPCSOL', 'KAPCSOS', 'KAPHATÓ', 'KAPKODÓ', 'KAPTAFA', 'KAPTATÓ', 'KAPUALJ', 'KAPUCNI', 'KARAKÁN', 'KARAOKE',
            'KARAVÁN', 'KARDLAP', 'KARÉNEK', 'KARFIOL', 'KARIKÁS', 'KARIZMA', 'KARIZOM', 'KARKÖTŐ', 'KARNAGY', 'KAROTIN', 'KAROTTA',
            'KARRIER', 'KARTÁRS', 'KARTELL', 'KARVALY', 'KASÍROZ', 'KASTÉLY', 'KASZAKŐ', 'KASZINÓ', 'KATALÁN', 'KATATÓN', 'KATEDRA',
            'KATÉTER', 'KATONAI', 'KATONÁS', 'KATTINT', 'KAUCSUK', 'KAVARÁS', 'KAVAROG', 'KAZETTA', 'KÁBELEZ', 'KÁBÍTÁS', 'KÁBÍTÓS',
            'KÁBULAT', 'KÁLCIUM', 'KÁLYHÁS', 'KÁPOLNA', 'KÁRESET', 'KÁROMOL', 'KÁROSAN', 'KÁRÖRÖM', 'KÁRTEVŐ', 'KÁRTOLT', 'KÁRTYÁS',
            'KÁTRÁNY', 'KÁVÉBAB', 'KÁVÉHÁZ', 'KÁVÉZÁS', 'KÁVÉZIK', 'KECSEGE', 'KEDVELŐ', 'KEDVELT', 'KEDVENC', 'KEDVEZŐ', 'KEFEHAJ',
            'KEGYENC', 'KELENDŐ', 'KELEPCE', 'KELEPEL', 'KELESZT', 'KELLENE', 'KELLŐEN', 'KELTETŐ', 'KEMENCE', 'KEMPING', 'KENEGET',
            'KENETES', 'KENGURU', 'KENGYEL', 'KENTAUR', 'KENUZÁS', 'KENUZIK', 'KERAMIT', 'KERÁMIA', 'KEREKEN', 'KEREKES', 'KEREKÍT',
            'KERENGŐ', 'KEREPEL', 'KEREPLŐ', 'KERESET', 'KERESÉS', 'KERESZT', 'KERETES', 'KERETEZ', 'KEREVET', 'KERINGŐ', 'KERÍTÉS',
            'KEROZIN', 'KERTÉSZ', 'KERÜLET', 'KESELYŰ', 'KESEREG', 'KESERGŐ', 'KESERÍT', 'KESKENY', 'KESUDIÓ', 'KESZTYŰ', 'KETCHUP',
            'KETYEGŐ', 'KETTYEN', 'KEVEREG', 'KEVERÉK', 'KEVERÉS', 'KEVÉSBÉ', 'KEVESEN', 'KEVÉSKE', 'KEVÉSSÉ', 'KEZDETI', 'KEZELÉS',
            'KEZEZÉS', 'KÉJELEG', 'KÉKRÓKA', 'KÉKVÉRŰ', 'KÉMIKUS', 'KÉNEZÉS', 'KÉPESÍT', 'KÉPISÉG', 'KÉPÍRÁS', 'KÉPMEZŐ', 'KÉPPONT',
            'KÉPZELT', 'KÉPZETT', 'KÉRDŐÍV', 'KÉREGET', 'KÉRELEM', 'KÉRKEDŐ', 'KÉRŐDZŐ', 'KÉRVÉNY', 'KÉSELÉS', 'KÉSHEGY', 'KÉSŐBBI',
            'KÉSZÁRU', 'KÉSZÍTŐ', 'KÉSZLET', 'KÉSZSÉG', 'KÉSZTET', 'KÉSZÜLŐ', 'KÉSZÜLT', 'KÉTERES', 'KÉTEZER', 'KÉTÉLTŰ', 'KÉTÉVES',
            'KÉTFEJŰ', 'KÉTFELÉ', 'KÉTFÉLE', 'KÉTHAVI', 'KÉTHETI', 'KÉTKEZI', 'KÉTKEZŰ', 'KÉTLÁBÚ', 'KÉTLAKI', 'KÉTNAPI', 'KÁTÓRAI',
            'KÉTÓRÁS', 'KÉTPÚPÚ', 'KÉTSZÁZ', 'KÉTSZER', 'KÉTTAGÚ', 'KÉZCSÓK', 'KÉZIFÉK', 'KÉZIRAT', 'KÉZÍRÁS', 'KÉZJEGY', 'KÉZKRÉM',
            'KIAGYAL', 'KIAKNÁZ', 'KIALUDT', 'KIÁLLÁS', 'KIÁLLÍT', 'KIÁLTÁS', 'KIÁLTOZ', 'KIÁTKOZ', 'KIÁZTAT', 'KIBELEZ', 'KIBETŰZ',
            'KIBÉKÍT', 'KIBÉKÜL', 'KIBÉLEL', 'KIBÉREL', 'KIBICEL', 'KIBORÍT', 'KIBOGOZ', 'KIBORÍT', 'KIBORUL', 'KIBŐVÍT', 'KIBŐVÜL',
            'KIBUKIK', 'KIBULIZ', 'KIBÚJIK', 'KICIPEL', 'KICSENG', 'KICSIKE', 'KICSINY', 'KICSODA', 'KICSÖNG', 'KIDAGAD', 'KIDERÍT',
            'KIDERÜL', 'KIDOBÁS', 'KIDOBÓS', 'KIDŐLÉS', 'KIDUMÁL', 'KIEJTÉS', 'KIEMELT', 'KIENGED', 'KIESZEL', 'KIESZIK', 'KIETLEN',
            'KIÉGETT', 'KIÉLVEZ', 'KIÉRZIK', 'KIFAKAD', 'KIFAKÍT', 'KIFAKUL', 'KIFARAG', 'KIFAROL', 'KIFÁRAD', 'KIFEJEZ', 'KIFESTŐ',
            'KIFÉSÜL', 'KIFILÉZ', 'KIFIZET', 'KIFOGÁS', 'KIFOLYÓ', 'KIFOSZT', 'KIFŐZDE', 'KIFŐZÉS', 'KIFUTÁS', 'KIFŰTÉS', 'KIGÁZOL',
            'KIGŐZÖL', 'KIGURÍT', 'KIGURUL', 'KIHAJÍT', 'KIHAJOL', 'KIHAJTÓ', 'KIHALÁS', 'KIHARAP', 'KIHASAD', 'KIHASÍT', 'KIHATÁS',
            'KIHÁGÁS', 'KIHÁMOZ', 'KIHERÉL', 'KIHEVER', 'KIHEVÜL', 'KIHÍMEZ', 'KIHÍVAT', 'KIHÍVÁS', 'KIHÍZIK', 'KIHOZAT', 'KIHOZÁS',
            'KIHÚZAT', 'KIHÚZÁS', 'KIHŰLÉS', 'KIHŰTÉS', 'KIIKTAT', 'KIINDUL', 'KIIRTÁS', 'KIISMER', 'KIISZIK', 'KIIZZAD', 'KIJAVÍT',
            'KIJÁRAT', 'KIJÁRÁS', 'KIJELEZ', 'KIJELÖL', 'KIJELZŐ', 'KIJJEBB', 'KIJÖVET', 'KIJUTÁS', 'KIKACAG', 'KIKAPAR', 'KIKAPÁL',
            'KIKAPÁS', 'KIKAPÓS', 'KIKAVAR', 'KIKEFÉL', 'KIKELET', 'KIKELÉS', 'KIKENÉS', 'KIKERES', 'KIKERÜL', 'KIKEVER', 'KIKEZEL',
            'KIKÉPEZ', 'KIKÉRÉS', 'KIKIÁLT', 'KIKÍSÉR', 'KIKOPIK', 'KIKOPOG', 'KIKOTOR', 'KIKÖHÖG', 'KIKÖPÉS', 'KIKÖTÉS', 'KIKÖVEZ',
            'KIKUTAT', 'KIKÚRÁL', 'KILAZÍT', 'KILÁBAL', 'KILÁTÁS', 'KILEHEL', 'KILESÉS', 'KILÉPÉS', 'KILINCS', 'KILOPÁS', 'KILÓDÍT',
            'KILÓGAT', 'KILÓGÁS', 'KILÖKÉS', 'KILÖVÉS', 'KILÚGOZ', 'KIMAGOZ', 'KIMARAD', 'KIMARÁS', 'KIMERED', 'KIMERÉS', 'KIMERÍT',
            'KIMERÜL', 'KIMÉRÉS', 'KIMÉRVE', 'KIMETSZ', 'KIMUTAT', 'KIMÚLIK', 'KIMŰVEL', 'KINCSES', 'KINEVEL', 'KINEVET', 'KINEVEZ',
            'KINÉZET', 'KINÉZÉS', 'KINÖVÉS', 'KINYÚJT', 'KINYÚLT', 'KIOKTAT', 'KIOLDÁS', 'KIOLLÓZ', 'KIOLTÁS', 'KIOLVAD', 'KIOLVAS',
            'KIONTÁS', 'KIÖBLÍT', 'KIÖMLIK', 'KIÖNTÉS', 'KIPAKOL', 'KIPEREG', 'KIPÉCÉZ', 'KIPIHEN', 'KIPIPÁL', 'KIPIRUL', 'KIPOFOZ',
            'KIPOROL', 'KIPÓTOL', 'KIPÖDÖR', 'KIPUCOL', 'KIRABOL', 'KIRAGAD', 'KIRAKAT', 'KIRAKÁS', 'KIRÁGÁS', 'KIRÁLYI', 'KIRÁMOL',
            'KIRÁZÁS', 'KIREPED', 'KIREPÍT', 'KIREPÜL', 'KIRÍVÁS', 'KIROBOG', 'KIROHAN', 'KIROVÁS', 'KIRÖHÖG', 'KIRÖPÍT', 'KIRÖPÜL',
            'KIRÚGÁS', 'KISAUTÓ', 'KISBABA', 'KISBETŰ', 'KISBÍRÓ', 'KISBUSZ', 'KISDIÁK', 'KISEGÍT', 'KISEPER', 'KISÉTÁL', 'KISFILM',
            'KISFIÚS', 'KISHITŰ', 'KISIMÍT', 'KISIMUL', 'KISINAS', 'KISIPAR', 'KISKAPU', 'KISKORÚ', 'KISLÁNY', 'KISMAMA', 'KISOKOS',
            'KISÖPÖR', 'KISÚROL', 'KISÜLÉS', 'KISÜSTI', 'KISÜTÉS', 'KISÜZEM', 'KISZÁLL', 'KITAGAD', 'KITAKAR', 'KITALÁL', 'KITANÍT',
            'KITANUL', 'KITAPOS', 'KITARTÓ', 'KITÁGÍT', 'KITÁGUL', 'KITÁLAL', 'KITÁRUL', 'KITEKER', 'KITELEL', 'KITELIK', 'KITEREL',
            'KITERÍT', 'KITERÜL', 'KITÉPÉS', 'KITÉRÉS', 'KITÉTEL', 'KITOLAT', 'KITOLÁS', 'KITÓDUL', 'KITÖMÉS', 'KITÖRÉS', 'KITÖRIK',
            'KITÖRÖL', 'KITÚRÁS', 'KITŰNIK', 'KITŰZÉS', 'KIUGRÁS', 'KIUGRIK', 'KIÚSZIK', 'KIÜLTET', 'KIVAKAR', 'KIVASAL', 'KIVÁGAT',
            'KIVÁGÁS', 'KIVÁJÁS', 'KIVÁLÁS', 'KIVÁLIK', 'KIVÁRÁS', 'KIVERÉS', 'KIVESÉZ', 'KIVETÉS', 'KIVETÍT', 'KIVEZET', 'KIVÉDÉS',
            'KIVÉGEZ', 'KIVÉNÜL', 'KIVÉSÉS', 'KIVÉTEL', 'KIVITEL', 'KIVONAT', 'KIVONÁS', 'KIVONUL', 'KIZAVAR', 'KIZÁRÁS', 'KIZUHAN',
            'KIZÚDUL', 'KÍGYÓZÓ', 'KÍNÁLAT', 'KÍNÁLÁS', 'KÍSÉRET', 'KÍSÉRÉS', 'KÍSÉRTŐ', 'KÍVÁNÁS', 'KÍVÁNÓS', 'KLAPPOL', 'KLEZMER',
            'KLIKKEL', 'KLINIKA', 'KLOZETT', 'KLUBTAG', 'KOCCINT', 'KOCKAKŐ', 'KOCOGÁS', 'KOCSÁNY', 'KOCSIÚT', 'KOFFEIN', 'KOHÉZIÓ',
            'KOKÁRDA', 'KOLBÁSZ', 'KOLERÁS', 'KOLIBRI', 'KOLLÁZS', 'KOLLÉGA', 'KOLÓNIA', 'KOMBÁJN', 'KOMBINÉ', 'KOMÉDIA', 'KOMFORT',
            'KOMIKUM', 'KOMIKUS', 'KOMMUNA', 'KOMORNA', 'KOMÓTOS', 'KOMPAKT', 'KOMPLEX', 'KONCERT', 'KONFLIS', 'KONKOLY', 'KONKRÉT',
            'KONTRÁS', 'KONTRÁZ', 'KONZERV', 'KONZULI', 'KONYHAI', 'KOPASZT', 'KOPÍROZ', 'KOPOGÁS', 'KOPONYA', 'KOPORSÓ', 'KOPPANT',
            'KOPPINT', 'KORAVÉN', 'KORÁBBI', 'KORBÁCS', 'KORDÉLY', 'KORHADÓ', 'KORHADT', 'KORHELY', 'KORMÁNY', 'KORONÁS', 'KORONÁZ',
            'KORPUSZ', 'KORRAJZ', 'KORREKT', 'KORRUPT', 'KORSZAK', 'KORTÁRS', 'KORTYOL', 'KOSARAS', 'KOSZORÚ', 'KOSZTOS', 'KOSZORÚ',
            'KOSZTOL', 'KOSZTOS', 'KOSZTÜM', 'KOTORÉK', 'KÓBOROL', 'KÓDOLÁS', 'KÓDSZÁM', 'KÓPÉSÁG', 'KÓRHÁZI', 'KÓRISME', 'KÓRISTA',
            'KÓRUSMŰ', 'KÓSTOLÓ', 'KÖBGYÖK', 'KÖDFOLT', 'KÖDKÜRT', 'KÖDÖSÍT', 'KÖHÖGÉS', 'KÖLCSÖN', 'KÖLTÖTT', 'KÖLTŐNŐ', 'KÖLTSÉG',
            'KÖNNYED', 'KÖNNYEN', 'KÖNNYES', 'KÖNNYÍT', 'KÖNYVEL', 'KÖNYVES', 'KÖPTETŐ', 'KÖRBEAD', 'KÖRBEÉR', 'KÖRBEÍR', 'KÖRBEÜL',
            'KÖRCIKK', 'KÖRÉBEN', 'KÖRIRAT', 'KÖRÍTÉS', 'KÖRÍVES', 'KÖRNYÉK', 'KÖRÖZÉS', 'KÖRSÉTA', 'KÖRTÁNC', 'KÖRTEFA', 'KÖRÜLÉR',
            'KÖRÜLÍR', 'KÖRÜLÜL', 'KÖRZETI', 'KÖSZÖNT', 'KÖSZÖRŰ', 'KÖTELEM', 'KÖTELES', 'KÖTELEZ', 'KÖTELÉK', 'KÖTÖZÉS', 'KÖTŐDÉS',
            'KÖTŐDIK', 'KÖTŐFÉK', 'KÖTŐGÉP', 'KÖTŐJEL', 'KÖTŐMÓD', 'KÖTŐSZÓ', 'KÖTVÉNY', 'KÖVETEL', 'KÖVETÉS', 'KÖVEZET', 'KÖVEZÉS',
            'KÖVÉRÍT', 'KÖVÜLET', 'KÖZELEG', 'KÖZELGŐ', 'KÖZELÍT', 'KÖZEPES', 'KÖZÉLET', 'KÖZÉPEN', 'KÖZÉPSŐ', 'KÖZÉPÚT', 'KÖZHELY',
            'KÖZLÖNY', 'KÖZNAPI', 'KÖZÖSEN', 'KÖZÖSÜL', 'KÖZÖTTI', 'KÖZPÉNZ', 'KÖZPONT', 'KÖZREAD', 'KÖZREND', 'KÖZSÉGI', 'KÖZÜLET',
            'KÖZÜZEM', 'KŐBALTA', 'KŐBÁNYA', 'KŐDARAB', 'KŐEDÉNY', 'KŐFEJTŐ', 'KŐHALOM', 'KŐKOCKA', 'KŐKORSÓ', 'KŐMŰVES', 'KŐPADLÓ',
            'KŐRAKÁS', 'KŐRISFA', 'KŐSZIRT', 'KŐSZÍVŰ', 'KŐZÁPOR', 'KRAJCÁR', 'KREÁCIÓ', 'KREATÍV', 'KREDENC', 'KRIKETT', 'KRIPTON',
            'KRITIKA', 'KROKETT', 'KRÓNIKA', 'KRUMPLI', 'KUBIKOL', 'KUBIKOS', 'KUBISTA', 'KUKACOS', 'KUKKOLÓ', 'KULCSOL', 'KULCSOS',
            'KULIZIK', 'KULTUSZ', 'KULTÚRA', 'KUPLUNG', 'KUPOLÁS', 'KUPOROG', 'KURÁTOR', 'KURÁZSI', 'KURBLIZ', 'KURJANT', 'KURKUMA',
            'KURRENS', 'KUTATÁS', 'KUTYAÓL', 'KUTYÁUL', 'KUVIKOL', 'KÚTÁGAS', 'KÚTÁSÁS', 'KÚTFÚRÓ', 'KÚTKÁVA', 'KÜLALAK', 'KÜLDÖNC',
            'KÜLDÖTT', 'KÜLFÖLD', 'KÜLÖNÍR', 'KÜLÖNÖS', 'KÜLPIAC', 'KÜLSZÍN', 'KÜRTJEL', 'KVANTUM', 'KVARCOL'
        ]
    },
    'L': {
        '3': [
            'LAK', 'LAP', 'LAT', 'LÁB', 'LÁM', 'LÁP', 'LÁT', 'LÁZ', 'LED', 'LEJ', 'LEL', 'LEN', 'LER', 'LEP', 'LES', 'LÉC', 'LÉG', 'LÉK',
            'LÉP', 'LÉT', 'LIK', 'LOB', 'LOM', 'LOP', 'LÓG', 'LÖK', 'LUK', 'LÚD', 'LÚG', 'LÚR'
        ],
        '4': [
            'LAKK', 'LAKÓ', 'LANT', 'LAPP', 'LAZA', 'LÁDA', 'LÁGY', 'LÁMA', 'LÁNC', 'LÁNG', 'LÁNY', 'LÁSD', 'LÁTÓ', 'LÁVA', 'LEAD', 'LEÁS',
            'LEÉG', 'LEÉL', 'LEÉR', 'LEÍR', 'LEJT', 'LELŐ', 'LENG', 'LENN', 'LENŐ', 'LENT', 'LEÖL', 'LERÍ', 'LERÓ', 'LESZ', 'LETT', 'LEÜL',
            'LEÜT', 'LETT', 'LEÜL', 'LEÜT', 'LEVŐ', 'LÉGI', 'LÉGY', 'LÉHA', 'LÉNY', 'LÉVŐ', 'LIÁN', 'LIBA', 'LIFT', 'LIGA', 'LILA', 'LINK',
            'LÍRA', 'LOGÓ', 'LOMB', 'LONC', 'LOPÓ', 'LÓCA', 'LÓGÓ', 'LŐRE', 'LUFI', 'LUPE', 'LÜKE', 'LYUK'
        ],
        '5': [
            ...
            'LEVÉL', 'LEVON', 'LEZÁR', 'LEZÚZ', 'LÉCEL', 'LÉCES', 'LÉDÚS', 'LÉGIÓ', 'LÉKEL', 'LÉLEK', 'LÉPES', 'LÉPÉS', 'LÉTRA', 'LÉZER',
            'LIBEG', 'LICIT', 'LICSI', 'LIGER', 'LIGET', 'LIHEG', 'LIKŐR', 'LILÁS', 'LIMIT', 'LISTA', 'LISZT', 'LITER', 'LÍRAI', 'LOBBI',
            'LOBOG', 'LOBOS', 'LOHAD', 'LOHOL', 'LOKÁL', 'LOMHA', 'LOMOL', 'LOMOS', 'LOPÁS', 'LOPVA', 'LOTTÓ', 'LOTYÓ', 'LOVAG', 'LOVAL',
            'LOVAS', 'LÓBÁL', 'LÓDEN', 'LÓDÍT', 'LÓDUL', 'LÓERŐ', 'LÓGAT', 'LÓGÁS', 'LÓGÓS', 'LÓHÚS', 'LÓLÁB', 'LÖKET', 'LÖKÉS', 'LÖKÖD',
            'LÖNCS', 'LÖTTY', 'LÖVEG', 'LÖVET', 'LÖVÉS', 'LŐPOR', 'LŐRÉS', 'LŐTÉR', 'LUDAS', 'LUGAS', 'LUKAS', 'LURKÓ', 'LUSTA', 'LUTRI',
            'LUXUS', 'LÚGOS', 'LÚGOZ', 'LÚMEN'
        ],
        '6': [
            'LABANC', 'LABODA', 'LAGÚNA', 'LAIKUS', 'LAJHÁR', 'LAKBÉR', 'LAKCÍM', 'LAKKOS', 'LAKKOZ', 'LAKOMA', 'LAKOTT', 'LAKTÓZ',
            'LANDOL', 'LANKAD', 'LANKÁS', 'LANTOS', 'LANYHA', 'LAPÁLY', 'LAPPAD', 'LAPTOP', 'LASSAN', 'LASSÍT', 'LASSUL', 'LASSZÓ',
            'LATYAK', 'LAVINA', 'LAZSÁL', 'LÁBFEJ', 'LÁBFÉK', 'LÁBNYI', 'LÁBUJJ', 'LÁDIKA', 'LÁGYAN', 'LÁGYÉK', 'LÁGYÍT', 'LÁGYUL',
            'LÁMPÁS', 'LÁNCOL', 'LÁNCOS', 'LÁNGOL', 'LÁNGOS', 'LÁNYKA', 'LÁNYOS', 'LÁRMÁS', 'LÁTÁSI', 'LÁTCSŐ', 'LÁTENS', 'LÁTKÉP',
            'LÁTNOK', 'LÁTTAT', 'LÁZADÓ', 'LÁZÍTÓ', 'LÁZLAP', 'LÁZONG', 'LEBBEN', 'LEBONT', 'LEAPAD', 'LEARAT', 'LEADÁS', 'LEALÁZ',
            'LEÁSÁS', 'LEÁZIK', 'LEBENY', 'LEBONT', 'LECSAP', 'LECSÍP', 'LECSUK', 'LEDÖNT', 'LEEMEL', 'LEENDŐ', 'LEESÉS', 'LEESIK',
            'LEEVÉS', 'LEÉGET', 'LEÉGÉS', 'LEÉLÉS', 'LEÉPÍT', 'LEÉPÜL', 'LEÉRÉS', 'LEÉRIK', 'LEFAGY', 'LEFEJT', 'LEFELÉ', 'LEFEST',
            'LEFOGY', 'LEGELŐ', 'LEGÉNY', 'LEGOTT', 'LEGUÁN', 'LEGYEN', 'LEGYEZ', 'LEGYŐZ', 'LEGYŰR', 'LEHAGY', 'LEHAJT', 'LEHÁNT',
            'LEHÁNY', 'LEHETŐ', 'LEHORD', 'LEHULL', 'LEHUNY', 'LEIGÁZ', 'LEIRAT', 'LEITAT', 'LEÍRAT', 'LEÍRÁS', 'LEJÁRÓ', 'LEJÁRT',
            'LEJMOL', 'LEJTŐS', 'LEKTOR', 'LEKTŰR', 'LEKÜLD', 'LEKÜZD', 'LEKVÁR', 'LELÁTÓ', 'LELENC', 'LELKES', 'LELTÁR', 'LEMEGY',
            'LEMENŐ', 'LEMOND', 'LENCSE', 'LENDÍT', 'LENDÜL', 'LENÉZŐ', 'LENGET', 'LENGÉS', 'LENMAG', 'LENYEL', 'LENYES', 'LENYÍR',
            'LENYOM', 'LENYÚL', 'LENYÚZ', 'LEOKÁD', 'LEOSON', 'LEÖLÉS', 'LEPEDŐ', 'LEPÉNY', 'LEPLEZ', 'LEPRÁS', 'LÉPTEK', 'LÉPTÉK',
            'LERÁNT', 'LEROGY', 'LERONT', 'LESGÓL', 'LESÚJT', 'LESZED', 'LESZEL', 'LESZID', 'LESZÍV', 'LESZÓL', 'LESZÓR', 'LESZÚR',
            'LESZŰR', 'LETESZ', 'LETILT', 'LETÖLT', 'LETÖRT', 'LEÜLÉS', 'LEÜTÉS', 'LEVÁLT', 'LEVARR', 'LEVEGŐ', 'LEVERT', 'LEVESZ',
            'LEVISZ', 'LEVLAP', 'LEZSER', 'LÉGCSŐ', 'LÉGFÉK', 'LÉGIES', 'LÉGKÖR', 'LÉGTÉR', 'LÉGÚTI', 'LÉGZÉS', 'LÉHŰTŐ', 'LÉNYEG',
            'LÉPCSŐ', 'LÉPKED', 'LÉPTET', 'LÉTÉRE', 'LÉTEZŐ', 'LÉTIGE', 'LÉZENG', 'LIBEGŐ', 'LIBIDÓ', 'LICENC', 'LIDÉRC', 'LIFTES',
            'LIGNIT', 'LIKVID', 'LILIOM', 'LIMLOM', 'LINKEL', 'LINZER', 'LISTÁS', 'LISTÁZ', 'LITVÁN', 'LÍCEUM', 'LÍTIUM', 'LÍZING',
            'LOBBAN', 'LOBOGÓ', 'LOCSOG', 'LOCSOL', 'LOGGIA', 'LOGIKA', 'LOMBIK', 'LOMBOS', 'LOMPOS', 'LOMTÁR', 'LOPKOD', 'LOPOTT',
            'LOVAGI', 'LOVÁSZ', 'LÓFOGÚ', 'LÓHERE', 'LÓKÖTŐ', 'LÓSZŐR', 'LÓTETŰ', 'LÓZUNG', 'LÖKDÖS', 'LÖTYÖG', 'LÖVELL', 'LÖVÉSZ',
            'LŐSZER', 'LUCSOK', 'LUMPEN', 'LUMPOL', 'LUGGAT', 'LÚDBŐR', 'LÜKTET', 'LYUKAS'
        ],
        '7': [
            'LABDACS', 'LABILIS', 'LAKATOS', 'LAKÁSÁR', 'LAKHATÓ', 'LAKHELY', 'LAKMUSZ', 'LAKOZIK', 'LAKÓHÁZ', 'LAKÓTÉR', 'LAKTATÓ',
            'LAMBADA', 'LAMINÁL', 'LAMPION', 'LANGYOS', 'LANKADT', 'LANOLIN', 'LANOVKA', 'LANYHUL', 'LAPÁTOL', 'LAPÍTÁS', 'LAPOZÁS',
            'LAPPANG', 'LAPSZÁM', 'LAPSZÉL', 'LAPSZUS', 'LAPULÁS', 'LASAGNE', 'LAVÍROZ', 'LAZASÁG', 'LAZÍTÁS', 'LAZULÁS', 'LÁBBELI',
            'LÁBIKRA', 'LÁBNYOM', 'LÁBSZAG', 'LÁBSZÁR', 'LÁGYSÁG', 'LÁNCHÍD', 'LÁNCING', 'LÁNDZSA', 'LÁNGÉSZ', 'LÁNYKOR', 'LÁNYNÉV',
            'LÁNYSÁG', 'LÁTHATÓ', 'LÁTNOKI', 'LÁTOGAT', 'LÁTOMÁS', 'LÁTÓKÖR', 'LÁTÓTÉR', 'LÁTSZAT', 'LÁTSZIK', 'LÁTVÁNY', 'LÁZADÁS',
            'LÁZÁLOM', 'LÁZASAN', 'LÁZÍTÁS', 'LÁZMÉRŐ', 'LEALÁZÓ', 'LEÁLLÁS', 'LEÁLLÍT', 'LEÁNYÁG', 'LEÁNYKA', 'LEÁNYOS', 'LEÁNYZÓ',
            'LEÁZTAT', 'LEBEGÉS', 'LEBETŰZ', 'LEBÉNUL', 'LEBORÍT', 'LEBORUL', 'LEBUKÁS', 'LEBUKIK', 'LEBUTÍT', 'LEBZSEL', 'LECITIN',
            'LECSENG', 'LECSÜNG', 'LEDARÁL', 'LEDOBÁS', 'LEENGED', 'LEFARAG', 'LEFÁRAD', 'LEFEDÉS', 'LEFEJEZ', 'LEFEJÉS', 'LEFÉKEZ',
            'LEFIXÁL', 'LEFIZET', 'LEFOGAD', 'LEFOGAT', 'LEFOGÁS', 'LEFOKOZ', 'LEFOLYÓ', 'LEFOTÓZ', 'LEFÖLÖZ', 'LEFŐZÉS', 'LEFUTÁS',
            'LEFÚJÁS', 'LEFÜLEL', 'LEFŰZŐS', 'LEGÁLIS', 'LEGALJA', 'LEGALSÓ', 'LEGALUL', 'LEGÁZOL', 'LEGELÖL', 'LEGELSŐ', 'LEGENDA',
            'LEGÉPEL', 'LEGFŐBB', 'LEGITIM', 'LEGJAVA', 'LEGJOBB', 'LEGTÖBB', 'LEGURÍT', 'LEGURUL', 'LEGVÉGE', 'LEGYÁRT', 'LEGYEZŐ',
            'LEGYINT', 'LEHAJÍT', 'LEHAJOL', 'LEHARAP', 'LEHASAL', 'LEHÁMOZ', 'LEHELET', 'LEHÍVAT', 'LEHÍVÁS', 'LEHOZÁS', 'LEHÚZÁS',
            'LEHŰLÉS', 'LEHŰTÉS', 'LEINTÉS', 'LEISZIK', 'LEJÁRAT', 'LEJJEBB', 'LEJÖVET', 'LEJUTÁS', 'LEKAPAR', 'LEKAPÁS', 'LEKEFÉL',
            'LEKENÉS', 'LEKERÜL', 'LEKEVER', 'LEKEZEL', 'LEKÉPEZ', 'LEKÉRET', 'LEKÉRÉS', 'LEKÉSIK', 'LEKIÁLT', 'LEKÍSÉR', 'LEKOPIK',
            'LEKOPOG', 'LEKÖPÉS', 'LEKÖRÖZ', 'LEKÖTÉS', 'LEKÖZÖL', 'LELAKIK', 'LELAPÍT', 'LELÁTÁS', 'LELÉCEL', 'LELÉPÉS', 'LELKÉSZ',
            'LELOHAD', 'LELÓGÁS', 'LELÖKÉS', 'LELÖVÉS', 'LEMARAD', 'LEMARAT', 'LEMARÁS', 'LEMÁLIK', 'LEMÁSOL', 'LEMENET', 'LEMÉRET',
            'LEMÉRÉS', 'LEMERÜL', 'LEMETSZ', 'LEMMING', 'LEMONDÓ', 'LEMOSAT', 'LEMOSÁS', 'LENÉZÉS', 'LENGYEL', 'LENOLAJ', 'LENYÚJT',
            'LEOLDÁS', 'LEOLTÁS', 'LEOLVAS', 'LEOMLIK', 'LEOPÁRD', 'LEÖBLÍT', 'LEÖLTÉS', 'LEÖNTÉS', 'LEPÁROL', 'LEPEDÉK', 'LEPEREG',
            'LEPIHEN', 'LEPIPÁL', 'LEPOROL', 'LERAGAD', 'LERAKAT', 'LERAKÁS', 'LERÁGÁS', 'LERÁZÁS', 'LEROHAD', 'LEROHAN', 'LERÚGÁS',
            'LESEGÍT', 'LESEPER', 'LESHELY', 'LESIKÁL', 'LESIMÍT', 'LESIMUL', 'LESÖPÖR', 'LESÚJTÓ', 'LESÚROL', 'LESÜLÉS', 'LESÜTÉS',
            'LESZÁLL', 'LETAGAD', 'LETAKAR', 'LETÁMAD', 'LETAPOS', 'LETAROL', 'LETEKER', 'LETELIK', 'LETELTE', 'LETEPER', 'LETERÍT',
            'LETÉPÉS', 'LETÉRÉS', 'LETÉRÍT', 'LETIPOR', 'LETOLÁS', 'LETÖRÉS', 'LETÖRIK', 'LETÖRÖL', 'LETUDÁS', 'LETŰNIK', 'LETŰRÉS',
            'LETŰZÉS', 'LEUGRÁS', 'LEUGRIK', 'LEÜLTET', 'LEVAKAR', 'LEVASAL', 'LEVÁGAT', 'LEVÁGÁS', 'LEVÁLIK', 'LEVEGŐS', 'LEVELES',
            'LEVELEZ', 'LEVENTE', 'LEVERÉS', 'LEVESES', 'LEVETET', 'LEVETÉS', 'LEVETÍT', 'LEVEZET', 'LEVÉDET', 'LEVÉTEL', 'LEVITÁL',
            'LEVIZEL', 'LEVONAT', 'LEVONÁS', 'LEVONUL', 'LEXIKON', 'LEZAVAR', 'LEZÁRÁS', 'LEZÁRUL', 'LEZUHAN', 'LEZÚDÍT', 'LEZÚDUL',
            'LÉGGÖMB', 'LÉGHAJÓ', 'LÉGIERŐ', 'LÉGKÖRI', 'LÉGNEMŰ', 'LÉGSÚLY', 'LÉGUTAK', 'LÉGÜGYI', 'LÉGÜRES', 'LÉGZÉSI', 'LÉGZSÁK',
            'LÉGYOTT', 'LÉHASÁG', 'LÉNYEGI', 'LÉPCSŐS', 'LÉPEGET', 'LÉTALAP', 'LÉTELEM', 'LÉTESÍT', 'LÉTESÜL', 'LÉTEZÉS', 'LÉTEZIK',
            'LÉTSZÁM', 'LÉZERES', 'LIBABŐR', 'LIBAMÁJ', 'LIBATOP', 'LIBELLA', 'LIBÉRIA', 'LICITÁL', 'LIGETES', 'LIMITÁL', 'LIMUZIN',
            'LINCSEL', 'LISZTES', 'LISZTEZ', 'LITÁNIA', 'LITERES', 'LÍRIKUS', 'LOBBANT', 'LOBOGÁS', 'LOCCSAN', 'LOGFÁJL', 'LOGIKAI',
            'LOGIKUS', 'LOHADÁS', 'LOHOLÁS', 'LOJÁLIS', 'LOKÁLIS', 'LOKÁTOR', 'LONCSOS', 'LOPÓTÖK', 'LOTTÓZÓ', 'LOVAGOL', 'LOVARDA',
            'LÓÁPOLÓ', 'LÓFAROK', 'LÓGATÁS', 'LÓHÁTON', 'LÓKUPEC', 'LÓPATKÓ', 'LÓSPORT', 'LÓUGRÁS', 'LÖVEDÉK', 'LŐÁLLÁS', 'LŐDÖRÖG',
            'LŐPOROS', 'LUCERNA', 'LUCSKOS', 'LUKASZT', 'LUMBÁGÓ', 'LÚDTALP', 'LÚDTOLL', 'LÜKTETŐ', 'LYUGGAT'
        ]
    },
    'M': {
        '3': [
            'MAG', 'MAI', 'MAR', 'MÁJ', 'MÁK', 'MÁR', 'MÁS', 'MÁZ', 'MEG', 'MEÓ', 'MER', 'MEZ', 'MÉG', 'MÉH', 'MÉN', 'MÉR', 'MÉZ', 'MIÉ',
            'MIK', 'MIN', 'MIT', 'MÍG', 'MOL', 'MOS', 'MÓD', 'MÓL', 'MÓR', 'MŰT'
        ],
        '4': [
            'MACA', 'MACI', 'MAGA', 'MAJD', 'MAKI', 'MAKK', 'MAMA', 'MAMI', 'MANÓ', 'MARA', 'MARÓ', 'MARS', 'MATT', 'MÁLÉ', 'MÁRA', 'MÁRT',
            'MÁSÉ', 'MEGY', 'MELL', 'MELÓ', 'MELY', 'MENŐ', 'MENÜ', 'MENT', 'MENY', 'MEÓS', 'MEÓZ', 'MERŐ', 'MERT', 'MESE', 'MEZŐ', 'MÉCS',
            'MÉLY', 'MÉLA', 'MÉLY', 'MÉRŐ', 'MÉRV', 'MÉSZ', 'MIND', 'MINI', 'MINT', 'MIRE', 'MISE', 'MÍSZ', 'MÍVŰ', 'MOHA', 'MOHÓ', 'MOLL',
            'MOLY', 'MOND', 'MONÓ', 'MOST', 'MOZI', 'MÓDI', 'MÓKA', 'MÓLÓ', 'MÖGÉ', 'MUDI', 'MUFF', 'MUKI', 'MUKK', 'MURI', 'MUST', 'MÚLÓ',
            'MÚLT', 'MŰTŐ', 'MŰÚT', 'MŰVI'
        ],
        '5': [
        ...
        '6': [
            ...
            'MAGYAL', 'MAGYAR', 'MAJDAN', 'MAJMOL', 'MAKACS', 'MAKÁKÓ', 'MAKETT', 'MALÁTA', 'MALTER', 'MAMMON', 'MAMUSZ', 'MANÉZS',
            'MANGÁN', 'MANTRA', 'MARABU', 'MARADI', 'MARDOS', 'MARKOL', 'MARKOS', 'MASZAT', 'MASZEK', 'MASSZA', 'MATINÉ', 'MATRAC',
            'MATRÓZ', 'MATTÍT', 'MATÚRA', 'MÁGLYA', 'MÁGNES', 'MÁJUSI', 'MÁKFEJ', 'MÁKONY', 'MÁLHÁS', 'MÁLHÁZ', 'MÁLNÁS', 'MÁLYVA',
            'MÁNIÁS', 'MÁRKÁS', 'MÁRTÁS', 'MÁRTÍR', 'MÁSFÉL', 'MÁSHOL', 'MÁSKOR', 'MÁSNAP', 'MÁSSÁG', 'MÁSUTT', 'MÁSZIK', 'MÁTRIX',
            'MÁZLIS', 'MÁZOLÓ', 'MÁZSÁL', 'MÁZSÁS', 'MECSET', 'MEDDIG', 'MEDIÁL', 'MEDIÁN', 'MEDIKA', 'MEGÁLD', 'MEGÁLL', 'MEGÁRT',
            'MEGBÁN', 'MEGBÍR', 'MEGBÍZ', 'MEGBÖK', 'MEGDOB', 'MEGDÖF', 'MEGDŐL', 'MEGDUG', 'MEGEDZ', 'MEGEJT', 'MEGÉRT', 'MEGFEJ',
            'MEGFEN', 'MEGFÉR', 'MEGFOG', 'MEGFŐZ', 'MEGFUT', 'MEGFÚJ', 'MEGFÚR', 'MEGFŰZ', 'MEGHAL', 'MEGHAT', 'MEGHÁG', 'MEGHÍV',
            'MEGHÚZ', 'MEGHŰL', 'MEGINT', 'MEGJÁR', 'MEGJÖN', 'MEGKAP', 'MEGKEL', 'MEGKEN', 'MEGKÉR', 'MEGKÖT', 'MEGLÁT', 'MEGLEL',
            'MEGLEP', 'MEGLES', 'MEGLÉP', 'MEGLOP', 'MEGLÓG', 'MEGLÖK', 'MEGMAR', 'MEGMÉR', 'MEGMOS', 'MEGMŰT', 'MEGNÉZ', 'MEGOLD',
            'MEGRAK', 'MEGRÁG', 'MEGRÁZ', 'MEGRÚG', 'MEGSÓZ', 'MEGSÚG', 'MEGSÜL', 'MEGSÜT', 'MEGSZŐ', 'MEGTÉP', 'MEGTÉR', 'MEGTOL',
            'MEGTÖM', 'MEGTÖR', 'MEGTUD', 'MEGTŰR', 'MEGTŰZ', 'MEGVAN', 'MEGVÁG', 'MEGVÁR', 'MEGVER', 'MEGVET', 'MEGVÉD', 'MEGVÍV',
            'MEGVON', 'MEGYEI', 'MELASZ', 'MELLÉK', 'MELLŐL', 'MELLŐZ', 'MELLSŐ', 'MELLTŰ', 'MELYIK', 'MEMOÁR', 'MENHIR', 'MENNÉL',
            'MENÓRA', 'MENTEN', 'MENTES', 'MENTÉN', 'MENTÉS', 'MENTOL', 'MENTOR', 'MENTŐS', 'MENYÉT', 'MENNYI', 'MEREDT', 'MERENG',
            'MERÉSZ', 'MERŐEN', 'MERRŐL', 'MESTER', 'MESZEL', 'MESZES', 'MESZEZ', 'MESSZE', 'MESSZI', 'METEOR', 'METÉLT', 'METRUM',
            'METSZŐ', 'METTŐL', 'MEZŐNY', 'MEZŐŐR', 'MÉCSES', 'MÉDIUM', 'MÉGSEM', 'MÉHÉSZ', 'MÉHKAS', 'MÉHRAJ', 'MÉLABÚ', 'MÉLTAT',
            'MÉLTÁN', 'MÉLYED', 'MÉLYEN', 'MÉLYÍT', 'MÉLYÜL', 'MÉRGES', 'MÉRGEZ', 'MÉRLEG', 'MÉRNÖK', 'MÉRŐÓN', 'MÉRTAN', 'MÉRTEN',
            'MÉRTÉK', 'MÉSZKŐ', 'MÉTELY', 'MIATTA', 'MIAZMA', 'MIÁKOL', 'MIFÉLE', 'MIGRÉN', 'MIKÁDÓ', 'MIKÉNT', 'MIKÉPP', 'MILLIÓ',
            'MILYEN', 'MIMIKA', 'MIMÓZA', 'MINAPI', 'MINDAZ', 'MINDEN', 'MINDEZ', 'MINDIG', 'MINTÁS', 'MINTÁZ', 'MINTHA', 'MINYON',
            'MIRIÁD', 'MIRIGY', 'MITÉVŐ', 'MIUTÁN', 'MÍNUSZ', 'MÍTOSZ', 'MOCCAN', 'MOCSÁR', 'MOCSOK', 'MODELL', 'MODERN', 'MOKÁNY',
            'MOLETT', 'MOLNÁR', 'MOLYOL', 'MOLYOS', 'MONDAI', 'MONDAT', 'MONDÁS', 'MONGOL', 'MONGÚZ', 'MORBID', 'MORCOS', 'MORDUL',
            'MORFIN', 'MORGÁS', 'MORGÓS', 'MORMOG', 'MORMOL', 'MORMON', 'MORZSA', 'MOSDAT', 'MOSDÁS', 'MOSDIK', 'MOSLÉK', 'MOSODA',
            'MOSOLY', 'MOSÓNŐ', 'MOSTAN', 'MOSZAT', 'MOTYOG', 'MOZAIK', 'MOZDÍT', 'MOZDUL', 'MOZGAT', 'MOZGÁS', 'MOZSÁR', 'MÓRING',
            'MÖGÖTT', 'MÖGÜLE', 'MUFLON', 'MUKKAN', 'MULATÓ', 'MULATT', 'MUMPSZ', 'MUNDÉR', 'MUNKÁS', 'MUSTÁR', 'MUSZÁJ', 'MUTATÓ',
            'MUTÁNS', 'MUZSIK', 'MÚLTÁN', 'MÚZEUM', 'MÜTYŰR', 'MŰÉRTŐ', 'MŰFAJI', 'MŰGOND', 'MŰHELY', 'MŰHIBA', 'MŰHOLD', 'MŰKÖDŐ',
            'MŰLÉGY', 'MŰSZAK', 'MŰSZÁL', 'MŰSZEM', 'MŰSZER', 'MŰSZÍV', 'MŰTÉTI', 'MŰUGRÓ', 'MŰVELT', 'MŰVESE', 'MŰVÉSZ'
        ],
        '7': [
            'MACERÁL', 'MACERÁS', 'MACHETE', 'MADÁRKA', 'MADEIRA', 'MAGASAN', 'MAGASÍT', 'MAGAZIN', 'MAGÁNOS', 'MAGÁZÁS', 'MAGOLÁS',
            'MAGVETŐ', 'MAGZATI', 'MAJÁLIS', 'MAJDANI', 'MAJDNEM', 'MAJONÉZ', 'MAJSZOL', 'MAKADÁM', 'MAKOGÁS', 'MAKRAMÉ', 'MAKRÉLA',
            'MALASZT', 'MALÁRIA', 'MALÁTÁS', 'MALOMKŐ', 'MALOMTÓ', 'MAMLASZ', 'MANDULA', 'MANIKŰR', 'MANIÓKA', 'MANÖKEN', 'MANŐVER',
            'MANZÁRD', 'MARADÁS', 'MARADÉK', 'MARATÁS', 'MARATON', 'MARCONA', 'MARKÁNS', 'MAROKKÓ', 'MAROKKŐ', 'MARÓLÚG', 'MARSALL',
            'MARTINI', 'MASKARA', 'MASZLAG', 'MASSZÍV', 'MASSZŐR', 'MATADOR', 'MATÉRIA', 'MATRICA', 'MATRÓNA', 'MAXIMÁL', 'MAXIMUM',
            'MAZSOLA', 'MÁGIKUS', 'MÁJFOLT', 'MÁJKRÉM', 'MÁJUSFA', 'MÁKGUBÓ', 'MÁKSZEM', 'MÁMORÍT', 'MÁMOROS', 'MÁRCIUS', 'MÁRKINÉ',
            'MÁRMINT', 'MÁRMOST', 'MÁRTOTT', 'MÁRVÁNY', 'MÁSFELÉ', 'MÁSFÉLE', 'MÁSHOGY', 'MÁSHOVA', 'MÁSHOVÁ', 'MÁSKÉNT', 'MÁSKÉPP',
            'MÁSNAPI', 'MÁSODÉV', 'MÁSODIK', 'MÁSOLAT', 'MÁSOLÁS', 'MÁSZKÁL', 'MÁSZÓKA', 'MÁSSZOR', 'MÁZOLÁS', 'MÁZSÁLÓ', 'MECÉNÁS',
            'MEDENCE', 'MEDIKUS', 'MEDITÁL', 'MEGABIT', 'MEGADÁS', 'MEGAFON', 'MEGAKAD', 'MEGALÁZ', 'MEGALIT', 'MEGÁLLÓ', 'MEGÁRAD',
            'MEGÁSAT', 'MEGÁSÁS', 'MEGÁZIK', 'MEGBÁNT', 'MEGBÍZÓ', 'MEGBONT', 'MEGCSAL', 'MEGCSAP', 'MEGCSÍP', 'MEGDÖNT', 'MEGELŐZ',
            'MEGEMEL', 'MEGERED', 'MEGESIK', 'MEGETET', 'MEGÉGET', 'MEGÉLÉS', 'MEGÉPÍT', 'MEGÉPÜL', 'MEGÉREZ', 'MEGÉRÉS', 'MEGÉRIK',
            'MEGÉRTŐ', 'MEGÉTET', 'MEGFAGY', 'MEGFEDD', 'MEGFEJT', 'MEGFEST', 'MEGFOJT', 'MEGGYÓN', 'MEGGYŐZ', 'MEGGYÚR', 'MEGGYŰR',
            'MEGHAGY', 'MEGHAJT', 'MEGITAT', 'MEGÍRÁS', 'MEGGYFA', 'MEGHALL', 'MEGHATÓ', 'MEGHÁNT', 'MEGHINT', 'MEGHISZ', 'MEGHITT',
            'MEGHÍVÓ', 'MEGIDÉZ', 'MEGIGÉZ', 'MEGIJED', 'MEGINOG', 'MEGITAT', 'MEGÍGÉR', 'MEGÍRAT', 'MEGÍRÁS', 'MEGÍTÉL', 'MEGKAPÓ',
            'MEGKEZD', 'MEGKÜLD', 'MGEKÜZD', 'MEGLEPŐ', 'MEGLETT', 'MEGLEVŐ', 'MEGLÉVŐ', 'MEGMÁRT', 'MEGMENT', 'MEGMOND', 'MEGNYAL',
            'MEGNYER', 'MEGNYES', 'MEGNYIT', 'MEGNYÍR', 'MEGNYOM', 'MEGNYÚZ', 'MEGOKOL', 'MEGOSZT', 'MEGÓVÁS', 'MEGÖLEL', 'MEGÖLET',
            'MEGÖLÉS', 'MEGÖRÜL', 'MEGŐRIZ', 'MEGŐRÖL', 'MEGŐRÜL', 'MEGŐRZŐ', 'MEGRÁNT', 'MEGRÁZÓ', 'MEGRIAD', 'MEGROGY', 'MEGRONT',
            'MEGSEJT', 'MEGSÉRT', 'MEGSZAB', 'MEGSZÁN', 'MEGSZED', 'MEGSZEG', 'MEGSZID', 'MEGSZÍV', 'MEGSZÓL', 'MEGSZÚR', 'MEGSZÜL',
            'MEGSZŰR', 'MEGTART', 'MEGTESZ', 'MEGTILT', 'MEGTOLD', 'MEGTÖLT', 'MEGTÖRT', 'MEGUGAT', 'MEGUNÁS', 'MEGUTÁL', 'MEGÚJÍT',
            'MEGÚJUL', 'MEGÜLÉS', 'MEGÜRÜL', 'MEGÜTÉS', 'MEGÜZEN', 'MEGVALL', 'MEGVARR', 'MEGVÁLT', 'MEGVESZ', 'MEGVETŐ', 'MEGVISZ',
            'MEGGYFA', 'MEKEGÉS', 'MEKKORA', 'MELANIN', 'MELANZS', 'MELEGEN', 'MELEGÍT', 'MELÍROZ', 'MELLETT', 'MELLÉNY', 'MELLKAS',
            'MELLKÉP', 'MELLRÁK', 'MELLVÉD', 'MELÓDIA', 'MELÓZIK', 'MEMBRÁN', 'MEMENTÓ', 'MEMÓRIA', 'MENEDÉK', 'MENEKÜL', 'MENESZT',
            'MENETEL', 'MENETES', 'MENHELY', 'MENNYEI', 'MENTÉSI', 'MENTŐÖV', 'MENTSÉG', 'MENÜETT', 'MENNYEI', 'MENNYKŐ', 'MEREDEK',
            'MERENGŐ', 'MERESZT', 'MEREVEN', 'MEREVÍT', 'MERŐBEN', 'MERÜLÉS', 'MESEÍRÓ', 'MESSIÁS', 'MESTERI', 'MESZELŐ', 'METÓDUS',
            'METRIKA', 'METSZET', 'METSZÉS', 'MÉHKÜRT', 'MÉHNYAK', 'MÉHSZÁJ', 'MÉLABÚS', 'MÉLYSÉG', 'MÉREGET', 'MÉRETES', 'MÉRETEZ',
            'MÉRFÖLD', 'MÉRGEZŐ', 'MÉRHETŐ', 'MÉRNÖKI', 'MÉRŐÓRA', 'MÉRTANI', 'MÉRVADÓ', 'MÉSZPÁT', 'MÉTERES', 'MÉZÉDES', 'MIALATT',
            'MIAZMÁS', 'MIÁLTAL', 'MICSODA', 'MIELŐBB', 'MIELŐTT', 'MIHELYT', 'MIKORRA', 'MIKROBA', 'MILÍCIA', 'MILLIÓS', 'MIMIKRI',
            'MINARET', 'MINDEGY', 'MINDEME', 'MINDKÉT', 'MINIMUM', 'MINŐSÉG', 'MINŐSÍT', 'MINŐSÜL', 'MINTEGY', 'MINTSEM', 'MIRELIT',
            'MIRTUSZ', 'MISEBOR', 'MISEING', 'MISÉZIK', 'MISSZIÓ', 'MITIKUS', 'MIXERNŐ', 'MIZÉRIA', 'MOCOROG', 'MOCSÁRI', 'MOCSKOL',
            'MOCSKOS', 'MODÁLIS', 'MODERÁL', 'MODOROS', 'MODULÁL', 'MOGORVA', 'MOGYORÓ', 'MOHIKÁN', 'MOHÓSÁG', 'MONDOTT', 'MONDÓKA',
            'MONITOR', 'MONOGÁM', 'MONOKLI', 'MONOLIT', 'MONOLÓG', 'MONOTON', 'MONSZUN', 'MONTÁZS', 'MOPSZLI', 'MORÁLIS', 'MORDÁLY',
            'MORFÉMA', 'MORFIUM', 'MORMOTA', 'MORÓZUS', 'MORZSÁL', 'MORZSOL', 'MOSHATÓ', 'MOSOGAT', 'MOSÓGÉP', 'MOSÓPOR', 'MOSTANI',
            'MOSTOHA', 'MOTIVÁL', 'MOTÍVUM', 'MOTOLLA', 'MOTOROS', 'MOTOZÁS', 'MOTRING', 'MOZDONY', 'MOZGATÓ', 'MOZGÁSI', 'MOZIZÁS',
            'MOZIZIK', 'MÓCSING', 'MÓDOSÍT', 'MÓDOSUL', 'MÓDOZAT', 'MÓDSZER', 'MÓKÁZIK', 'MÓRIKÁL', 'MÖGÖTTE', 'MÖGÖTTI', 'MULANDÓ',
            'MULASZT', 'MULATÁS', 'MULATÓS', 'MUNÍCIÓ', 'MURIZÁS', 'MURIZIK', 'MUSICAL', 'MUSKÉTA', 'MUSLICA', 'MUSZLIM', 'MUSZLIN',
            'MUTÁCIÓ', 'MUTATÁS', 'MUTATÓS', 'MUTÁLÁS', 'MUTOGAT', 'MUZSIKA', 'MÚLTKOR', 'MÜEZZIN', 'MŰANYAG', 'MŰBÚTOR', 'MŰEMLÉK',
            'MŰKINCS', 'MŰKÖDÉS', 'MŰKÖDIK', 'MŰKÖRÖM', 'MŰREMEK', 'MŰSOROS', 'MŰSZAKI', 'MŰTÁRGY', 'MŰTEREM', 'MŰUGRÁS', 'MŰÚSZÁS',
            'MŰVELET', 'MŰVELÉS', 'MŰVÉSZI', 'MŰVIRÁG'
        ]
    },
    'N': {
        '3': [
            'NAP', 'NÁD', 'NEJ', 'NEM', 'NET', 'NÉP', 'NÉV', 'NÉZ', 'NOS', 'NŐI', 'NŐS', 'NÚT', 'NYŰ'
        ],
        '4': [
    ...
    'O': {
        ...
        '4': [
            ...
            'ORKA', 'OROM', 'OROZ', 'ORSÓ', 'OSON', 'OSZT', 'OXID'
        ],
        '5': [
    ...
    'P': {
        ...
        '5': [
            ...
            'PETTY', 'PÉLDA', 'PÉPES', 'PIACI', 'PIHEG', 'PIHEN', 'PIHÉS', 'PILLA', 'PILLE', 'PINCE', 'PINTY', 'PIÓCA', 'PIPÁL', 'PIPÁS',
            'PIRÍT', 'PIROG', 'PIROS', 'PIRUL', 'PISÁL', 'PISIL', 'PISIS', 'PISZE', 'PITLI', 'PITON', 'PIXEL', 'PIZZA', 'PLACC', 'PLATÓ',
    ...
    'R': {
        ...
        '4': [
            ...
            'RÁNG', 'RÁNŐ', 'RÁNT', 'RÁRÓ', 'RÁTA', 'RÁUN', 'RÁÜL', 'RÁÜT', 'REÁL', 'RECE', 'REDŐ', 'REGE', 'REJT', 'RELÉ', 'REND', 'RENG',
            'REST', 'REVÜ', 'RÉCE', 'RÉGI', 'RÉMA', 'RÉPA', 'RÉSZ', 'RÉTI', 'RIAD', 'RIAN', 'RIGÓ', 'RIMA', 'RING', 'RIZS', 'ROCK', 'ROGY',
            'ROJT', 'ROLÓ', 'ROMA', 'RONT', 'ROST', 'ROZÉ', 'ROZS', 'RÓKA', 'RÓLA', 'RÓNA', 'RÖMI', 'RÖNK', 'RUCA', 'RUGÓ', 'RUHA', 'RUND',
            'RUTA', 'RÚGÓ', 'RÚNA', 'RÚZS', 'RÜGY'
        ],
        '5': [
        ...
        '6': [
            'RABIGA', 'RABLÁS', 'RABSÁG', 'RADIÁN', 'RAGACS', 'RAGLÁN', 'RAGYÁS', 'RAGYOG', 'RAJONG', 'RAJTKŐ', 'RAJTOL', 'RAJZÁS',
            'RAJZIK', 'RAJZOL', 'RAJZOS', 'RAKÉTA', 'RAKLAP', 'RAKOTT', 'RAKTÁR', 'RAKTÉR', 'RAMATY', 'RANDOM', 'RANGOS', 'RAPLIS',
            'RAPTOR', 'RASZTA', 'RAVASZ', 'RAZZIA', 'RÁADÁS', 'RÁAKAD', 'RÁCSAP', 'RÁCSOS', 'RÁCSOZ', 'RÁCSUK', 'RÁDIÓS', 'RÁDIUM',
            'RÁDÖNT', 'RÁDZSA', 'RÁEMEL', 'RÁESÉS', 'RÁESIK', 'RÁÉGÉS', 'RÁÉPÍT', 'RÁÉPÜL', 'RÁÉREZ', 'RÁÉRÉS', 'RÁÉRŐS', 'RÁFAGY',
            'RÁFEST', 'RÁHAGY', 'RÁHAJT', 'RÁHÁNY', 'RÁHULL', 'RÁÍGÉR', 'RÁÍRAT', 'RÁÍRÁS', 'RÁKÁSZ', 'RÁKEZD', 'RÁKÖLT', 'RÁMEGY',
            'RÁMOND', 'RÁNCOL', 'RÁNCOS', 'RÁNDÍT', 'RÁNDUL', 'RÁNGAT', 'RÁNGÁS', 'RÁNTÁS', 'RÁNYIT', 'RÁNYOM', 'RÁRÁNT', 'RÁROGY',
            'RÁRONT', 'RÁSZÁN', 'RÁSZED', 'RÁSZEL', 'RÁSZÓL', 'RÁSZÓR', 'RÁSZÚR', 'RÁTESZ', 'RÁTÖLT', 'RÁUNÁS', 'RÁUTAL', 'RÁÜLÉS',
            'RÁÜTÉS', 'RÁVALL', 'RÁVALÓ', 'RÁVARR', 'RÁVESZ', 'RÁVISZ', 'REAGÁL', 'REÁLIS', 'REBBEN', 'RECEPT', 'RECSEG', 'REDŐNY',
            'REDVES', 'REFLEX', 'REFORM', 'REFRÉN', 'REGÉNY', 'REGGEL', 'REGNÁL', 'REGULA', 'REJLIK', 'REJTEK', 'REJTVE', 'REKEDT',
            'REKESZ', 'REKLÁM', 'REKORD', 'REKTOR', 'RELIEF', 'RELUXA', 'REMETE', 'REMÉLT', 'REMÉNY', 'RENDEL', 'RENDES', 'RENDEZ',
            'RENDŐR', 'RENDRE', 'RENGET', 'RENGÉS', 'RENOMÉ', 'RENYHE', 'REPDES', 'REPEDT', 'REPESZ', 'REPETA', 'REPKED', 'REPPEN',
            'REPRÍZ', 'REPTÉR', 'REPÜLŐ', 'RESZEL', 'RETESZ', 'RETINA', 'RETKES', 'RETTEG', 'RETTEN', 'REUMÁS', 'REVANS', 'REZDÜL',
            'REZEDA', 'REZGET', 'REZGÉS', 'REZÜMÉ', 'REZZEN', 'REZSIM', 'RÉBUSZ', 'RÉGENS', 'RÉGÉSZ', 'RÉGIES', 'RÉGÓTA', 'RÉMHÍR',
            'RÉMKÉP', 'RÉMLIK', 'RÉMSÉG', 'RÉMÜLT', 'RÉSZEG', 'RÉSZES', 'RÉTSÉG', 'RÉVÉSZ', 'RÉVÜLT', 'RÉZSÚT', 'RIANÁS', 'RIASZT',
            'RIBANC', 'RICSAJ', 'RIGLIZ', 'RIGMUS', 'RIKÍTÓ', 'RIKOLT', 'RINGAT', 'RINGLÓ', 'RINGYÓ', 'RINYÁL', 'RIPACS', 'RIPORT',
            'RISZÁL', 'RITKÁN', 'RITKÁS', 'RITKÍT', 'RITKUL', 'RITMUS', 'RIVALL', 'RIZIKÓ', 'RIZSES', 'ROBBAN', 'ROBOGÓ', 'ROCKER',
            'ROCKOS', 'ROGYÁS', 'ROHADT', 'ROHANÓ', 'ROJTOS', 'ROJTOZ', 'ROKKAN', 'ROKOKÓ', 'ROKONI', 'ROLLER', 'ROMÁNC', 'ROMBOL',
            'ROMLÁS', 'ROMLIK', 'RONDÍT', 'RONGÁL', 'RONTÁS', 'ROPPAN', 'ROSKAD', 'ROSTÁL', 'ROSTOS', 'ROTHAD', 'ROTYOG', 'ROUTER',
            'ROVOTT', 'ROZMÁR', 'ROZOGA', 'ROZSDA', 'ROZSOS', 'RÓZSÁS', 'RÖFFEN', 'RÖGTÖN', 'RÖGZÍT', 'RÖGZÜL', 'RÖNKFA', 'RÖPCSI',
            'RÖPDÖS', 'RÖPKÖD', 'RÖPLAP', 'RÖPPEN', 'RŐTVAD', 'RUGDAL', 'RUGDOS', 'RULETT', 'RUSNYA', 'RUSZKI', 'RUSZLI', 'RÚGTAT',
            'RÚTSÁG', 'RÚZSOS', 'RÚZSOZ', 'RÜGYES', 'RÜHELL'
        ],
        '7': [
            'RABLÁNC', 'RABOSÍT', 'RABRUHA', 'RABTÁRS', 'RACCSOL', 'RADÍROZ', 'RAGADÓS', 'RAGASZT', 'RAGOZÁS', 'RAGYOGÓ', 'RAHEDLI',
            'RAJONGÓ', 'RAJTAÜT', 'RAJTGÉP', 'RAJTJEL', 'RAJZBAK', 'RAJZLAP', 'RAJZOLÓ', 'RAKODÁS', 'RAKODIK', 'RAKONCA', 'RAKÓDIK',
            'RAKPART', 'RAKTÁRI', 'RALIZÁS', 'RALIZIK', 'RAMADÁN', 'RANDEVÚ', 'RANGADÓ', 'RANGSOR', 'RAVATAL', 'RAVIOLI', 'RÁÁLDOZ',
            'RÁÁLLÁS', 'RÁBÁMUL', 'RÁBÍRÁS', 'RÁBÍZÁS', 'RÁBORÍT', 'RÁBORUL', 'RÁBÖKÉS', 'RÁCÁFOL', 'RÁGCSÁL', 'RÁDIUSZ', 'RÁDOBÁS',
            'RÁDŐLÉS', 'RÁENGED', 'RÁÉBRED', 'RÁÉRZÉS', 'RÁFÁZIK', 'RÁFÉRÉS', 'RÁFIZET', 'RÁFOGÁS', 'RÁFUTÁS', 'RÁFÚJÁS', 'RÁFŰTÉS',
            'RÁFŰZÉS', 'RÁGALOM', 'RÁGCSÁL', 'RÁGÓDIK', 'RÁGÓZÁS', 'RÁGÓZIK', 'RÁGYÚJT', 'RÁHARAP', 'RÁHASAL', 'RÁHATÁS', 'RÁHAJOL',
            'RÁHÁRÍT', 'RÁHÁRUL', 'RÁHIBÁZ', 'RÁHÍMEZ', 'RÁHÚZÁS', 'RÁILLIK', 'RÁISMER', 'RÁJÁRÁS', 'RÁJÖVÉS', 'RÁKAPAT', 'RÁKAPÁS',
            'RÁKENÉS', 'RÁKERES', 'RÁKERÜL', 'RÁKFENE', 'RÁKIÁLT', 'RÁKOLLÓ', 'RÁKÖPÉS', 'RÁKÖTÉS', 'RÁKSEJT', 'RÁLÁTÁS', 'RÁLEHEL',
            'RÁLELÉS', 'RÁLÉPÉS', 'RÁLÓGÁS', 'RÁLÖKÉS', 'RÁLÖVÉS', 'RÁMARAD', 'RÁMÁZÁS', 'RÁMÁZOL', 'RÁMENŐS', 'RÁMERED', 'RÁMÉRÉS',
            'RÁMOLÁS', 'RÁMUTAT', 'RÁNEVEL', 'RÁNEVET', 'RÁNÉZÉS', 'RÁNÖVÉS', 'RÁNTOTT', 'RÁOLVAS', 'RÁOMLIK', 'RÁORDÍT', 'RÁÖLTÉS',
            'RÁÖMLIK', 'RÁÖNTÉS', 'RÁPIRÍT', 'RÁRAGAD', 'RÁRAKÁS', 'RÁRÁZÁS', 'RÁREPÜL', 'RÁROHAN', 'RÁRUHÁZ', 'RÁSEGÍT', 'RÁSÓZÁS',
            'RÁSPOLY', 'RÁSÓZÁS', 'RÁSÜLÉS', 'RÁSÜTÉS', 'RÁSZÁLL', 'RÁTALÁL', 'RÁTAPAD', 'RÁTAPOS', 'RÁTARTI', 'RÁTÁMAD', 'RÁTEKER',
            'RÁTEREL', 'RÁTERÍT', 'RÁTÉRÉS', 'RÁTOLÁS', 'RÁTÖRÉS', 'RÁTŰZÉS', 'RÁUGRIK', 'RÁUSZÍT', 'RÁVÁGÁS', 'RÁVERÉS', 'RÁVETÉS',
            'RÁVEZET', 'RÁVÉSÉS', 'RÁVONÁS', 'RÁZUHAN', 'RÁZÚDÍT', 'RÁZÚDUL', 'REAGENS', 'REAKCIÓ', 'REAKTÍV', 'REAKTOR', 'REÁLBÉR',
            'REBEGÉS', 'RECSEGŐ', 'RECCSEN', 'REDŐZET', 'REDŐZÉS', 'REDUKÁL', 'REFERÁL', 'REGGELI', 'REGRUTA', 'REGULÁZ', 'REJTETT',
            'REJTÉLY', 'REJTJEL', 'REKAMIÉ', 'REKESZT', 'REKKENŐ', 'REKTORI', 'REKVIEM', 'RELÁCIÓ', 'RELATÍV', 'RELAXÁL', 'RELÉADÓ',
            'REMEGÉS', 'REMEKEL', 'REMEKMŰ', 'REMEKÜL', 'RENDELŐ', 'RENDÉSZ', 'RENDEZŐ', 'RENDJEL', 'RENDJÉN', 'RENDŐRI', 'RENEGÁT',
            'RENONSZ', 'RENOVÁL', 'REPARÁL', 'REPEDÉS', 'REPESZT', 'REPÍTÉS', 'REPKÉNY', 'REPLIKA', 'REPÜLÉS', 'RESTELL', 'RESZELŐ',
            'RESZELT', 'RESZKET', 'RESZORT', 'RETIKÜL', 'RETTENT', 'RETUSÁL', 'REVIZOR', 'REVÍZIÓ', 'REZONÁL', 'RÉGEBBI', 'RÉGENTE',
            'RÉGISÉG', 'RÉGMÚLT', 'RÉMÁLOM', 'RÉMESEN', 'RÉMMESE', 'RÉMTETT', 'RÉMÜLET', 'RÉSHANG', 'RÉSZBEN', 'RÉSZIDŐ', 'RÉSZINT',
            'RÉSZLEG', 'RÉSZLET', 'RÉSZVÉT', 'RÉTEGES', 'RÉTEGEZ', 'RÉTISAS', 'RÉVETEG', 'RÉVPÉNZ', 'RÉVÜLET', 'RÉZBŐRŰ', 'RÉZDRÓT',
            'RÉZKARC', 'RÉZPÉNZ', 'RIASZTÓ', 'RIBIZLI', 'RICHTIG', 'RICINUS', 'RIDEGEN', 'RIDIKÜL', 'RIGOLYA', 'RIPOSZT', 'RITKÍTÓ',
            'RITMIKA', 'RIVALDA', 'RIVÁLIS', 'RIZLING', 'RIZOTTÓ', 'ROBBANÓ', 'ROBBANT', 'ROBOGÁS', 'ROBORÁL', 'ROBOTOL', 'ROBOTOS',
            'ROHADÁS', 'ROHAMOS', 'ROHAMOZ', 'ROHANÁS', 'RÓKÁZIK', 'ROKFORT', 'ROKKANT', 'ROKONÍT', 'ROLETTA', 'ROMBOID', 'ROMBOLÓ',
            'ROMLOTT', 'ROMBUSZ', 'ROMLOTT', 'ROZSDÁS', 'RÖFÖGÉS', 'RÖHÖGÉS', 'RONCSOL', 'RONGYOL', 'RONGYOS', 'ROPOGÁS', 'ROPOGÓS',
            'ROPPANT', 'ROSTÉLY', 'ROSSZUL', 'ROTÁCIÓ', 'ROTÁLÁS', 'ROTHADT', 'ROVATOL', 'ROVÁTKA', 'ROZETTA', 'ROZZANT', 'ROZSDÁS',
            'RÓZSAFA', 'RÓZSATŐ', 'RÖFÖGÉS', 'RÖGVEST', 'RÖGTÖNI', 'RÖHÖGÉS', 'RÖMIZIK', 'RÖNTGEN', 'RÖPIRAT', 'RÖSTELL', 'RÖVIDEN',
            'RÖVIDÍT', 'RÖVIDKE', 'RÖVIDÜL', 'RUBEOLA', 'RUBRIKA', 'RUGÓZAT', 'RUGÓZÁS', 'RUGÓZIK', 'RUHATÁR', 'RUHAUJJ', 'RUHÁZAT',
            'RUTINOS', 'RÜCSKÖS', 'RÜGYEZŐ', 'RÜHATKA', 'RÜKVERC'
        ]
    },
    'S': {
        '3': [
        ...
        '4': [
            'SAJT', 'SAKK', 'SARC', 'SARJ', 'SARK', 'SARU', 'SATU', 'SAVÓ', 'SÁNC', 'SEFT', 'SEJK', 'SEJT', 'SETE', 'SÉMA', 'SÉRT', 'SÉRV',
            'SÉTA', 'SIET', 'SICC', 'SIKK', 'SILÓ', 'SIMA', 'SITT', 'SÍEL', 'SÍRI', 'SÍRÓ', 'SÍZŐ', 'SKÓT', 'SLAG', 'SMÚZ', 'SODÓ', 'SOHA',
            'SOKÁ', 'SOKK', 'SORS', 'SORT', 'SOSE', 'SÖNT', 'SPAM', 'SRÁC', 'SRÉG', 'SRÓF', 'STÁB', 'STÉG', 'STOP', 'SUBA', 'SUTA', 'SÚGÓ',
            'SÚJT', 'SÚLY', 'SÜLT', 'SÜNI', 'SÜTŐ', 'SŰRŰ', 'SVÁB', 'SVÉD', 'SZAB', 'SZAG', 'SZAK', 'SZAR', 'SZÁJ', 'SZÁK', 'SZÁL', 'SZÁM',
            'SZÁN', 'SZÁR', 'SZÁZ', 'SZED', 'SZEG', 'SZEL', 'SZEM', 'SZER', 'SZEX', 'SZÉF', 'SZÉK', 'SZÉL', 'SZÉN', 'SZÉP', 'SZÉT', 'SZIA',
            'SZID', 'SZIK', 'SZIL', 'SZÍJ', 'SZÍN', 'SZÍR', 'SZÍT', 'SZÍV', 'SZOP', 'SZÓL', 'SZÓR', 'SZÖG', 'SZŐR', 'SZÚR', 'SZÜL', 'SZŰK',
            'SZŰR', 'SZŰZ'
        ],
        '5': [
            ...
            'SÜRÖG', 'SÜTÉS', 'SÜVEG', 'SÜVÍT', 'SŰRÍT', 'SŰRŰN', 'SVUNG', 'SZABÓ', 'SZAFT', 'SZAKI', 'SZARU', 'SZARV', 'SZÁLL', 'SZÁNÓ',
            'SZÁNT', 'SZÁRÚ', 'SZÁSZ', 'SZEDŐ', 'SZEGY', 'SZELŐ', 'SZENT', 'SZERB', 'SZERV', 'SZESZ', 'SZETT', 'SZEXI', 'SZÉNA', 'SZÉRŰ',
            'SZIKE', 'SZINT', 'SZIRT', 'SZITA', 'SZÍNI', 'SZÍNŰ', 'SZÍVÓ', 'SZLÁV', 'SZLÖM', 'SZMOG', 'SZNOB', 'SZOBA', 'SZOMJ', 'SZÓDA',
            'SZÓFA', 'SZÓJA', 'SZÓLÓ', 'SZÓRT', 'SZÓSZ', 'SZÓTŐ', 'SZÖRF', 'SZÖRP', 'SZÖSZ', 'SZÖVŐ', 'SZŐKE', 'SZŐLŐ', 'SZŐTT', 'SZTÁR',
            'SZUMÓ', 'SZURI', 'SZUSZ', 'SZÚRÓ', 'SZÚRT', 'SZÜGY', 'SZÜLŐ', 'SZŰCS', 'SZŰRŐ', 'SZŰRT', 'SZŰZI'
        ],
        '6': [
            ...
            'SATNYA', 'SÁMFÁZ', 'SÁNCOL', 'SÁNTÁN', 'SÁNTÍT', 'SÁPADT', 'SÁRGÁS', 'SÁRGÍT', 'SÁRGUL', 'SÁRHÁZ', 'SÁRMOS', 'SÁTÁNI',
            'SEBÉSZ', 'SEBLÁZ', 'SEFTEL', 'SEGÉLY', 'SEGÍTŐ', 'SEHÁNY', 'SEHOGY', 'SEHOVA', 'SEHOVÁ', 'SEJTES', 'SEJTET', 'SEJTÉS',
            'SEKÉLY', 'SELEJT', 'SELYEM', 'SEMMIS', 'SERBET', 'SERCEG', 'SERDÜL', 'SERÉNY', 'SERIFF', 'SERKED', 'SERKEN', 'SERLEG',
            'SERTÉS', 'SEZLON', 'SÉRTÉS', 'SÉRÜLT', 'SÉTÁLÓ', 'SÉTÁNY', 'SÉTAÚT', 'SIETÉS', 'SIETŐS', 'SIETVE', 'SIKKES', 'SIKLIK',
            'SIKOLT', 'SIKOLY', 'SIKONG', 'SILÁNY', 'SIRÁLY', 'SIMLIS', 'SIMULÓ', 'SINTÉR', 'SIPIRC', 'SIPOLY', 'SÍELÉS', 'SÍFUTÓ',
            'SÍKSÁG', 'SÍLIFT', 'SÍNPÁR', 'SÍPJEL', 'SÍPSZÓ', 'SÍRÁSÓ', 'SÍRUHA', 'SÍTALP', 'SÍTÚRA', 'SÍUGRÓ', 'SLÁGER', 'SLUSSZ',
            'SMARNI', 'SMÁROL', 'SMUCIG', 'SMÚZOL', 'SNAPSZ', 'SNASSZ', 'SODRÁS', 'SOKALL', 'SOKÁIG', 'SOKÁRA', 'SOKÉVI', 'SOKKAL',
            'SOKKOL', 'SOKKOS', 'SOMMÁS', 'SONKÁS', 'SORFAL', 'SORHÁZ', 'SORKÖZ', 'SORSOL', 'SORTŰZ', 'SORVAD', 'SORVÉG', 'SOVÁNY',
            'SÓHAJT', 'SÓLYOM', 'SÓSRÚD', 'SÓTLAN', 'SÓZOTT', 'SÖNTÉS', 'SÖPRÉS', 'SÖRBET', 'SÖRÉNY', 'SÖRHAB', 'SÖRHAS', 'SÖRIVÓ',
            'SÖRÖZŐ', 'SÖRTÉS', 'SÖVÉNY', 'SPAKLI', 'SPÁRGA', 'SPÉKEL', 'SPENÓT', 'SPERMA', 'SPICLI', 'SPIRÁL', 'SPÓROL', 'SPRINT',
            'SPULNI', 'SRAMLI', 'SRÉGEN', 'SRÓFOL', 'STABIL', 'STÁCIÓ', 'STÁTUS', 'STERIL', 'STIGMA', 'STIKLI', 'STÍLUS', 'STÍROL',
            'STÍRÖL', 'STOPLI', 'STRAMM', 'STRAND', 'STRAPA', 'STRICI', 'STRÓFA', 'STRUCC', 'STRÚMA', 'STUKKÓ', 'STÚDIÓ', 'SUBLÓT',
            'SUGALL', 'SUHANC', 'SUHANÓ', 'SUHINT', 'SUHOGÓ', 'SUJTÁS', 'SULYOK', 'SUMMÁZ', 'SUNYÍT', 'SURRAN', 'SUSKUS', 'SUSOGÓ',
            'SUTTOG', 'SUTTYÓ', 'SÚLYOS', 'SÚLYOZ', 'SÚLYZÓ', 'SÚROLÓ', 'SÜPPED', 'SÜRGET', 'SÜRGÉS', 'SÜRGŐS', 'SÜTÖDE', 'SÜTTET',
            'SÜVÍTŐ', 'SÜVÖLT', 'SVIHÁK', 'SZABAD', 'SZABÁS', 'SZABIN', 'SZAGOL', 'SZAGOS', 'SZAJHA', 'SZAJKÓ', 'SZAJRÉ', 'SZAKAD',
            'SZAKÁG', 'SZAKOS', 'SZAKÍT', 'SZAKMA', 'SZALAD', 'SZALAG', 'SZALDÓ', 'SZALMA', 'SZALON', 'SZALTÓ', 'SZAMÁR', 'SZAMBA',
            'SZANÁL', 'SZAPUL', 'SZARÁS', 'SZAROS', 'SZARIK', 'SZARKA', 'SZATÉN', 'SZATÍR', 'SZAUNA', 'SZAVAL', 'SZAVAZ', 'SZÁJAL',
            'SZÁJAS', 'SZÁJÍZ', 'SZÁLAS', 'SZÁLAZ', 'SZÁLFA', 'SZÁLKA', 'SZÁLLÓ', 'SZÁMÍT', 'SZÁMLA', 'SZÁMOL', 'SZÁMOS', 'SZÁMOZ',
            'SZÁMŰZ', 'SZÁNKÓ', 'SZÁNÁS', 'SZÁNTÓ', 'SZÁRAD', 'SZÁRAS', 'SZÁRAZ', 'SZÁRÍT', 'SZÁRNY', 'SZÁZAD', 'SZÁZAN', 'SZÁZAS',
            'SZCÉNA', 'SZEDÁL', 'SZEDÁN', 'SZEDER', 'SZEDÉS', 'SZEGEL', 'SZEGES', 'SZEGEZ', 'SZEGFŰ', 'SZEKÁL', 'SZEKÉR', 'SZEKTA',
            'SZELEL', 'SZELEP', 'SZELES', 'SZELET', 'SZELÉN', 'SZELÉS', 'SZELÍD', 'SZELLŐ', 'SZEMBE', 'SZEMEL', 'SZEMES', 'SZEMEZ',
            'SZEMÉT', 'SZEMLE', 'SZENDE', 'SZENES', 'SZENNY', 'SZEPEG', 'SZEPLŐ', 'SZERÁF', 'SZERÁJ', 'SZERDA', 'SZEREL', 'SZEREP',
            'SZERET', 'SZEREZ', 'SZERKÓ', 'SZERTE', 'SZERVA', 'SZERVI', 'SZERZŐ', 'SZEXEL', 'SZEXIS', 'SZEZÁM', 'SZEZON', 'SZÉDÍT',
            'SZÉDÜL', 'SZÉKEL', 'SZÉKES', 'SZÉLED', 'SZÉLES', 'SZÉLEZ', 'SZÉLSŐ', 'SZÉNÁS', 'SZÉPEN', 'SZÉPIA', 'SZÉPÍT', 'SZÉPÜL',
            'SZÉRIA', 'SZÉRUM', 'SZÉTLŐ', 'SZÉTFŐ', 'SZÉTÜT', 'SZFÉRA', 'SZFINX', 'SZIÁMI', 'SZIDÁS', 'SZIFON', 'SZIGET', 'SZIGNÓ',
            'SZIGOR', 'SZIKÁR', 'SZIKES', 'SZIKLA', 'SZIKRA', 'SZIKSÓ', 'SZILAJ', 'SZILFA', 'SZILKE', 'SZILVA', 'SZIMAT', 'SZINTE',
            'SZINTŰ', 'SZIPKA', 'SZIPOG', 'SZIPÓS', 'SZIPUS', 'SZIRÉN', 'SZIROM', 'SZIRTI', 'SZIRUP', 'SZITÁL', 'SZITÁR', 'SZITOK',
            'SZIVAR', 'SZÍJAS', 'SZÍJAZ', 'SZÍNES', 'SZÍNEZ', 'SZÍTÁS', 'SZÍVAT', 'SZÍVÁS', 'SZÍVEL', 'SZÍVES', 'SZÍVÓS', 'SZKÍTA',
            'SZLENG', 'SZOBOR', 'SZOKÁS', 'SZOKIK', 'SZOLGA', 'SZOLID', 'SZONDA', 'SZOPÁS', 'SZOPIK', 'SZOPÓS', 'SZORÍT', 'SZOROS',
            'SZOROZ', 'SZORUL', 'SZORZÓ', 'SZÓBAN', 'SZÓCSŐ', 'SZÓDÁS', 'SZÓFAJ', 'SZÓKÉP', 'SZÓKÖZ', 'SZÓLAM', 'SZÓLÁS', 'SZÓLÍT',
            'SZÓNOK', 'SZÓRÁS', 'SZÓSOR', 'SZÓTAG', 'SZÓTAN', 'SZÓTÁR', 'SZÓVAL', 'SZÓVÉG', 'SZÓZAT', 'SZÖGEL', 'SZÖGES', 'SZÖGEZ',
            'SZÖKÉS', 'SZÖKIK', 'SZÖRNY', 'SZÖSZI', 'SZÖVEG', 'SZÖVET', 'SZÖVÉS', 'SZŐKÉS', 'SZŐKÍT', 'SZŐKÜL', 'SZŐLŐS', 'SZŐRME',
            'SZŐRÖS', 'SZŐRÖZ', 'SZPÁHI', 'SZTEPP', 'SZTORI', 'SZUFLA', 'SZUFLÉ', 'SZUMMA', 'SZUNDI', 'SZUNYA', 'SZUPER', 'SZUROK',
            'SZUVAS', 'SZÚRÁS', 'SZÚRÓS', 'SZÜLÉS', 'SZÜLŐI', 'SZÜNET', 'SZÜRET', 'SZÜRKE', 'SZŰKEN', 'SZŰKÍT', 'SZŰKÖL', 'SZŰKÖS',
            'SZŰKÜL', 'SZŰNÉS', 'SZŰNIK', 'SZŰRÉS'
        ],
        '7': [
            ...
            'SÜTŐVAS', 'SÜVÍTÉS', 'SÜVÖLTŐ', 'SŰRŰSÉG', 'SVINDLI', 'SZABÁLY', 'SZABDAL', 'SZABÁSZ', 'SZABLYA', 'SZABOTT', 'SZAFTOS',
            'SZAGGAT', 'SZAGLÁS', 'SZAGLIK', 'SZAJKÓZ', 'SZAKADÓ', 'SZAKADT', 'SZAKAJT', 'SZAKASZ', 'SZAKÁCS', 'SZAKÁLL', 'SZAKÍRÓ',
            'SZAKKÖR', 'SZAKLAP', 'SZAKMAI', 'SZAKÓCA', 'SZAKSZÓ', 'SZALAJT', 'SZALÁMI', 'SZAMÓCA', 'SZANDÁL', 'SZAPORA', 'SZAPPAN',
            'SZARUFA', 'SZARVAS', 'SZATÍRA', 'SZATÓCS', 'SZATYOR', 'SZAVALÓ', 'SZAVAZÓ', 'SZÁGULD', 'SZÁJHŐS', 'SZÁJVÍZ', 'SZÁJVÍZ',
            'SZÁLKÁS', 'SZÁLLÁS', 'SZÁLLÍT', 'SZÁMÍTÓ', 'SZÁMLAP', 'SZÁMLÁL', 'SZÁMLÁS', 'SZÁMLÁZ', 'SZÁMNÉV', 'SZÁMOLÓ', 'SZÁMSOR',
            'SZÁMTAN', 'SZÁMZÁR', 'SZÁNDÉK', 'SZÁNTÁS', 'SZÁRADT', 'SZÁRCSA', 'SZÁRÍTÓ', 'SZÁZÉVI', 'SZÁZFŐS', 'SZEÁNSZ', 'SZEBBÍT',
            'SZECSKA', 'SZEGECS', 'SZEGETT', 'SZEGÉLY', 'SZEGÉNY', 'SZEGLET', 'SZEKCIÓ', 'SZEKTÁS', 'SZEKTOR', 'SZELLEM', 'SZELLŐS',
            'SZEMBAJ', 'SZEMBEN', 'SZEMCSE', 'SZEMÉLY', 'SZEMÉSZ', 'SZEMFOG', 'SZEMHÉJ', 'SZEMLÉL', 'SZEMZÉS', 'SZENIOR', 'SZENTEL',
            'SZENTÜL', 'SZENVED', 'SZENZOR', 'SZEPLŐS', 'SZERDAI', 'SZERELŐ', 'SZERETŐ', 'SZERÉNY', 'SZERINT', 'SZERTÁR', 'SZERVÁL',
            'SZERVER', 'SZERVES', 'SZERVEZ', 'SZERVIZ', 'SZERZET', 'SZERZÉS', 'SZERZŐI', 'SZESZES', 'SZEVASZ', 'SZÉDÍTŐ', 'SZÉDÜLT',
            'SZÉGYEN', 'SZÉJJEL', 'SZÉKELY', 'SZÉKHÁZ', 'SZÉKLÁB', 'SZÉKLET', 'SZÉKSOR', 'SZÉNPOR', 'SZÉNSAV', 'SZÉPAPA', 'SZÉPFIÚ',
            'SZÉPÍRÓ', 'SZÉPÍTŐ', 'SZÉPSÉG', 'SZÉTÁLL', 'SZÉTDOB', 'SZÉTDÚL', 'SZÉTESŐ', 'SZÉTFUT', 'SZÉTHÚZ', 'SZÉTJÖN', 'SZÉTNÉZ',
            'SZÉTRAK', 'SZÉTRÁG', 'SZÉTRÚG', 'SZÉTTÁR', 'SZÉTTÉP', 'SZÉTTOL', 'SZÉTTÖR', 'SZÉTVÁG', 'SZÉTVER', 'SZÉTZÚZ', 'SZIGNÁL',
            'SZIGONY', 'SZIGORÚ', 'SZIKKAD', 'SZIKLÁS', 'SZIKVÍZ', 'SZILÁNK', 'SZILÁRD', 'SZILVÁS', 'SZIMPLA', 'SZINGLI', 'SZINTÉN',
            'SZINTEZ', 'SZINUSZ', 'SZIRÉNA', 'SZIRTES', 'SZISZEG', 'SZITTYA', 'SZIVACS', 'SZÍNEZŐ', 'SZÍNÉSZ', 'SZÍNFAL', 'SZÍNHÁZ',
            'SZÍNHÚS', 'SZÍNKÉP', 'SZÍNLAP', 'SZÍNLEG', 'SZÍNLEL', 'SZÍNPAD', 'SZÍNTÉR', 'SZÍNVAK', 'SZÍVBAJ', 'SZÍVÓKA', 'SZÍVÜGY',
            'SZKRIPT', 'SZLALOM', 'SZLOGEN', 'SZLOVÁK', 'SZLOVÉN', 'SZMOGOS', 'SZOBAÁR', 'SZOBROZ', 'SZOCPOL', 'SZOKOTT', 'SZOKNYA',
            'SZOKTAT', 'SZOLGAI', 'SZOLGÁL', 'SZOMBAT', 'SZOMJAN', 'SZOMJAS', 'SZOMORÚ', 'SZONÁTA', 'SZONDÁZ', 'SZONETT', 'SZOPÓKA',
            'SZOPRÁN', 'SZOPTAT', 'SZORBIT', 'SZORGOS', 'SZORÍTÓ', 'SZORONG', 'SZORULT', 'SZORZAT', 'SZORZÁS', 'SZOVJET', 'SZÓALAK',
            'SZÓBELI', 'SZÓCIKK', 'SZÓCSKA', 'SZÓNOKI', 'SZÓÖZÖN', 'SZÓREND', 'SZÓSZÉK', 'SZÓSZOS', 'SZÓTÁRI', 'SZÓTLAN', 'SZÓVÉGI',
            'SZÓVICC', 'SZÓVIVŐ', 'SZÖCSKE', 'SZÖGLET', 'SZÖGVAS', 'SZÖKELL', 'SZÖKŐÁR', 'SZÖKŐÉV', 'SZÖKTET', 'SZÖRFÖL', 'SZÖRFÖS',
            'SZÖRNYŰ', 'SZÖRPÖS', 'SZÖSZKE', 'SZÖVÖDE', 'SZÖVÖTT', 'SZŐLÉSZ', 'SZŐLŐLÉ', 'SZŐNYEG', 'SZŐRMÉS', 'SZŐRZET', 'SZŐTTES',
            'SZTÁROL', 'SZTEREÓ', 'SZTORNÓ', 'SZTRÁDA', 'SZTRÁJK', 'SZTYEPP', 'SZULFÁT', 'SZULFID', 'SZULFIT', 'SZULTÁN', 'SZUNDÍT',
            'SZURDOK', 'SZURKÁL', 'SZURKOL', 'SZURKOS', 'SZURONY', 'SZURTOS', 'SZUSZOG', 'SZÚNYOG', 'SZÜKSÉG', 'SZÜLÉSI', 'SZÜLÉSZ',
            'SZÜLÖTT', 'SZÜNIDŐ', 'SZÜNNAP', 'SZÜRKÉS', 'SZÜRKÍT', 'SZÜRKÜL', 'SZŰKÍTŐ', 'SZŰZIES'
        ]
    },
    'T': {
        '3': [
        ...
        '4': [
            ...
            'TÁRT', 'TEÁS', 'TEKE', 'TELE', 'TELI', 'TELJ', 'TELT', 'TENG', 'TERC', 'TERV', 'TESÓ', 'TEST', 'TESZ', 'TETŐ', 'TETT', 'TETŐ',
            'TETŰ', 'TEVE', 'TÉKA', 'TÉLI', 'TÉMA', 'TÉNY', 'TÉRD', 'TÉRI', 'TÉVÉ', 'TIED', 'TIÉD', 'TILT', 'TINI', 'TINÓ', 'TIPP', 'TOJÓ',
            'TOKA', 'TOLD', 'TOLL', 'TOLÓ', 'TOTÓ', 'TORS', 'TORZ', 'TOTÓ', 'TOVA', 'TÓRA', 'TÖBB', 'TÖLT', 'TÖMB', 'TÖNK', 'TÖRP', 'TÖRT',
            'TŐGY', 'TŐKE', 'TRÁK', 'TRIÓ', 'TRÓN', 'TUBA', 'TUFA', 'TUJA', 'TUSA', 'TÚRA', 'TÚRÓ', 'TÚSZ', 'TUTI', 'TÜDŐ', 'TÜLL', 'TÜRK',
            'TÜTÜ', 'TŰZŐ', 'TYÚK'
        ],
        '5': [
    ...
    'V': {
        ...
        '4': [
            ...
            'VISZ', 'VITA', 'VIVŐ', 'VIZA', 'VÍVÓ', 'VÍZI', 'VOKS', 'VOLT', 'VONÓ', 'VONZ'
        ],
        '5': [
    ...
    'Z': {
        ...
        '7': [
            ...
            'ZAMATOS', 'ZAVARÁS', 'ZAVARGÓ', 'ZAVAROG', 'ZAVAROS', 'ZÁPOROS', 'ZÁPOROZ', 'ZÁRADÉK', 'ZÁRHANG', 'ZÁRJEGY', 'ZÁROLÁS',
