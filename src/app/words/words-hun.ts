...
export const wordsHun: Words = {
    ...
    'K': {
        ...
        '5': [
            ...
            'KÉPEZ', 'KÉPZŐ', 'KÉRDŐ', 'KÉREG', 'KÉREM', 'KÉRET', 'KÉSEI', 'KÉSEL', 'KÉSES', 'KÉSÉS', 'KÉSIK', 'KÉSŐI', 'KÉSŐN', 'KÉTES',
            'KHAKI', 'KIADÓ', 'KIÁLL', 'KIÁLT', 'KIBIC', 'KIBÍR', 'KIBÖK', 'KIBUC', 'KICSI', 'KIDOB', 'KIDŐL', 'KIDUG', 'KIEJT', 'KIÉLT',
            'KIFED', 'KIFEJ', 'KIFEN', 'KIFÉR', 'KIFLI', 'KIFOG', 'KIFŐZ', 'KIFUT', 'KIFÚJ', 'KIFÚR', 'KIFŰT', 'KIFŰZ', 'KIHAL', 'KIHAT',
            'KIHÍV', 'KIHOZ', 'KIHÚZ', 'KIHŰL', 'KIHŰT', 'KIIRT', 'KIJÁR', 'KIJÖN', 'KIJUT', 'KIKAP', 'KIKEL', 'KIKEN', 'KIKÉR', 'KIKÖP',
            'KIKÖT', 'KILÁT', 'KILEL', 'KILES', 'KILÉP', 'KILÉT', 'KILOP', 'KILÓG', 'KILÖK', 'KIMAR', 'KIMER', 'KIMÉR', 'KIMOS', 'KINCS',
            'KINÉZ', 'KINCS', 'KININ', 'KINTI', 'KIOLD', 'KIOLT', 'KIONT', 'KIÖLT', 'KIÖNT', 'KISÍR', 'KIRAK', 'KIRÁG', 'KIRÁZ', 'KIRÚG',
            'KISÍR', 'KISSÉ', 'KISÜL', 'KISÜT', 'KITÁR', 'KITÁT', 'KITÉP', 'KITÉR', 'KITIN', 'KITOL', 'KITÖM', 'KITÖR', 'KITÚR', 'KITŰZ',
            'KIVAN', 'KIVÁG', 'KIVÁJ', 'KIVÁR', 'KIVER', 'KIVET', 'KIVÉD', 'KIVÉS', 'KIVÉT', 'KIVÍV', 'KIVON', 'KIZÁR', 'KÍGYÓ', 'KÍNAI',
            'KÍNÁL', 'KÍNOS', 'KÍNOZ', 'KÍNZÓ', 'KÍSÉR', 'KÍVÁN', 'KÍVÜL', 'KLIKK', 'KLISÉ', 'KLÍMA', 'KOALA', 'KOBAK', 'KOCKA', 'KOCOG',
            'KOCSI', 'KOMÁZ', 'KOMBI', 'KOMLÓ', 'KOMOR', 'KOMÓD', 'KONDA', 'KONDI', 'KONGA', 'KONOK', 'KONTY', 'KOPÁR', 'KOPÁS', 'KOPIK',
            'KOPOG', 'KORAI', 'KORÁL', 'KORÁN', 'KORCS', 'KORDÉ', 'KORHŰ', 'KOROG', 'KOROM', 'KOROS', 'KORPA', 'KORSÓ', 'KORTY', 'KORZÓ',
            'KOSÁR', 'KOSZT', 'KOTON', 'KOTOR', 'KOTTA', 'KOZÁK', 'KÓBOR', 'KÓCOL', 'KÓCOS', 'KÓDEX', 'KÓDOL', 'KÓKAD', 'KÓMÁS', 'KÓPIA',
            'KÓROS', 'KÓRUS', 'KÓSER', 'KÓSZA', 'KÖDÖL', 'KÖDÖS', 'KÖHÖG', 'KÖLES', 'KÖLNI', 'KÖLTŐ', 'KÖNNY', 'KÖNYV', 'KÖPET', 'KÖPÉS',
            'KÖPÜL', 'KÖRBE', 'KÖRET', 'KÖRÍT', 'KÖRÍV', 'KÖRÖM', 'KÖRÖZ', 'KÖRTE', 'KÖRÚT', 'KÖRÜL', 'KÖRZŐ', 'KÖSZI', 'KÖTEG', 'KÖTET',
            'KÖTÉL', 'KÖTÉS', 'KÖTÖZ', 'KÖTVE', 'KÖVES', 'KÖVET', 'KÖVEZ', 'KÖVÉR', 'KÖZBE', 'KÖZEG', 'KÖZEL', 'KÖZÉP', 'KÖZJÓ', 'KÖZMŰ',
            'KÖZÖL', 'KÖZÖS', 'KÖZTE', 'KÖZTI', 'KÖZÚT', 'KÖZÜL', 'KŐFAL', 'KŐKOR', 'KŐLAP', 'KŐPOR', 'KŐZET', 'KRACH', 'KREÁL', 'KREOL',
            'KREPP', 'KRESZ', 'KRÉTA', 'KRIMI', 'KROKI', 'KUCKÓ', 'KUFÁR', 'KUGLI', 'KUJON', 'KUKAC', 'KUKÁS', 'KUKÁZ', 'KUKTA', 'KULÁK',
            'KULCS', 'KUPAC', 'KUPAK', 'KUPEC', 'KUPLÉ', 'KUPON', 'KURTA', 'KURUC', 'KUSZA', 'KUTAS', 'KUTAT', 'KUTYA', 'KUVIK', 'KÚPOS',
            'KÚRÁL', 'KÚRIA', 'KÚTFŐ', 'KÜBLI', 'KÜLDŐ', 'KÜLLŐ', 'KÜLÖN', 'KÜLSŐ', 'KÜRTŐ', 'KÜTYÜ', 'KÜZDŐ', 'KVARC', 'KVARK', 'KVINT',
            'KVITT', 'KVÓTA'
        ],
        '6': [
