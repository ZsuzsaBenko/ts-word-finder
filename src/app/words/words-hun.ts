...
export const wordsHun: Words = {
    ...
    'F': {
        ...
        '6': [
            ...
            'FILMEZ', 'FILTER', 'FINÁLÉ', 'FINÁNC', 'FINGIK', 'FINTOR', 'FIÓKOS', 'FIRKÁL', 'FIRTAT', 'FITYEG', 'FITYMA', 'FIZETŐ',
            'FIZIKA', 'FLAKON', 'FLANEL', 'FLASKA', 'FLEGMA', 'FLEPNI', 'FLOPPY', 'FLOTTA', 'FLÓTÁS', 'FLUXUS', 'FLÚGOS', 'FODROS',
            'FODROZ', 'FOGADÓ', 'FOGÁGY', 'FOGÁSZ', 'FOGBÉL', 'FOGDOS', 'FOGHÁZ', 'FOGHÍJ', 'FOGHÚS', 'FOGÍNY', 'FOGLAL', 'FOGOLY',
            'FOGSÁG', 'FOGSOR', 'FOGZÁS', 'FOGZIK', 'FOGYÁS', 'FOHÁSZ', 'FOJTÁS', 'FOLDOZ', 'FOLSAV', 'FOLTOS', 'FOLTOZ', 'FOLYAM',
            'FOLYAT', 'FOLYÁS', 'FOLYIK', 'FOLYÓS', 'FONÉMA', 'FONODA', 'FONOTT', 'FONTOS', 'FORDÍT', 'FORDUL', 'FORGAT', 'FORGÁS',
            'FORINT', 'FORMAI', 'FORMÁL', 'FORMÁS', 'FORMÁZ', 'FORRAD', 'FORRAL', 'FORRÁS', 'FORRÁZ', 'FÓKUSZ', 'FÓBIÁS', 'FÓLIÁS',
            'FÓLIÁZ', 'FÖLDEL', 'FÖLDES', 'FÖLDÚT', 'FÖLÉNY', 'FÖLÖTT', 'FÖLSŐS', 'FÖLÜLI', 'FÖVENY', 'FŐALAK', 'FŐAPÁT', 'FŐBÍRÓ',
            'FŐÉTEL', 'FŐHAJÓ', 'FŐHELY', 'FŐKAPU', 'FŐKÉNT', 'FŐKÖTŐ', 'FŐNÉVI', 'FŐNÖZŐ', 'FŐREND', 'FŐSZAK', 'FŐUTCA', 'FŐZÉSI',
            'FŐZTJE', 'FRANKÓ', 'FRÁNYA', 'FRÁTER', 'FRÁZIS', 'FRESKÓ', 'FRIGID', 'FRITŐZ', 'FRIVOL', 'FRIZBI', 'FRÖCCS', 'FRUFRU',
            'FRUSKA', 'FULLAD', 'FURCSA', 'FURDAL', 'FURGON', 'FUTÓMŰ', 'FUTTAT', 'FUVOLA', 'FÚJTAT', 'FÚVÓKA', 'FÚZIÓS', 'FÜGEFA',
            'FÜGGÉS', 'FÜLÉSZ', 'FÜLLED', 'FÜRDET', 'FÜRDÉS', 'FÜRDIK', 'FÜRGÉN', 'FÜRTÖS', 'FÜSTÖL', 'FÜSTÖS', 'FÜTYÜL', 'FŰRÉSZ',
            'FŰSZÁL', 'FŰSZER', 'FŰTÖTT', 'FŰZÖLD', 'FŰZÖTT'
        ],
        '7': [
    ...
    'L': {
        '3': [
            'LAK', 'LAP', 'LAT', 'LÁB', 'LÁM', 'LÁP', 'LÁT', 'LED', 'LEJ', 'LEL', 'LEN', 'LER', 'LEP', 'LES', 'LÉC', 'LÉG', 'LÉK', 'LÉP',
            'LÉT', 'LIK', 'LOB', 'LOM', 'LOP', 'LÓG', 'LÖK', 'LÚG'
        ],
        '4': [
            'LAKK', 'LAKÓ', 'LANT', 'LAPP', 'LAZA', 'LÁNG', 'LÁNY', 'LÁTÓ', 'LEAD', 'LEÁS', 'LEÉG', 'LEÉL', 'LEÉR', 'LEÍR', 'LELŐ', 'LENŐ',
            'LENG', 'LENN', 'LENT', 'LERÍ', 'LERÓ', 'LESZ', 'LETT', 'LEÜL', 'LEÜT', 'LÉGI', 'LÉNY', 'LIÁN', 'LIBA', 'LIGA', 'LILA', 'LINK',
            'LOPÓ', 'LÜKE'
        ],
        '5': [
            'LABDA', 'LAKAT', 'LAKÁS', 'LANKA', 'LAZUL', 'LÁBAL', 'LÁBAS', 'LÁBOS', 'LÁMPA', 'LÁPOS', 'LÁTÁS', 'LEÁNY', 'LEBŐG', 'LEDÉR',
            'LEDŐL', 'LEFED', 'LEFEJ', 'LEFOG', 'LEFŐZ', 'LEFUT', 'LEFÚJ', 'LEFÚR', 'LEFŰZ', 'LEHAL', 'LEHÚZ', 'LEJUT', 'LEKAP', 'LEKÉR',
            'LEKÖT', 'LELÁT', 'LELES', 'LELET', 'LELÉP', 'LELÉS', 'LELÓG', 'LELÖK', 'LEMEZ', 'LEMÉR', 'LENÉZ', 'LENGE', 'LENTI', 'LEOLT',
            'LEÖLT', 'LEÖNT', 'LEPEL', 'LERAK', 'LERÁZ', 'LESÜL', 'LESÜT', 'LETÉP', 'LETÉR', 'LEVES', 'LEVÉL', 'LEVON', 'LEZÚZ', 'LÉCEL',
            'LÉCES', 'LÉKEL', 'LÉPES', 'LÉPÉS', 'LIGET', 'LILÁS', 'LISZT', 'LOBOG', 'LOBOS', 'LOHAD', 'LOHOL', 'LOMOL', 'LOMOS', 'LOTTÓ',
            'LÓGÁS', 'LÓGÓS', 'LÖKET', 'LÖKÉS', 'LÖKÖD', 'LUSTA', 'LÚGOS'
        ],
        '6': [
            'LAKBÉR', 'LAKKOS', 'LAKKOZ', 'LANKAD', 'LANKÁS', 'LANTOS', 'LAPPAD', 'LAPTOP', 'LÁBUJJ', 'LÁMPÁS', 'LÁNGOS', 'LÁNYOS',
            'LEBONT', 'LECSAP', 'LEDÖNT', 'LEEMEL', 'LEÉPÍT', 'LEÉPÜL', 'LEFEJT', 'LEGÉNY', 'LEHAGY', 'LEHAJT', 'LEIGÁZ', 'LELÁTÓ',
            'LELENC', 'LENCSE', 'LENYÍR', 'LENYÚL', 'LEOSON', 'LEPEDŐ', 'LERÁNT', 'LEROGY', 'LERONT', 'LESZED', 'LESZEL', 'LESZID',
            'LESZÓL', 'LESZÚR', 'LESZŰR', 'LETESZ', 'LEÜTÉS', 'LEVARR', 'LEVEGŐ', 'LEVESZ', 'LEVISZ', 'LÉNYEG', 'LÉPTET', 'LITVÁN',
